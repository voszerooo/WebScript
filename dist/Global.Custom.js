...
(() => {
        ...
        getSnapshot: function () {
          ...
          for (const n in a) {
            ...
            const N = m(n),
              p = M(`[${N}]`, s + 2),
              L = d(v),
              I = `${r}[${'fail' === g ? '👾' : '🚀'}][${L}ms]${p} | ${'fail' === g ? `FAIL - ${u}` : 'DONE'}`;
    ...
    p = (() => {
      ...
      function r(r, t) {
        return function (o = {}) {
          ...
          i.forEach((o) => {
            const { key: i, type: c = 'switch', name: s = ['ON', 'OFF'], color: M = ['var(--ovnAccentHEX)', 'var(--ovnBase04HEX)'], group: l = t, class: u = [], default: g = !0, order: v = 50, inform: N = !0, reload: p = !1, map: m, onClick: L, onMounted: I } = o;
            (i || 'jump' === c) &&
              r((r) => {
  ...
  const m = (() => {
              ...
              y &&
                ...
                N(v)
                  .then(() => {
                    ...
                    (n.searchParams.set('page', v), history.replaceState(null, '', n.toString()), (j = !1), (D = 0), w());
                  })
                  .finally(() => {
                    g = !1;
                  }));
              ...
              (n) => {
                ...
                r.isIntersecting &&
                  ...
                  N(v)
                    .then(() => {
                      const n = new URL(location.href);
                      (n.searchParams.set('page', v), history.replaceState(null, '', n.toString()), A());
                    })
                    .finally(() => {
                      g = !1;
                    }));
                      ...
                      u.run(
                        () => {
                          ...
                          try {
                            ...
                            t ? (r(t, i), N.log(n, `Step${e + 1} ✅ ${i} - ${a}`)) : (N.warn(n, `Step${e + 1} ❓ None - ${a}`), s && ((v = !0), N.error(n, `Step${e + 1} ❌ Break`)));
                          } catch (r) {
                            (N.error(n, `Step${e + 1} ❌ Error - ${r.message}`, 0, r.stack), s && (v = !0));
                          }
                          o();
                        },
                        { jitter: l, order: e },
    ...
    x = { PREFS: t, RUNTIME: a, REDIS: o, DOM: s, MATCH: M, SITE: l, OBSERVER: i, INFORM: d, RANDOM: u, DEBUG: N, BUTTON: p, CONFIG: g, RESOLVER: v, VERIFY: m, SCHEDULER: L, HOOK: c, ADD_CLASS: I, QUICK_READ: y, REMOVE_LIMITS: j, AUTO_LOAD: h, AUTO_EXECUTE: D };
  ((window.OVN = x),
    (function () {
      ...
      function M(o, s, l) {
        ...
        if (o.children && o.children.length > 0) {
          ...
          ((y.className = 'ovnGroupBody'),
            ...
            o.children.forEach((n) => M(n, y, l && g)),
            a.append(v, y),
            s.appendChild(a));
        } else
          s.appendChild(
            (function (o, i) {
              ...
              return (g && t.hover.get(c, !0) && d.OVN.hover(M, g), M);
            })(o, l),
          );
      }
      function l() {
    ...
    (function () {
      function n() {
        ...
        let u = 0,
          g = 0;
        for (const n of Object.values(M)) 'done' === n.state ? u++ : g++;
    ...
    L.run('Gallop', () => {
      !(function () {
        ...
        function C() {
          T = !1;
          const n = (D || (D = S()), j || ((j = document.createElement('canvas')), (j.style.cssText = '\n                    position: fixed;\n                    top: 0;\n                    left: 0;\n                    width: 100%;\n                    height: 100%;\n                    pointer-events: none;\n                    z-index: 999999999;\n                    opacity: 0;\n                    transition: opacity .2s ease;\n                '), D.appendChild(j), (h = j.getContext('2d'))), (j.width = window.innerWidth), (j.height = window.innerHeight), j);
          ((n.style.transition = 'none'), (n.style.opacity = '1'), n.offsetHeight, (n.style.transition = 'opacity .2s ease'), E());
        }
        function E() {
          h && h.clearRect(0, 0, j.width, j.height);
        }
        function f() {
          T ||
            x ||
            (x = requestAnimationFrame(() => {
              (!(function () {
                if (!h || L.length < 2 || T) return;
                (E(), h.beginPath(), h.moveTo(L[0].x, L[0].y));
                for (let n = 1; n < L.length; n++) h.lineTo(L[n].x, L[n].y);
                ((h.strokeStyle = r), (h.lineWidth = 2), (h.lineCap = 'round'), (h.lineJoin = 'round'), h.stroke());
              })(),
                (x = null));
            }));
        }
        function O(n = !1) {
          const r = () => {
            ((v = !1), (N = !1), (p = !1), (L = []), j && (j.style.opacity = '0'), document.documentElement.classList.remove('gesture-active'), window.removeEventListener('mousemove', U, !0), window.removeEventListener('mouseup', _, !0), m && clearTimeout(m), x && (cancelAnimationFrame(x), (x = null)));
          };
        ...
        function B(n) {
          2 !== n.button ||
            ...
            (m && (clearTimeout(m), (m = null)), O(!0), (v = !0), (N = !1), (p = !1), (I = n.clientX), (y = n.clientY), (L = [{ x: n.clientX, y: n.clientY }]), document.documentElement.classList.add('gesture-active'), window.addEventListener('mousemove', U, !0), window.addEventListener('mouseup', _, !0));
        }
        function U(n) {
          if (!v) return;
          ...
          (L.push(r),
            ...
            L.length > d &&
              ...
              (function () {
                ...
                const n = () => {
                  (j.removeEventListener('transitionend', n), j && (j.remove(), (j = null), (h = null)));
                };
                (j.addEventListener('transitionend', n, { once: !0 }),
                  setTimeout(() => {
                    j && j.parentNode && '0' === j.style.opacity && (j.remove(), (j = null), (h = null));
                  }, 200));
              })(),
            f());
        }
        ...
        function Y(n) {
          ...
          (document.addEventListener('mousedown', B, { capture: !0, passive: !1, signal: e }),
            ...
            window.addEventListener(
              'resize',
              () => {
                j && ((j.width = window.innerWidth), (j.height = window.innerHeight), v && E());
              },
              { signal: e },
            ),
            (b = !0));
