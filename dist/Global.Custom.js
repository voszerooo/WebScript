...
(() => {
          ...
          hover: function (n, r, e, o, i = 926) {
            ...
            const v = (n) => {
                ((d = setTimeout(() => {
                  ...
                  ('function' == typeof o && o(), 1 === e && (c.removeEventListener('mouseenter', v), c.removeEventListener('mouseleave', g), t.delete(c)));
                }, i)),
                  t.set(c, { timerId: d, hoverElement: u, onEnter: v, onLeave: g }));
              },
              g = () => {
            ...
            (c.addEventListener('mouseenter', v), c.addEventListener('mouseleave', g), t.set(c, { timerId: d, hoverElement: u, onEnter: v, onLeave: g }));
          },
        };
      }
      ...
      return {
        log: function (r, t = 'DONE', o = 0, a) {
          const i = u({ icon: '🚀', key: r, time: o, msg: t }),
            c = a ? `${i} | ${a}` : i;
          return (e.push(c), n && console.log(c), v(r, c), N(r, { level: 'log', msg: t, time: o }), c);
        },
        warn: function (r, t = 'DEBUG', o = 0, a) {
          const i = u({ icon: '🛠️', key: r, time: o, msg: t }),
            c = a ? `${i} | ${a}` : i;
          return (e.push(c), n && console.warn(c), v(r, c), N(r, { level: 'warn', msg: t, time: o }), c);
        },
        error: function (r, t = 'ERROR', o = 0, a) {
          const i = u({ icon: '👾', key: r, time: o, msg: t }),
            c = a ? `${i} | ${a}` : i;
          return (e.push(c), n && console.error(c), v(r, c), N(r, { level: 'error', msg: t, time: o }), c);
        },
        getLogs: function (n) {
          return t[n] || [];
        },
        ...
        getSnapshot: function () {
          ...
          for (const n in a) {
            ...
            for (const n of o) {
              ...
              ('block' === n.step && (M.block = r(n.state)), 'match' === n.step && (M.match = r(n.state)), 'state' === n.step && (M.state = r(n.state)), 'chain' === n.step && (M.chain = r(n.state)), 'run.exec' === n.step && ((M.exec = r(n.state)), (g = n.timeCost || 0)), 'fail' === n.state && ((v = 'fail'), (u = n.step)));
            }
            'fail' !== v && (v = 'done');
            const p = m(n),
              N = l(`[${p}]`, s + 2),
            ...
            i[n] = { group: c.group || n.split('_')[0] || 'Unknown', shortName: p, timeCost: g, steps: M, state: v, reason: u, logs: t[n] || [], consoleLine: L };
          }
          for (const n in o) {
            if (i[n]) continue;
            const e = o[n],
    ...
    m = (() => {
      ...
      function r(r, t) {
        return function (o = {}) {
          ...
          a.forEach((o) => {
            const { key: a, type: i = 'switch', name: s = ['ON', 'OFF'], color: l = ['var(--ovnAccentHEX)', 'var(--ovnBase04HEX)'], group: M = t, class: d = [], default: v = !0, order: g = 50, inform: p = !0, reload: N = !1, map: m, onClick: y, onMounted: L } = o;
            (a || 'jump' === i) &&
              r((r) => {
                ...
                ((o.className = [...n(d), a].join(' ')), (o.dataset.order = g));
                let I = 'switch' === i ? c.get(a, v) : null;
                function j() {
                ...
                ('switch' === i && (y?.({ phase: 'init', type: i, key: a, state: I, button: o }), (I = c.get(a, v))),
                  j(),
  ...
  const y = (() => {
      ...
      return {
        apply: function ({ delay: e = 260, target: t, subjoin: o, trace: i = !1, traceQuery: c = 'a[href]', traceJudge: l }) {
          const M = Array.isArray(t) ? t : [t],
            ...
            v = `subjoin_${M.join('_')}_${d.join('_')}`;
          function g(n) {
            (d.forEach((r) => {
          ...
          function N() {
            (p(),
              ...
              s.observeWithKey(v, document.body, { childList: !0, subtree: !0 }, p, { preventDuplicate: !0, autoDisconnect: !1 }));
          }
        ...
        apply: function ({ mode: r = 'smart', loadPage: e = 9, itemTarget: t = '#container .c-container', itemWrapper: o = '#container', buttonPrev: a = '.page-prev', buttonNext: i = '.page-next', fragment: c = !1, jitter: s } = {}) {
          ...
          function p(r) {
            return new Promise((e) => {
              const o = v.get({ jitter: l, order: r });
              setTimeout(() => {
                $.get(n(r), (n) => {
              ...
              I &&
                ...
                p(g)
                  .then(() => {
                    ...
                    (n.searchParams.set('page', g), history.replaceState(null, '', n.toString()), (j = !1), (D = 0), b());
                  })
                  .finally(() => {
                    u = !1;
                  }));
    ...
    T = { PREFS: a, RUNTIME: c, REDIS: i, DOM: l, MATCH: M, SITE: d, OBSERVER: s, INFORM: u, RANDOM: v, DEBUG: N, BUTTON: m, CONFIG: g, RESOLVER: p, VERIFY: y, SCHEDULER: L, HOOK: n, ADD_CLASS: I, QUICK_READ: j, REMOVE_LIMITS: h, AUTO_LOAD: D, AUTO_EXECUTE: x };
  ((window.OVN = T),
    (function () {
    ...
    (function () {
      ...
      function s(i, l, M) {
        ...
        if (i.children && i.children.length > 0) {
          ...
          ((L.type = 'checkbox'), (L.checked = v), (L.disabled = !M), L.classList.add('ovnStatusDot', 'ovnState', 'ovnBack'), r(L, i, v), e(m, M, v));
          const I = document.createElement('div');
          ((I.className = 'ovnGroupBody'),
            ...
            i.children.forEach((n) => s(n, I, M && v)),
            c.append(g, I),
            l.appendChild(c));
        } else
          l.appendChild(
            (function (t, o) {
              ...
              return (v && a.hover.get(i, !0) && u.OVN.hover(l, v), l);
            })(i, M),
          );
      }
      function M() {
    ...
    (function () {
      function n() {
        ...
        let d = 0,
          v = 0;
        for (const n of Object.values(c)) 'done' === n.state ? d++ : v++;
        const g = `[==👽OVN==][🛸] DONE - ${d}/${d + v} | FAIL - ${v}`,
    ...
    L.run('Gallop', () => {
      !(function () {
            ...
            (v ||
              (v = requestAnimationFrame(() => {
                (!(function () {
                  ...
                  ((s.strokeStyle = M), (s.lineWidth = 2), (s.lineCap = 'round'), (s.lineJoin = 'round'), s.stroke());
                })(),
                  (v = null));
              })));
        }
        let N = !1,
          ...
          j = null;
        function h() {
          (j && (clearTimeout(j), (j = null)), window.removeEventListener('mousemove', x, !0), window.removeEventListener('mouseup', T, !0), (N = !1), (m = !1), (y = []), i && ((i.style.pointerEvents = 'none'), (i.style.display = 'none')), v && (cancelAnimationFrame(v), (v = null)), (g = !1));
        }
        function D() {
        ...
        function x(r) {
          ...
          const t = { x: r.clientX, y: r.clientY },
            ...
            d = t.y - I;
          if (!m) {
            if (!(o * o + d * d > n * n)) return;
            ((m = !0),
              (function () {
                if (!l()) return;
                const n = window.devicePixelRatio || 1;
                ((c.width = window.innerWidth * n), (c.height = window.innerHeight * n), s.setTransform(n, 0, 0, n, 0, 0), (i.style.display = 'block'), (i.style.pointerEvents = 'auto'), (M = getComputedStyle(document.documentElement).getPropertyValue('--ovnGallopTrail').trim() || '#2C2C3E50'));
              })());
          }
        ...
        function T(r) {
          ...
          if ((r.preventDefault(), r.stopPropagation(), !m)) return void h();
          ...
          if (c >= n) {
            ...
            if (e) o(e);
              ...
              const n = t(a, i);
              ['left', 'right', 'up', 'down'].includes(n) && o(n, c);
            }
          }
          D();
        }
        ...
        function z(n) {
          2 !== n.button ||
            ...
            (h(), window.addEventListener('mousemove', x, !0), window.addEventListener('mouseup', T, !0), (N = !0), (m = !1), (g = !1), (L = n.clientX), (I = n.clientY), (y = [{ x: n.clientX, y: n.clientY }]));
        }
          ...
          setTimeout(function n() {
            l()
              ? (window.addEventListener('contextmenu', w, { capture: !0, passive: !1 }),
                window.addEventListener('auxclick', b, { capture: !0, passive: !1 }),
