...
(() => {
  ...
  (r.inject(), (window.OVN_CSS_INJECTOR = r));
  const e = (() => {
      function n(n) {
        const r = new Map();
        function e(r) {
    ...
    o = (() => {
      function n(n, r = !0) {
        const t = e.prefs.get(n, void 0);
        return void 0 === t ? r : !!t;
      }
      function r(r, t) {
        const o = !!t;
        return (n(r) === o || e.prefs.set(r, o), o);
      }
      return {
        get: n,
        set: r,
    ...
    c = (() => {
      ...
      function r(r) {
        ...
        function d(n) {
          (n.firstChild !== o && n.insertBefore(o, n.firstChild), c && n.lastChild !== c && n.appendChild(c), i && (c ? i.nextSibling !== c && n.insertBefore(i, c) : n.lastChild !== i && n.appendChild(i)));
        }
        function u(n) {
          (document.body.firstChild !== n && document.body.insertBefore(n, document.body.firstChild),
            ...
            (function (n) {
              ...
              (Array.from(n.children).forEach((n) => {
                n !== o && n !== i && n !== c && (n.hasAttribute('data-ovn-frozen') || (l(n, 'style') ? M(n, o) : l(n, 'script') && M(n, i)));
              }),
                d(n));
            })(n),
            (function (n) {
                  ...
                  (r) => {
                    ...
                    (r.forEach((n) => {
                      n.addedNodes.forEach((n) => {
                        1 === n.nodeType && n !== o && n !== i && n !== c && (n.hasAttribute('data-ovn-frozen') || (l(n, 'style') ? M(n, o) && (e = !0) : l(n, 'script') ? M(n, i) && (e = !0) : (e = !0)));
                      });
                    }),
                      e && d(n));
                  },
        ...
        function v() {
          return (
            ...
            ((t = new Promise((o) => {
              function i() {
                const i = (function () {
                  if ((e && !document.contains(e) && ((e = null), (t = null), a.disconnectKey(s)), e)) return e;
                  const o = document.querySelector(`#${r}`);
                  if (o) return ((e = o), r === n && u(e), e);
                  const i = document.createElement('div');
                  return ((i.id = r), document.body.insertBefore(i, document.body.firstChild), (e = i), r === n && u(e), e);
                })();
                o(i);
              }
  ...
  const s = (() => {
      ...
      function r(r = {}) {
        const e = r.include || [],
          o = r.exclude || [],
          a = e.join('|') + '::' + o.join('|');
        return t.compute('compiledMatch', a, () => {
          const r = e.map(n),
            t = o.map(n),
            a = 1 === e.length && '*' === e[0] && 0 === o.length;
          return { test: (n) => !!a || (r.some((r) => r.test(n)) && !t.some((r) => r.test(n))) };
        });
      }
      function e(r, e) {
        return n(r).test(e);
    ...
    M = (() => {
      function n(n, r = {}) {
        const t = r.informTime || 3e3,
          o = new WeakMap();
        function a({ message: r, type: e = '', method: o = 'left', timeout: a = t }) {
          const i = document.createElement('div'),
            c = ['ovnTips', o];
          (e && c.push(e),
            (i.className = c.join(' ')),
        ...
        return {
          top: (n, r = '', e = t) => {
            a({ message: n, type: r, method: 'top', timeout: e });
          },
          left: (n, r = '', e = t) => {
            a({ message: n, type: r, method: 'left', timeout: e });
          },
          hover: function (n, r, t, a, i = 926) {
            if (!n) return;
            const c = 'string' == typeof n ? document.querySelector(n) : n;
            if (!c) return;
            const s = 'hover::' + r,
              l = e.hover.get(s) || 0;
            if ('number' == typeof t && l >= t) return;
            const M = o.get(c);
            M && (c.removeEventListener('mouseenter', M.onEnter), c.removeEventListener('mouseleave', M.onLeave), M.timerId && clearTimeout(M.timerId), M.hoverElement && M.hoverElement.remove(), o.delete(c));
            let d = null,
              u = null;
            const g = (n) => {
                ((d = setTimeout(() => {
                  ((u = document.createElement('div')), (u.className = 'ovnTips hover'), (u.textContent = r), document.body.appendChild(u));
                  const { clientX: i, clientY: M } = n,
                  ...
                  ('function' == typeof a && a(), 1 === t && (c.removeEventListener('mouseenter', g), c.removeEventListener('mouseleave', v), o.delete(c)));
                }, i)),
      ...
      return { create: n, OVN: n(c.bindOVN, { informTime: 3e3 }) };
    })();
  i.apply('inform', M);
  const d = (() => {
      function n(n = {}) {
  ...
  const g = (() => {
      ...
      for (const n in u) 'debug' !== n && (r[n] = e(u[n], [n], null));
      return {
        get: (r) => n[r],
        getFlat: () => n,
        getTree: () => r,
    ...
    v = (() => {
      ...
      function v({ icon: n, key: e, time: t, msg: o }) {
        M(t);
        const a = d(t),
          i = m(e);
        !(function (n) {
      ...
      function p(n, { level: r, msg: e, time: t }) {
        o[n] || (o[n] = {});
        const a = o[n];
        (null != t && t >= 0 ? (a.timeCost = t) : a.timeCost || (a.timeCost = 0), (a.debugLevel = r), 'error' === r && ((a.error = !0), (a.errorMSG = e)), M(a.timeCost));
      }
      function m(n) {
        const r = n.split('_');
      ...
      return {
        ...
        infoTotal: function () {
          if (n) {
            for (const [n, r] of Object.entries(o)) {
              ...
              console.log(v({ icon: e, key: n, time: r.timeCost || 0, msg: t }));
            }
            if (void 0 !== a) {
              const n = a.getActiveCount();
        ...
        getSnapshot: function () {
          ...
          for (const n in i) {
            const o = i[n],
              c = e[n] || {},
              M = { block: null, match: null, state: null, chain: null, exec: null };
            let u = '',
              g = 'idle',
              v = 0;
            for (const n of o) {
              const r = (n) => 'done' === n || ('fail' !== n && null);
              ('block' === n.step && (M.block = r(n.state)), 'match' === n.step && (M.match = r(n.state)), 'state' === n.step && (M.state = r(n.state)), 'chain' === n.step && (M.chain = r(n.state)), 'run.exec' === n.step && ((M.exec = r(n.state)), (v = n.timeCost || 0)), 'fail' === n.state && ((g = 'fail'), (u = n.step)));
            }
            'fail' !== g && (g = 'done');
            const N = m(n),
              p = l(`[${N}]`, s + 2),
            ...
            a[n] = { group: c.group || n.split('_')[0] || 'Unknown', shortName: N, timeCost: v, steps: M, state: g, reason: u, logs: t[n] || [], consoleLine: I };
          }
          for (const n in o) {
            if (a[n]) continue;
            const e = o[n],
              i = e.error ? '👾' : 'warn' === e.debugLevel ? '🛠️' : '🚀',
              ...
              v = d(M),
              N = `${r}[${i}][${v}ms]${g} | ${c}`;
            a[n] = { group: n.split('_')[0] || 'Unknown', shortName: u, timeCost: M, steps: {}, state: e.error ? 'fail' : 'done', reason: e.errorMSG || '', logs: t[n] || [], consoleLine: N };
          }
          return a;
        },
        ...
        okTrace: function (n, r, e) {
          ...
          t && ((t.state = 'done'), (t.timeCost = performance.now() - t.time), (t.detail = e), M(t.timeCost));
        },
        failTrace: function (n, r, e) {
          const t = y(n).find((n) => n.step === r && 'pending' === n.state);
          t && ((t.state = 'fail'), (t.reason = e), (t.timeCost = performance.now() - t.time), M(t.timeCost));
        },
        skipTrace: function (n, r, e) {
          y(n).push({ step: r, state: 'skip', reason: e });
        },
        format: function ({ icon: n, key: r, time: e, msg: t }) {
          return v({ icon: n, key: r, time: e, msg: t });
        },
      };
    })(),
    N = (() => {
      ...
      function r(r, t) {
        return function (a = {}) {
          ...
          i.forEach((a) => {
            const { key: i, type: c = 'switch', name: s = ['ON', 'OFF'], color: l = ['var(--ovnAccentHEX)', 'var(--ovnBase04HEX)'], group: d = t, class: u = [], default: g = !0, order: v = 50, inform: N = !0, reload: p = !1, map: m, onClick: y, onMounted: I } = a;
            (i || 'jump' === c) &&
              r((r) => {
                ...
                if ('jump' === c && m)
                  return void Object.entries(m).forEach(([o, a]) => {
                    ...
                    ((i.className = [...n(u)].join(' ')),
                      ...
                      (i.dataset.order = v),
                      (i.onclick = () => {
                        (y?.({ phase: 'action', type: 'jump', label: o, url: a, button: i }), N && M.top(`Jump TO ${o}`, 'correct'), y || (location.href = a), p && location.reload());
                      }),
                      e(t, i, v),
                      I?.(i));
                  });
                ...
                ((a.className = [...n(u), i].join(' ')), (a.dataset.order = v));
                let j = 'switch' === c ? o.get(i, g) : null;
                function h() {
                  if ('switch' !== c) return void (a.textContent = n(s)[0] || 'RUN');
                  const r = n(s),
                    e = n(l);
                  ((a.textContent = j ? r[0] : r[1]), (a.style.background = j ? e[0] : e[1]));
                }
                (h(),
                  'switch' === c && y?.({ phase: 'init', type: c, key: i, state: j, button: a }),
                  a.addEventListener('click', () => {
                    if ('switch' === c) {
                      if (((j = o.toggle(i)), h(), y?.({ phase: 'toggle', type: c, key: i, state: j, button: a }), N)) {
                        const r = j ? n(s)[0] || 'ON' : n(s)[1] || 'OFF';
                        M.top(`${i}: ${r}`, 'correct');
                      }
                    } else (y?.({ phase: 'action', type: c, key: i, button: a }), N && M.top(`${n(s)[0] || i} 已执行`, 'correct'));
                    p && location.reload();
                  }),
                  e(t, a, v),
                  I?.(a));
      ...
      return { create: r, bindOVN: r(c.bindOVN, ['ovnButtonBase', 'ovnButtonUnder']) };
    })();
  i.apply('button', N);
  const p = (() => {
      function n(n) {
      ...
      return {
        check: function (n, a) {
          ...
          for (const [r, e] of i) {
            v?.startTrace?.(n.key, r);
            const t = e(n, a);
            if (!t.ready) return (v?.failTrace?.(n.key, r, t.reason), t);
            v?.okTrace?.(n.key, r);
          }
          return { ready: !0 };
        },
    ...
    m = (() => {
      ...
      function a() {
        ...
        n.length = 0;
        const a = (n, r) => {
          for (const e of n) (v?.startTrace?.(e.mod.key, `phase.${r}`), v?.startTrace?.(e.mod.key, 'run.exec'), t(e.mod, e.callback), v?.okTrace?.(e.mod.key, 'run.exec'), v?.okTrace?.(e.mod.key, `phase.${r}`));
        };
      ...
      return {
        run: function (e, i, c = {}) {
          if (void 0 === e) return (a(), !0);
          const s = g.resolve(e);
          if (!s) return (v?.failTrace?.(e, 'resolve', 'NOT_FOUND'), !1);
          const l = g.get(s);
          if (!l) return (v?.skipTrace?.(s, 'run', 'NO_MODULE'), !1);
          v?.startTrace?.(s, 'run');
          const M = (function (n, r = {}) {
              return { url: r.url || location.href, runtime: o, group: g.get(n.group), chain: g.getChain(n.key) };
            })(l, c),
            d = p.check(l, M);
          if (!d.ready) return (v?.failTrace?.(s, 'final', d.reason), !1);
          if ('function' != typeof i) return (v?.failTrace?.(s, 'run', 'NO_FUNC'), !1);
          if (
            !(function (n) {
              return (n.depend && n.depend.length > 0) || (n.phase && 'none' !== n.phase) || n.priority > 0;
            })(l)
          ) {
            v?.startTrace?.(s, 'run.exec');
            performance.now();
            return (t(l, i), v?.okTrace?.(s, 'run.exec'), !0);
          }
          return (n.push({ mod: l, callback: i }), r || ((r = !0), Promise.resolve().then(a)), !0);
        },
      };
    })(),
    y = (() => {
      const n = 'visited',
        r = 'data-ovn-trace';
      return {
        apply: function ({ delay: t = 260, target: o, subjoin: i, trace: c = !1, traceQuery: s = 'a[href]', traceJudge: l }) {
          const M = Array.isArray(o) ? o : [o],
            d = Array.isArray(i) ? i : [i],
            u = new Set(JSON.parse(e.visited.get(n, '[]'))),
            g = `subjoin_${M.join('_')}_${d.join('_')}`;
          function v(n) {
            (d.forEach((r) => {
          ...
          function p() {
            (N(),
              document.body.addEventListener('click', (r) => {
                const t = r.target.closest(s);
                if (!t) return;
                const o = t.getAttribute('href');
                o &&
                  ('function' == typeof l ? l(o) : !Array.isArray(l) || l.every((n) => o.includes(n))) &&
                  (u.add(o),
                  e.visited.set(n, JSON.stringify([...u])),
                  M.forEach((n) => {
                    const r = t.closest(n);
                    r && v(r);
                  }));
              }),
              a.observeWithKey(g, document.body, { childList: !0, subtree: !0 }, N, { preventDuplicate: !0, autoDisconnect: !1 }));
          }
      ...
      return {
        apply: function ({ mode: r = 'smart', loadPage: e = 9, itemTarget: t = '#container .c-container', itemWrapper: o = '#container', buttonPrev: a = '.page-prev', buttonNext: i = '.page-next', fragment: c = !1, jitter: s } = {}) {
          const l = s || { delay: 30, interval: 30, random: 70 },
            ...
            u = 'string' == typeof o ? document.querySelector(o) : o;
          if (!u) return;
          let g = !1,
            v = M;
          function N(r) {
            return new Promise((e) => {
              const o = d.get({ jitter: l, order: r });
              setTimeout(() => {
                $.get(n(r), (n) => {
                  const r = document.createElement('div');
                  r.innerHTML = n;
                  const o = r.querySelectorAll(t),
                    a = c ? document.createDocumentFragment() : u;
                  (o.forEach((n) => {
                    (n.classList.add('ovnFadeInLoad'), a.appendChild(n));
                  }),
                    c && u.appendChild(a),
                    requestAnimationFrame(() => {
                      u.querySelectorAll('.ovnFadeInLoad:not(.ovnLoaded)').forEach((n) => {
          ...
          if ('multipage' === r) {
            ...
            p && ((p.href = n(M + e + 1)), (p.textContent = `Next ${e + 1}`));
            const m = [];
            for (let y = 1; y <= e; y++) {
              const I = M + y;
              m.push(N(I));
      ...
      return {
        apply: function (e = {}) {
          const { jitter: t, delay: o, interval: a, random: i, backstage: c = !1, strict: s = !1, debug: l = !1 } = e,
            M = t || { delay: o || 200, interval: a || 20, random: i || 0 },
            u = [];
          for (let n = 1; n <= 10; n++) {
            const r = `step${n}`;
            e[r] && u.push(e[r]);
                      ...
                      d.run(
                        () => {
                          ...
                          try {
                            ...
                            t ? (r(t, i), v.log(n, `Step${e + 1} ✅ ${i} - ${a}`)) : (v.warn(n, `Step${e + 1} ❓ None - ${a}`), s && ((N = !0), v.error(n, `Step${e + 1} ❌ Break`)));
                          } catch (r) {
                            (v.error(n, `Step${e + 1} ❌ Error - ${r.message}`, 0, r.stack), s && (N = !0));
                          }
                          o();
                        },
                        { jitter: M, order: e },
    ...
    D = { PREFS: e, RUNTIME: o, REDIS: t, DOM: c, MATCH: s, SITE: l, OBSERVER: a, INFORM: M, RANDOM: d, DEBUG: v, BUTTON: N, CONFIG: u, RESOLVER: g, VERIFY: p, SCHEDULER: m, HOOK: i, ADD_CLASS: y, QUICK_READ: I, REMOVE_LIMITS: j, AUTO_LOAD: h, AUTO_EXECUTE: L };
  ((window.OVN = D),
    (function () {
        ...
        c = () => {
          const o = document.documentElement,
            a =
              ...
              'light';
          a !== e && (o.classList.remove('ovnThemeLight', 'ovnThemeDark'), o.classList.add('light' === a ? 'ovnThemeLight' : 'ovnThemeDark'), (e = a));
        },
        s = () => {
          ...
          n.forEach((n, e) => {
            a.observeWithKey(`ovnTheme_${e}`, n, { attributes: !0 }, r, { preventDuplicate: !0, autoDisconnect: !1 });
          });
        };
      (() => {
        const n = () => {
          (c(), s(), window.matchMedia('(prefers-color-scheme: dark)').addEventListener('change', c), window.matchMedia('(prefers-color-scheme: light)').addEventListener('change', c));
        };
    ...
    (function () {
      ...
      function i(n, r, t, o, a) {
        let i = e.fold.get(o, a);
        (i ? (r.classList.add('ovnClose'), (r.style.height = '0px'), t.classList.remove('ovnRotated')) : ((r.style.height = 'auto'), t.classList.add('ovnRotated')),
          n.addEventListener('click', (n) => {
            if ((n.stopPropagation(), (i = !i), e.fold.set(o, i), r.classList.add('ovnOpen'), i)) {
            ...
            t.classList.toggle('ovnRotated', !i);
          }));
      }
      function s(n, e) {
        n.querySelectorAll('input[type=checkbox]').forEach((n) => {
          const t = n.id?.replace('ovnChild_', '');
          if (!t) return;
          const i = g.get(t),
            c = n.closest('.ovnBodyRow, .ovnHeaderRow');
          if (!c) return;
          n.disabled = !e;
          const s = o.get(t, i?.default ?? !0);
          ((n.checked = !!e && s), r(n, i || {}, n.checked), a(c, e, n.checked));
        });
      }
      function l(t, c, d) {
        const u = t.key,
          g = o.get(u, t.default ?? !0);
        if (t.children && t.children.length > 0) {
          const o = document.createElement('div');
          o.className = 'ovnGroupBase Sub';
          const v = document.createElement('div');
          v.className = 'ovnGroupHead';
          const N = document.createElement('div');
          ((N.className = 'ovnFoldBox'), (N.style.cursor = 'pointer'), e.hover.get(u, !0) && M.OVN.hover(N, 'HEIHEI 彩蛋 | ClickClick', 2));
          ...
          ((I.type = 'checkbox'), (I.checked = g), (I.disabled = !d), I.classList.add('ovnStatusDot', 'ovnState', 'ovnBack'), r(I, t, g), a(m, d, g));
          ...
          ((j.className = 'ovnGroupBody'),
            ...
            I.addEventListener('change', () => {
              const e = I.checked;
              (n.set(u, e), r(I, t, e), a(m, d, e), s(j, d && e));
            }),
            m.append(y, I),
            v.append(N, m),
            i(N, j, p, `fold_${u}`, t.fold ?? !1),
            t.children.forEach((n) => l(n, j, d && g)),
            o.append(v, j),
            c.appendChild(o));
        } else
          c.appendChild(
            (function (t, i) {
              ...
              ((u.type = 'checkbox'),
                ...
                u.addEventListener('change', () => {
                  (n.set(c, u.checked), r(u, t, u.checked), a(l, i, u.checked));
                }),
                l.append(d, u));
              const g = t.error ? t.errorMSG : t.feature;
              return (g && e.hover.get(c, !0) && M.OVN.hover(l, g), l);
            })(t, d),
          );
      }
      function d() {
        const a = document.querySelector('#ovnOptionsPanel');
        if (a) return (a.classList.add('ovnHide'), void setTimeout(() => a.remove(), 526));
        ...
        Object.values(N).forEach((e) => {
          const t = o.get(e.key, !0),
            a = document.createElement('div');
          a.className = 'ovnGroupBase';
          const c = document.createElement('div');
          c.className = 'ovnGroupHead';
          const M = document.createElement('div');
          M.className = 'ovnFoldBox';
          const d = document.createElement('div');
          ((d.className = 'ovnArrow'), (d.textContent = '›'), M.appendChild(d));
          ...
          ((p.className = 'ovnGroupBody'),
            N.addEventListener('change', () => {
              const t = N.checked;
              (n.set(e.key, t), r(N, e, t), s(p, t));
            }),
            u.append(g, N),
            c.append(M, u),
            i(M, p, d, `fold_${e.key}`, e.fold ?? !1),
            e.children.forEach((n) => l(n, p, t)),
            a.append(c, p),
            v.appendChild(a));
        });
        ...
        ((p.textContent = 'Apply'),
          ...
          (p.onclick = () => {
            (n.forEach((n, r) => o.set(r, n)), M.OVN.top('已应用 即将刷新', 'correct'), setTimeout(() => location.reload(), 1260));
          }));
        const m = document.createElement('button');
        ((m.textContent = 'Reset'),
          (m.className = 'ovnButtonBase ovnButtonAdapt ovnReset'),
          (m.onclick = () => {
            (e.reset(), t.clear(), M.OVN.top('已重置 即将刷新', 'correct'), setTimeout(() => location.reload(), 1260));
          }));
        const y = document.createElement('div');
        ((y.className = 'ovnButton'),
          y.append(p, m),
          d.append(v, y),
          c.bindOVN((n) => n.appendChild(d)),
    ...
    (function () {
      function n() {
        ...
        let u = 0,
          N = 0;
        for (const n of Object.values(l)) 'done' === n.state ? u++ : N++;
        const p = `[==👽OVN==][🛸] DONE - ${u}/${u + N} | FAIL - ${N}`,
          m = document.createElement('div');
        m.className = 'ovnDebugGrid';
        const y = g.getTree(),
          I = Object.keys(y),
          j = [...I.filter((n) => d[n]), ...Object.keys(d).filter((n) => !I.includes(n))];
        for (const n of j) {
          const r = d[n];
          if (!r) continue;
          const e = document.createElement('div');
      ...
      (v || void 0 !== v || console.warn('[==👽OVN==] OVN_Debug | OVN_GLOBAL_DEBUG not available yet, will retry on demand'),
              ...
              if (o >= i) {
                ...
                const r = (function (n) {
                  ...
                  const a = Math.min(o, n.length - 1),
                    ...
                    c = Math.abs(n[n.length - 1].y - n[a].y);
                  return i < s || c < s ? null : 'up' === e && 'down' === t ? 'up-down' : 'down' === e && 'up' === t ? 'down-up' : null;
                })(y);
                if (r) S(r);
                else {
                  const n = z(e, t);
        ...
        o &&
          (o.startsWith('--') &&
            (o = getComputedStyle(document.documentElement)
              ...
              .replace(/^url\(["']?(.*?)["']?\)$/i, '$1')
              .replace(/["']/g, '')),
          o && (document.head ? c(o) : document.addEventListener('DOMContentLoaded', () => c(o)), 'loading' === document.readyState ? document.addEventListener('DOMContentLoaded', () => setTimeout(s, 126)) : setTimeout(s, 126)));
      })();
    }),
    m.run('Selection', () => {
  ...
  (m.run('YUQUE', () => {
    ...
    m.run('ovnTable', () => {
      y.apply({ target: ['#main table:not(.data-table-card table)'], subjoin: ['ovnTable'] });
    }),
    m.run('ovnGrid', () => {
      y.apply({ target: ['.ne-editor-wrap-content', '.ne-viewer-layout-mode-fixed .ne-viewer-body'], subjoin: ['ovnGrid', 'ovnSolid'] });
    }));
  m.run('TickTick', () => {
  ...
  function x() {
    try {
      const n = document.documentElement;
      (n.classList.add('ovn'), i.apply('class', { html: n }), n.classList.contains('ovnThemeLight') && (n.classList.remove('ovnThemeLight'), n.classList.add('ovnThemeLight')), D.SCHEDULER.run(), D.DEBUG.infoTotal());
    } catch (n) {
