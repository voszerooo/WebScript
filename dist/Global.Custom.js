...
(() => {
        ...
        getSnapshot: function () {
          ...
          for (const n in a) {
            ...
            const p = m(n),
              N = l(`[${p}]`, s + 2),
              L = M(g),
              y = `${r}[${'fail' === v ? '👾' : '🚀'}][${L}ms]${N} | ${'fail' === v ? `FAIL - ${u}` : 'DONE'}`;
            i[n] = { group: c.group || n.split('_')[0] || 'Unknown', shortName: p, timeCost: g, steps: d, state: v, reason: u, logs: t[n] || [], consoleLine: y };
          }
          for (const n in o) {
            if (i[n]) continue;
            const e = o[n],
    ...
    N = (() => {
      ...
      function r(r, t) {
        return function (o = {}) {
          ...
          a.forEach((o) => {
            const { key: a, type: c = 'switch', name: s = ['ON', 'OFF'], color: l = ['var(--ovnAccentHEX)', 'var(--ovnBase04HEX)'], group: d = t, class: u = [], default: v = !0, order: g = 50, inform: p = !0, reload: N = !1, map: m, onClick: L, onMounted: y } = o;
            (a || 'jump' === c) &&
              r((r) => {
                ...
                if ('jump' === c && m)
                  return void Object.entries(m).forEach(([o, a]) => {
                    ...
                    ((i.className = [...n(u)].join(' ')),
                      ...
                      (i.dataset.order = g),
                      (i.onclick = () => {
                        (L?.({ phase: 'action', type: 'jump', label: o, url: a, button: i }), p && M.top(`Jump TO ${o}`, 'correct'), L || (location.href = a), N && location.reload());
                      }),
                      e(t, i, g),
                      y?.(i));
                  });
                ...
                (j(),
                  'switch' === c && L?.({ phase: 'init', type: c, key: a, state: I, button: o }),
                  o.addEventListener('click', () => {
                    if ('switch' === c) {
                      if (((I = i.toggle(a)), j(), L?.({ phase: 'toggle', type: c, key: a, state: I, button: o }), p)) {
                        const r = I ? n(s)[0] || 'ON' : n(s)[1] || 'OFF';
                        M.top(`${a}: ${r}`, 'correct');
                      }
                    } else (L?.({ phase: 'action', type: c, key: a, button: o }), p && M.top(`${n(s)[0] || a} 已执行`, 'correct'));
                    N && location.reload();
                  }),
                  e(t, o, g),
                  y?.(o));
  ...
  const m = (() => {
    ...
    x = { PREFS: o, RUNTIME: i, REDIS: a, DOM: s, MATCH: l, SITE: d, OBSERVER: c, INFORM: M, RANDOM: u, DEBUG: p, BUTTON: N, CONFIG: v, RESOLVER: g, VERIFY: m, SCHEDULER: L, HOOK: n, ADD_CLASS: y, QUICK_READ: I, REMOVE_LIMITS: j, AUTO_LOAD: h, AUTO_EXECUTE: D };
  ((window.OVN = x),
    (function () {
    ...
    (function () {
      ...
      function l(a, s, d) {
        ...
        if (a.children && a.children.length > 0) {
          ...
          ((y.type = 'checkbox'), (y.checked = v), (y.disabled = !d), y.classList.add('ovnStatusDot', 'ovnState', 'ovnBack'), r(y, a, v), e(m, d, v));
          const I = document.createElement('div');
          ((I.className = 'ovnGroupBody'),
            ...
            y.addEventListener('change', () => {
              const t = y.checked;
              (n.set(u, t), r(y, a, t), e(m, d, t), c(I, d && t));
            }),
            m.append(L, y),
            g.append(p, m),
            t(p, I, N, `fold_${u}`, a.fold ?? !1),
    ...
    (function () {
      function n() {
        ...
        const L = g.getTree(),
          y = Object.keys(L),
          I = [...y.filter((n) => d[n]), ...Object.keys(d).filter((n) => !y.includes(n))];
        for (const n of I) {
          const r = d[n];
          if (!r) continue;
          const e = document.createElement('div');
    ...
    L.run('Gallop', () => {
      !(function () {
        ...
        function k(n = !1) {
          const r = () => {
            ((g = !1), (p = !1), (N = !1), (L = []), j && (j.style.opacity = '0'), document.documentElement.classList.remove('gesture-active'), window.removeEventListener('mousemove', _, !0), window.removeEventListener('mouseup', U, !0), m && clearTimeout(m), x && (cancelAnimationFrame(x), (x = null)));
          };
        ...
        function B(n) {
          2 !== n.button ||
            ...
            (m && (clearTimeout(m), (m = null)), k(!0), (g = !0), (p = !1), (N = !1), (y = n.clientX), (I = n.clientY), (L = [{ x: n.clientX, y: n.clientY }]), document.documentElement.classList.add('gesture-active'), window.addEventListener('mousemove', _, !0), window.addEventListener('mouseup', U, !0));
        }
        function _(n) {
          if (!g) return;
          if (O) return void k(!0);
          ((p = !0), n.preventDefault(), n.stopPropagation());
        ...
        function Y(n) {
          ...
          (document.addEventListener('mousedown', B, { capture: !0, passive: !1, signal: e }),
            window.addEventListener('blur', () => k(!0), { signal: e }),
        ...
        (window.addEventListener('compositionstart', () => {
          ...
          window.addEventListener(
            'contextmenu',
            (n) => {
              g && p && (n.preventDefault(), n.stopPropagation(), n.stopImmediatePropagation());
            },
            { capture: !0, passive: !1 },
          ),
          void 0 !== s && s.bindOVN
