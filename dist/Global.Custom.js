...
(() => {
      ...
      const r = n || e,
        t = () => {
          try {
            ...
            let e = document.getElementById('ovnStyle');
            (e || ((e = document.createElement('div')), (e.id = 'ovnStyle'), n.insertBefore(e, n.firstChild)), (this.styleContainer = e));
            const o = this.styleContainer.querySelectorAll('style[data-ovn-style-global]');
            for (let n = 0; n < o.length; n++) o[n].remove();
            ((this.styleElement = document.createElement('style')), this.styleElement.setAttribute('data-ovn-style-global', ''), (this.styleElement.textContent = r), this.styleContainer.insertBefore(this.styleElement, this.styleContainer.firstChild), this.version++);
          } catch (n) {
  ...
  (o.classList.add('ovn'), n.apply('class', { html: o }), (window.OVN_CSS_INJECTOR = t));
  const a = (() => {
      function n(n) {
        const r = new Map();
        function e(r) {
    ...
    c = (() => {
      function n(n, r = !0) {
        const e = a.prefs.get(n, void 0);
        return void 0 === e ? r : !!e;
      }
      function r(r, e) {
        const t = !!e;
        return (n(r) === t || a.prefs.set(r, t), t);
      }
      return {
        get: n,
        set: r,
          ...
          (document.body.firstChild !== n && document.body.insertBefore(n, document.body.firstChild),
            ...
            (function (n) {
              ...
              (Array.from(n.children).forEach((n) => {
                n !== o && n !== a && n !== i && (n.hasAttribute('data-ovn-frozen') || (M(n, 'style') ? l(n, o) : M(n, 'script') && l(n, a)));
              }),
                d(n));
            })(n),
            (function (n) {
                  ...
                  (r) => {
                    ...
                    (r.forEach((n) => {
                      n.addedNodes.forEach((n) => {
                        1 === n.nodeType && n !== o && n !== a && n !== i && (n.hasAttribute('data-ovn-frozen') || (M(n, 'style') ? l(n, o) && (e = !0) : M(n, 'script') ? l(n, a) && (e = !0) : (e = !0)));
                      });
                    }),
                      e && d(n));
                  },
        ...
        function v() {
          return (
            ...
            ((t = new Promise((o) => {
              function a() {
                const a = (function () {
                  if ((e && !document.contains(e) && ((e = null), (t = null), s.disconnectKey(c)), e)) return e;
  ...
  const l = (() => {
      ...
      function r(r = {}) {
        const e = r.include || [],
          t = r.exclude || [],
          o = e.join('|') + '::' + t.join('|');
        return i.compute('compiledMatch', o, () => {
          const r = e.map(n),
            o = t.map(n),
    ...
    u = (() => {
      function n(n, r = {}) {
        const e = r.informTime || 3e3,
          t = new WeakMap();
        function o({ message: r, type: t = '', method: o = 'left', timeout: a = e }) {
        ...
        return {
          top: (n, r = '', t = e) => {
            o({ message: n, type: r, method: 'top', timeout: t });
          },
          left: (n, r = '', t = e) => {
            o({ message: n, type: r, method: 'left', timeout: t });
          },
          hover: function (n, r, e, o, i = 926) {
            if (!n) return;
            ...
            const l = t.get(c);
            l && (c.removeEventListener('mouseenter', l.onEnter), c.removeEventListener('mouseleave', l.onLeave), l.timerId && clearTimeout(l.timerId), l.hoverElement && l.hoverElement.remove(), t.delete(c));
            let d = null,
              u = null;
            const g = (n) => {
                ((d = setTimeout(() => {
                  ...
                  ('function' == typeof o && o(), 1 === e && (c.removeEventListener('mouseenter', g), c.removeEventListener('mouseleave', v), t.delete(c)));
                }, i)),
                  t.set(c, { timerId: d, hoverElement: u, onEnter: g, onLeave: v }));
              },
              v = () => {
            ...
            (c.addEventListener('mouseenter', g), c.addEventListener('mouseleave', v), t.set(c, { timerId: d, hoverElement: u, onEnter: g, onLeave: v }));
          },
        };
      }
      ...
      return {
        log: function (r, t = 'DONE', o = 0, a) {
          const i = u({ icon: '🚀', key: r, time: o, msg: t }),
            c = a ? `${i} | ${a}` : i;
          return (e.push(c), n && console.log(c), g(r, c), p(r, { level: 'log', msg: t, time: o }), c);
        },
        warn: function (r, t = 'DEBUG', o = 0, a) {
          const i = u({ icon: '🛠️', key: r, time: o, msg: t }),
            c = a ? `${i} | ${a}` : i;
          return (e.push(c), n && console.warn(c), g(r, c), p(r, { level: 'warn', msg: t, time: o }), c);
        },
        error: function (r, t = 'ERROR', o = 0, a) {
          const i = u({ icon: '👾', key: r, time: o, msg: t }),
            c = a ? `${i} | ${a}` : i;
          return (e.push(c), n && console.error(c), g(r, c), p(r, { level: 'error', msg: t, time: o }), c);
        },
        getLogs: function (n) {
          return t[n] || [];
        },
    ...
    m = (() => {
      ...
      function r(r, t) {
        return function (o = {}) {
          ...
          a.forEach((o) => {
            const { key: a, type: i = 'switch', name: s = ['ON', 'OFF'], color: M = ['var(--ovnAccentHEX)', 'var(--ovnBase04HEX)'], group: l = t, class: d = [], default: g = !0, order: v = 50, inform: N = !0, reload: p = !1, map: m, onClick: L, onMounted: I } = o;
            (a || 'jump' === i) &&
              r((r) => {
                ...
                if ('jump' === i && m)
                  return void Object.entries(m).forEach(([o, a]) => {
                    ...
                    ((i.className = [...n(d)].join(' ')),
                      (i.textContent = o),
                      (i.dataset.jump = o),
                      (i.dataset.order = v),
                      (i.onclick = () => {
                        (L?.({ phase: 'action', type: 'jump', label: o, url: a, button: i }), N && u.top(`Jump TO ${o}`, 'correct'), L || (location.href = a), p && location.reload());
                      }),
                      e(t, i, v),
                      I?.(i));
                  });
                ...
                ((o.className = [...n(d), a].join(' ')), (o.dataset.order = v));
                let y = 'switch' === i ? c.get(a, g) : null;
                function j() {
                  if ('switch' !== i) return void (o.textContent = n(s)[0] || 'RUN');
                  const r = n(s),
                    e = n(M);
                  ((o.textContent = y ? r[0] : r[1]), (o.style.background = y ? e[0] : e[1]));
                }
                (j(),
                  'switch' === i && L?.({ phase: 'init', type: i, key: a, state: y, button: o }),
                  o.addEventListener('click', () => {
                    if ('switch' === i) {
                      if (((y = c.toggle(a)), j(), L?.({ phase: 'toggle', type: i, key: a, state: y, button: o }), N)) {
                        const r = y ? n(s)[0] || 'ON' : n(s)[1] || 'OFF';
                        u.top(`${a}: ${r}`, 'correct');
                      }
                    } else (L?.({ phase: 'action', type: i, key: a, button: o }), N && u.top(`${n(s)[0] || a} 已执行`, 'correct'));
                    p && location.reload();
                  }),
                  e(t, o, v),
                  I?.(o));
  ...
  const L = (() => {
    ...
    I = (() => {
      ...
      return {
        run: function (e, a, i = {}) {
          ...
          const M = N.get(s);
          if (!M) return (p?.skipTrace?.(s, 'run', 'NO_MODULE'), !1);
          p?.startTrace?.(s, 'run');
          const l = (function (n, r = {}) {
              return { url: r.url || location.href, runtime: c, group: N.get(n.group), chain: N.getChain(n.key) };
            })(M, i),
            d = L.check(M, l);
          if (!d.ready) return (p?.failTrace?.(s, 'final', d.reason), !1);
          ...
          if (
            ...
            performance.now();
            return (t(M, a), p?.okTrace?.(s, 'run.exec'), !0);
          }
          return (n.push({ mod: M, callback: a }), r || ((r = !0), Promise.resolve().then(o)), !0);
        },
      };
    })(),
    y = (() => {
      const n = 'visited',
        r = 'data-ovn-trace';
      return {
        apply: function ({ delay: e = 260, target: t, subjoin: o, trace: i = !1, traceQuery: c = 'a[href]', traceJudge: M }) {
          const l = Array.isArray(t) ? t : [t],
            d = Array.isArray(o) ? o : [o],
            u = new Set(JSON.parse(a.visited.get(n, '[]'))),
            ...
            l.forEach((n) => {
              document.querySelectorAll(n).forEach((n) => {
                n.hasAttribute(r) ||
                  (i
                    ? (function (n) {
                        return [...n.querySelectorAll(c)].some((n) => {
          ...
          function p() {
            (N(),
              document.body.addEventListener('click', (r) => {
                const e = r.target.closest(c);
                if (!e) return;
                const t = e.getAttribute('href');
                t &&
                  ('function' == typeof M ? M(t) : !Array.isArray(M) || M.every((n) => t.includes(n))) &&
                  (u.add(t),
                  a.visited.set(n, JSON.stringify([...u])),
                  l.forEach((n) => {
                    const r = e.closest(n);
                    r && v(r);
                  }));
              }),
              s.observeWithKey(g, document.body, { childList: !0, subtree: !0 }, N, { preventDuplicate: !0, autoDisconnect: !1 }));
          }
        ...
        apply: function ({ mode: r = 'smart', loadPage: e = 9, itemTarget: t = '#container .c-container', itemWrapper: o = '#container', buttonPrev: a = '.page-prev', buttonNext: i = '.page-next', fragment: c = !1, jitter: s } = {}) {
          ...
          function N(r) {
            return new Promise((e) => {
              const o = g.get({ jitter: M, order: r });
              setTimeout(() => {
                $.get(n(r), (n) => {
              ...
              y &&
                ...
                N(v)
                  .then(() => {
                    ...
                    (n.searchParams.set('page', v), history.replaceState(null, '', n.toString()), (j = !1), (h = 0), w());
                  })
                  .finally(() => {
                    u = !1;
                  }));
                      ...
                      g.run(
                        () => {
                          ...
                          try {
                            ...
                            t ? (r(t, i), p.log(n, `Step${e + 1} ✅ ${i} - ${a}`)) : (p.warn(n, `Step${e + 1} ❓ None - ${a}`), s && ((v = !0), p.error(n, `Step${e + 1} ❌ Break`)));
                          } catch (r) {
                            (p.error(n, `Step${e + 1} ❌ Error - ${r.message}`, 0, r.stack), s && (v = !0));
                          }
                          o();
                        },
                        { jitter: l, order: e },
    ...
    T = { PREFS: a, RUNTIME: c, REDIS: i, DOM: M, MATCH: l, SITE: d, OBSERVER: s, INFORM: u, RANDOM: g, DEBUG: p, BUTTON: m, CONFIG: v, RESOLVER: N, VERIFY: L, SCHEDULER: I, HOOK: n, ADD_CLASS: y, QUICK_READ: j, REMOVE_LIMITS: D, AUTO_LOAD: h, AUTO_EXECUTE: x };
  ((window.OVN = T),
    (function () {
      ...
      const t = (n, r) => {
        ...
        c = () => {
          ...
          n.forEach((n, e) => {
            s.observeWithKey(`ovnTheme_${e}`, n, { attributes: !0 }, r, { preventDuplicate: !0, autoDisconnect: !1 });
          });
        };
      (() => {
        const n = () => {
          (i(), c(), window.matchMedia('(prefers-color-scheme: dark)').addEventListener('change', i), window.matchMedia('(prefers-color-scheme: light)').addEventListener('change', i));
        };
    ...
    (function () {
      ...
      function t(n, r, e, t, o) {
        let i = a.fold.get(t, o);
        (i ? (r.classList.add('ovnClose'), (r.style.height = '0px'), e.classList.remove('ovnRotated')) : ((r.style.height = 'auto'), e.classList.add('ovnRotated')),
          n.addEventListener('click', (n) => {
            if ((n.stopPropagation(), (i = !i), a.fold.set(t, i), r.classList.add('ovnOpen'), i)) {
      ...
      function o(n, t) {
        n.querySelectorAll('input[type=checkbox]').forEach((n) => {
          ...
          if (!o) return;
          const a = N.get(o),
            i = n.closest('.ovnBodyRow, .ovnHeaderRow');
          if (!i) return;
          n.disabled = !t;
          const s = c.get(o, a?.default ?? !0);
          ((n.checked = !!t && s), r(n, a || {}, n.checked), e(i, t, n.checked));
        });
      }
      function s(i, M, l) {
        const d = i.key,
          g = c.get(d, i.default ?? !0);
        if (i.children && i.children.length > 0) {
          const c = document.createElement('div');
          c.className = 'ovnGroupBase Sub';
          const v = document.createElement('div');
          v.className = 'ovnGroupHead';
          const N = document.createElement('div');
          ((N.className = 'ovnFoldBox'), (N.style.cursor = 'pointer'), a.hover.get(d, !0) && u.OVN.hover(N, 'HEIHEI 彩蛋 | ClickClick', 2));
          const p = document.createElement('div');
          ((p.className = 'ovnArrow'), (p.textContent = '›'), N.appendChild(p));
          const m = document.createElement('label');
          m.className = 'ovnHeaderRow';
          const L = document.createElement('span');
          ((L.textContent = d.split('_').pop()), (L.style.marginRight = 'auto'));
          const I = document.createElement('input');
          ((I.type = 'checkbox'), (I.checked = g), (I.disabled = !l), I.classList.add('ovnStatusDot', 'ovnState', 'ovnBack'), r(I, i, g), e(m, l, g));
          ...
          ((y.className = 'ovnGroupBody'),
            ...
            I.addEventListener('change', () => {
              const t = I.checked;
              (n.set(d, t), r(I, i, t), e(m, l, t), o(y, l && t));
            }),
            m.append(L, I),
            v.append(N, m),
            t(N, y, p, `fold_${d}`, i.fold ?? !1),
            i.children.forEach((n) => s(n, y, l && g)),
            c.append(v, y),
            M.appendChild(c));
        } else
          M.appendChild(
            (function (t, o) {
              const i = t.key,
                s = c.get(i, t.default ?? !0),
                M = document.createElement('label');
              M.className = 'ovnBodyRow';
              const l = document.createElement('span');
              l.textContent = i.split('_').pop();
              const d = document.createElement('input');
              ((d.type = 'checkbox'),
                (d.checked = s),
                (d.disabled = !o),
                (d.id = `ovnChild_${i}`),
                d.classList.add('ovnStatusDot', 'ovnState', 'ovnBack'),
                r(d, t, s),
                e(M, o, s),
                d.addEventListener('change', () => {
                  (n.set(i, d.checked), r(d, t, d.checked), e(M, o, d.checked));
                }),
                M.append(l, d));
              const g = t.error ? t.errorMSG : t.feature;
              return (g && a.hover.get(i, !0) && u.OVN.hover(M, g), M);
            })(i, l),
          );
      }
      function l() {
        ...
        ((d.textContent = 'Options'), l.appendChild(d));
        const g = document.createElement('div');
        g.className = 'ovnPanelBody';
        const v = N.getTree();
        Object.values(v).forEach((e) => {
          const a = c.get(e.key, !0),
            i = document.createElement('div');
          i.className = 'ovnGroupBase';
          ...
          ((N.type = 'checkbox'), (N.checked = a), N.classList.add('ovnStatusDot', 'ovnState', 'ovnBack'), r(N, e, a));
          const p = document.createElement('div');
          ((p.className = 'ovnGroupBody'),
            N.addEventListener('change', () => {
              const t = N.checked;
              (n.set(e.key, t), r(N, e, t), o(p, t));
            }),
            u.append(v, N),
            M.append(l, u),
            t(l, p, d, `fold_${e.key}`, e.fold ?? !1),
            e.children.forEach((n) => s(n, p, a)),
            i.append(M, p),
            g.appendChild(i));
        });
        ...
        ((p.textContent = 'Apply'),
          ...
          (p.onclick = () => {
            (n.forEach((n, r) => c.set(r, n)), u.OVN.top('已应用 即将刷新', 'correct'), setTimeout(() => location.reload(), 1260));
          }));
        const m = document.createElement('button');
        ((m.textContent = 'Reset'),
          (m.className = 'ovnButtonBase ovnButtonAdapt ovnReset'),
          (m.onclick = () => {
            (a.reset(), i.clear(), u.OVN.top('已重置 即将刷新', 'correct'), setTimeout(() => location.reload(), 1260));
          }));
        const L = document.createElement('div');
    ...
    (function () {
      function n() {
        ...
        let d = 0,
          g = 0;
        for (const n of Object.values(c)) 'done' === n.state ? d++ : g++;
        const v = `[==👽OVN==][🛸] DONE - ${d}/${d + g} | FAIL - ${g}`,
          ...
          for (const { key: n, val: t } of r) {
            ...
            ((i.className = 'ovnDebugLine'),
              ['block', 'match', 'state', 'chain'].forEach((n) => {
                ...
                const e = t.steps[n];
                (!0 === e ? r.setAttribute('data-ovn-state', 'success') : !1 === e && r.setAttribute('data-ovn-state', 'error'), u.OVN.hover(r, n.toUpperCase(), void 0, void 0, 20), i.appendChild(r));
              }),
              n.append(r, o, i),
              e.appendChild(n));
          }
        ...
        a &&
          (a.startsWith('--') &&
            (a = getComputedStyle(document.documentElement)
              ...
              .replace(/^url\(["']?(.*?)["']?\)$/i, '$1')
              .replace(/["']/g, '')),
          a && (document.head ? i(a) : document.addEventListener('DOMContentLoaded', () => i(a)), 'loading' === document.readyState ? document.addEventListener('DOMContentLoaded', () => setTimeout(c, 126)) : setTimeout(c, 126)));
      })();
    }),
    I.run('Selection', () => {
  ...
  function b() {
    try {
      (T.SCHEDULER.run(), T.DEBUG.infoTotal());
    } catch (n) {
