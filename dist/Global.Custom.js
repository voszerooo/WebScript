...
(() => {
    ...
    M = (() => {
      ...
      function r(r) {
        ...
        function u() {
          ...
          if (o) return ((e = o), r === n && g(e), e);
          const a = document.createElement('div');
          return ((a.id = r), document.body.insertBefore(a, document.body.firstChild), (e = a), r === n && g(e), e);
        }
        function g(g) {
          (document.body.firstChild !== g && document.body.insertBefore(g, document.body.firstChild),
            (o = p(g, 'ovnStyle')),
            (a = p(g, 'ovnScript')),
            (i = p(g, 'ovnLog')),
            (function (n) {
            ...
            r === n &&
              (function () {
                ...
                ((v = new MutationObserver(() => {
                  N ||
                    (N = setTimeout(() => {
                      ((N = null), (e && document.contains(e)) || ((e = null), (t = null), s.disconnectKey(c), u()));
                    }, 126));
                })),
                  v.observe(document.body, { childList: !0 }));
              })());
        }
        let v = null,
          N = null;
        ...
        getSnapshot: function () {
          ...
          for (const n in a) {
            ...
            const N = m(n),
              p = M(`[${N}]`, s + 2),
              y = d(v),
              L = `${r}[${'fail' === g ? '👾' : '🚀'}][${y}ms]${p} | ${'fail' === g ? `FAIL - ${u}` : 'DONE'}`;
            i[n] = { group: c.group || n.split('_')[0] || 'Unknown', shortName: N, timeCost: v, steps: l, state: g, reason: u, logs: t[n] || [], consoleLine: L };
          }
          for (const n in o) {
            if (i[n]) continue;
            const e = o[n],
    ...
    m = (() => {
      ...
      function r(r, t) {
        return function (o = {}) {
          ...
          a.forEach((o) => {
            const { key: a, type: i = 'switch', name: s = ['ON', 'OFF'], color: M = ['var(--ovnAccentHEX)', 'var(--ovnBase04HEX)'], group: l = t, class: d = [], default: g = !0, order: v = 50, inform: N = !0, reload: p = !1, map: m, onClick: y, onMounted: L } = o;
            (a || 'jump' === i) &&
              r((r) => {
                ...
                if ('jump' === i && m)
                  return void Object.entries(m).forEach(([o, a]) => {
                    ...
                    ((i.className = [...n(d)].join(' ')),
                      ...
                      (i.dataset.order = v),
                      (i.onclick = () => {
                        (y?.({ phase: 'action', type: 'jump', label: o, url: a, button: i }), N && u.top(`Jump TO ${o}`, 'correct'), y || (location.href = a), p && location.reload());
                      }),
                      e(t, i, v),
                      L?.(i));
                  });
                ...
                ('switch' === i && (y?.({ phase: 'init', type: i, key: a, state: I, button: o }), (I = c.get(a, g))),
                  j(),
                  o.addEventListener('click', () => {
                    if ('switch' === i) {
                      if (((I = c.toggle(a)), j(), y?.({ phase: 'toggle', type: i, key: a, state: I, button: o }), N)) {
                        const r = I ? n(s)[0] || 'ON' : n(s)[1] || 'OFF';
                        u.top(`${a}: ${r}`, 'correct');
                      }
                    } else (y?.({ phase: 'action', type: i, key: a, button: o }), N && u.top(`${n(s)[0] || a} 已执行`, 'correct'));
                    p && location.reload();
                  }),
                  e(t, o, v),
                  L?.(o));
  ...
  const y = (() => {
              ...
              I &&
                ...
                N(v)
                  .then(() => {
                    ...
                    (n.searchParams.set('page', v), history.replaceState(null, '', n.toString()), (j = !1), (h = 0), b());
                  })
                  .finally(() => {
                    u = !1;
                  }));
    ...
    T = { PREFS: a, RUNTIME: c, REDIS: i, DOM: M, MATCH: l, SITE: d, OBSERVER: s, INFORM: u, RANDOM: g, DEBUG: p, BUTTON: m, CONFIG: v, RESOLVER: N, VERIFY: y, SCHEDULER: L, HOOK: n, ADD_CLASS: I, QUICK_READ: j, REMOVE_LIMITS: D, AUTO_LOAD: h, AUTO_EXECUTE: x };
  ((window.OVN = T),
    (function () {
    ...
    (function () {
      ...
      function s(i, M, l) {
        ...
        if (i.children && i.children.length > 0) {
          ...
          ((y.textContent = d.split('_').pop()), (y.style.marginRight = 'auto'));
          const L = document.createElement('input');
          ((L.type = 'checkbox'), (L.checked = g), (L.disabled = !l), L.classList.add('ovnStatusDot', 'ovnState', 'ovnBack'), r(L, i, g), e(m, l, g));
          const I = document.createElement('div');
          ((I.className = 'ovnGroupBody'),
            ...
            L.addEventListener('change', () => {
              const t = L.checked;
              (n.set(d, t), r(L, i, t), e(m, l, t), o(I, l && t));
            }),
            m.append(y, L),
            v.append(N, m),
            t(N, I, p, `fold_${d}`, i.fold ?? !1),
            i.children.forEach((n) => s(n, I, l && g)),
            c.append(v, I),
            M.appendChild(c));
        } else
          M.appendChild(
    ...
    (function () {
      function n() {
        ...
        const y = N.getTree(),
          L = Object.keys(y),
          I = [...L.filter((n) => l[n]), ...Object.keys(l).filter((n) => !L.includes(n))];
        for (const n of I) {
          const r = l[n];
          if (!r) continue;
          const e = document.createElement('div');
        ...
        for (const [n, r] of Object.entries(c))
          try {
            r && r.consoleLine && 'string' == typeof r.consoleLine && b.push(r.consoleLine);
          } catch (r) {
            b.push(`[==👽OVN==][👾][-.--ms][${n}] | ERROR - ${r?.message || 'Unknown'}`);
          }
        const S = document.getElementById('ovnLog');
        if (S) {
          const n = Array.from(S.querySelectorAll('pre')).map((n) => n.textContent);
          n.length > 0 && (b.push(' '), b.push('----------'), b.push(' '), b.push(...n), b.push(' '));
        }
        ((w.textContent = b.join('\n')),
          j.appendChild(D),
          j.appendChild(x),
          j.appendChild(w),
          t.appendChild(m),
      ...
      !(function () {
        ...
        function L(n, t = 0) {
          switch (n) {
            ...
            case 'down': {
              let o = e;
              t >= r && (o = t < 426 ? 1 : t <= 926 ? 4 : 12);
              !(function (n) {
                window.scrollBy({ top: n, behavior: 'smooth' });
              })(('up' === n ? -1 : 1) * window.innerHeight * o);
              break;
            }
          }
        }
        function I() {
          (function () {
            ...
            return !!n && ((o = document.createElement('div')), (o.id = 'ovnGallop'), (o.style.cssText = 'display:none;position:fixed;top:0;left:0;width:100%;height:100%;z-index: var(--ovnPriority09,92926192);pointer-events:none;'), (i = document.createElement('canvas')), (i.style.cssText = 'position:absolute;top:0;left:0;width:100%;height:100%;pointer-events:none;'), (c = i.getContext('2d')), o.appendChild(i), n.appendChild(o), !0);
          })() && ((i.width = window.innerWidth), (i.height = window.innerHeight), (o.style.display = 'block'));
        }
        function j() {
          c &&
            !p &&
            (v ||
              (v = requestAnimationFrame(() => {
                (!(function () {
                  if (!c || l.length < 2 || p) return;
                  if ((c.clearRect(0, 0, i.width, i.height), c.beginPath(), c.moveTo(l[0].x, l[0].y), 2 === l.length)) c.lineTo(l[1].x, l[1].y);
                  else {
                    for (let n = 1; n < l.length - 1; n++) {
                      const r = (l[n].x + l[n + 1].x) / 2,
                        e = (l[n].y + l[n + 1].y) / 2;
                      c.quadraticCurveTo(l[n].x, l[n].y, r, e);
                    }
                    c.lineTo(l[l.length - 1].x, l[l.length - 1].y);
                  }
        ...
        function D(n) {
          const r = () => {
            ((s = !1), (M = !1), (l = []), o && ((o.style.display = 'none'), v && (cancelAnimationFrame(v), (v = null)), (p = !1)), N && clearTimeout(N));
          };
          n ? r() : (N && clearTimeout(N), (N = setTimeout(r, 150)));
        }
        function h(n) {
          2 !== n.button || m || (N && (clearTimeout(N), (N = null)), D(!0), (s = !0), (M = !1), (p = !1), (d = n.clientX), (g = n.clientY), (l = [{ x: n.clientX, y: n.clientY }]));
        }
        function x(n) {
          s && M && (n.preventDefault(), n.stopPropagation());
        }
        function T(n) {
          if (!s) return;
          if (m) return void D(!0);
          ...
          y * y + L * L < 4 ||
            ...
            l.length >= t &&
              ...
              (function () {
                if (p) return;
                ((p = !0), c && c.clearRect(0, 0, i.width, i.height));
        ...
        (window.addEventListener('compositionstart', () => {
          ...
          setTimeout(function () {
            (document.addEventListener('mousedown', h, { capture: !0, passive: !1 }),
              document.addEventListener('mousemove', T, { capture: !0, passive: !1 }),
              document.addEventListener('mouseup', w, { capture: !0, passive: !1 }),
              document.addEventListener('contextmenu', x, { capture: !0, passive: !1 }),
    ...
    L.run('QuickRead', () => {
      !(function () {
        function n({ scroll: n = !0, smooth: r = !0, ratio: e = 0.8, letterKey: t = !0 } = {}) {
          const o = (n) => window.scrollBy({ top: n, left: 0, behavior: r ? 'smooth' : 'auto' }),
            a = { ArrowUp: () => n && o(-window.innerHeight * e), ArrowDown: () => n && o(window.innerHeight * e) };
  ...
  (L.run('YUQUE', () => {
    ...
    L.run('ovnGrid', () => {
      I.apply({ target: ['.ne-viewer .ne-viewer-body', '.ne-editor.layout-read-write .ne-editor-wrap-content'], subjoin: ['ovnGrid', 'ovnSolid'] });
    }));
  L.run('TickTick', () => {
