...
(() => {
          ...
          (document.body.firstChild !== g && document.body.insertBefore(g, document.body.firstChild),
            ...
            (function (n) {
              ...
              (Array.from(n.children).forEach((n) => {
                n !== o && n !== a && n !== i && (n.hasAttribute('data-ovn-frozen') || (l(n, 'style') ? M(n, o) : l(n, 'script') && M(n, a)));
              }),
                d(n));
            })(g),
            (function (n) {
                  ...
                  (r) => {
                    ...
                    (r.forEach((n) => {
                      n.addedNodes.forEach((n) => {
                        1 === n.nodeType && n !== o && n !== a && n !== i && (n.hasAttribute('data-ovn-frozen') || (l(n, 'style') ? M(n, o) && (e = !0) : l(n, 'script') ? M(n, a) && (e = !0) : (e = !0)));
                      });
                    }),
                      e && d(n));
                  },
  ...
  const M = (() => {
    ...
    u = (() => {
      function n(n, r = {}) {
        ...
        return {
          ...
          hover: function (n, r, e, o, i = 926) {
            ...
            const M = t.get(c);
            M && (c.removeEventListener('mouseenter', M.onEnter), c.removeEventListener('mouseleave', M.onLeave), M.timerId && clearTimeout(M.timerId), M.hoverElement && M.hoverElement.remove(), t.delete(c));
            let d = null,
              u = null;
            const g = (n) => {
                ((d = setTimeout(() => {
      ...
      return { create: n, OVN: n(l.bindOVN, { informTime: 3e3 }) };
    })();
  n.apply('inform', u);
  const g = (() => {
      function n(n = {}) {
      ...
      return {
        ...
        getSnapshot: function () {
          ...
          for (const n in a) {
            ...
            i[n] = { group: c.group || n.split('_')[0] || 'Unknown', shortName: N, timeCost: v, steps: M, state: g, reason: u, logs: t[n] || [], consoleLine: L };
          }
          for (const n in o) {
            if (i[n]) continue;
            const e = o[n],
              ...
              v = d(M),
              N = `${r}[${a}][${v}ms]${g} | ${c}`;
            i[n] = { group: n.split('_')[0] || 'Unknown', shortName: u, timeCost: M, steps: {}, state: e.error ? 'fail' : 'done', reason: e.errorMSG || '', logs: t[n] || [], consoleLine: N };
          }
          return i;
        },
    ...
    m = (() => {
      ...
      function r(r, t) {
        return function (o = {}) {
          ...
          a.forEach((o) => {
            const { key: a, type: i = 'switch', name: s = ['ON', 'OFF'], color: l = ['var(--ovnAccentHEX)', 'var(--ovnBase04HEX)'], group: M = t, class: d = [], default: g = !0, order: v = 50, inform: N = !0, reload: p = !1, map: m, onClick: y, onMounted: L } = o;
            (a || 'jump' === i) &&
              r((r) => {
      ...
      return { create: r, bindOVN: r(l.bindOVN, ['ovnButtonBase', 'ovnButtonUnder']) };
    })();
  n.apply('button', m);
  const y = (() => {
      function n(n) {
    ...
    I = (() => {
      const n = 'visited',
        r = 'data-ovn-trace';
      return {
        apply: function ({ delay: e = 260, target: t, subjoin: o, trace: i = !1, traceQuery: c = 'a[href]', traceJudge: l }) {
        ...
        apply: function ({ mode: r = 'smart', loadPage: e = 9, itemTarget: t = '#container .c-container', itemWrapper: o = '#container', buttonPrev: a = '.page-prev', buttonNext: i = '.page-next', fragment: c = !1, jitter: s } = {}) {
          ...
          function N(r) {
            return new Promise((e) => {
              const o = g.get({ jitter: l, order: r });
              setTimeout(() => {
                $.get(n(r), (n) => {
    ...
    T = { PREFS: a, RUNTIME: c, REDIS: i, DOM: l, MATCH: M, SITE: d, OBSERVER: s, INFORM: u, RANDOM: g, DEBUG: p, BUTTON: m, CONFIG: v, RESOLVER: N, VERIFY: y, SCHEDULER: L, HOOK: n, ADD_CLASS: I, QUICK_READ: j, REMOVE_LIMITS: h, AUTO_LOAD: D, AUTO_EXECUTE: x };
  ((window.OVN = T),
    (function () {
    ...
    (function () {
      ...
      function s(i, l, M) {
        ...
        if (i.children && i.children.length > 0) {
          ...
          ((L.type = 'checkbox'), (L.checked = g), (L.disabled = !M), L.classList.add('ovnStatusDot', 'ovnState', 'ovnBack'), r(L, i, g), e(m, M, g));
          const I = document.createElement('div');
          ((I.className = 'ovnGroupBody'),
            ...
            L.addEventListener('change', () => {
              const t = L.checked;
              (n.set(d, t), r(L, i, t), e(m, M, t), o(I, M && t));
            }),
            m.append(y, L),
            v.append(N, m),
            t(N, I, p, `fold_${d}`, i.fold ?? !1),
            i.children.forEach((n) => s(n, I, M && g)),
            c.append(v, I),
            l.appendChild(c));
        } else
          l.appendChild(
            (function (t, o) {
              ...
              ((d.type = 'checkbox'),
                ...
                d.addEventListener('change', () => {
                  (n.set(i, d.checked), r(d, t, d.checked), e(l, o, d.checked));
                }),
                l.append(M, d));
              const g = t.error ? t.errorMSG : t.feature;
              return (g && a.hover.get(i, !0) && u.OVN.hover(l, g), l);
            })(i, M),
          );
      }
      function M() {
        ...
        ((d.textContent = 'Options'), M.appendChild(d));
    ...
    (function () {
      function n() {
        ...
        const y = N.getTree(),
          L = Object.keys(y),
          I = [...L.filter((n) => M[n]), ...Object.keys(M).filter((n) => !L.includes(n))];
        for (const n of I) {
          const r = M[n];
          if (!r) continue;
          const e = document.createElement('div');
    ...
    L.run('Gallop', () => {
      !(function () {
        ...
        function h(n) {
          const r = () => {
            ((s = !1), (l = !1), (M = []), o && ((o.style.display = 'none'), v && (cancelAnimationFrame(v), (v = null)), (p = !1)), N && clearTimeout(N));
          };
          n ? r() : (N && clearTimeout(N), (N = setTimeout(r, 150)));
        }
        function D(n) {
          2 !== n.button || m || (N && (clearTimeout(N), (N = null)), h(!0), (s = !0), (l = !1), (p = !1), (d = n.clientX), (g = n.clientY), (M = [{ x: n.clientX, y: n.clientY }]));
        }
        function x(n) {
          s && l && (n.preventDefault(), n.stopPropagation());
        }
        function T(n) {
          if (!s) return;
        ...
        (window.addEventListener('compositionstart', () => {
          ...
          setTimeout(function () {
            (document.addEventListener('mousedown', D, { capture: !0, passive: !1 }),
              document.addEventListener('mousemove', T, { capture: !0, passive: !1 }),
              document.addEventListener('mouseup', b, { capture: !0, passive: !1 }),
