...
(() => {
          ...
          a.forEach((o) => {
            ...
            (a || 'jump' === c) &&
              r((r) => {
                ...
                ('switch' === c && (y?.({ phase: 'init', type: c, key: a, state: j, button: o }), (j = i.get(a, v))),
                  h(),
                  o.addEventListener('click', () => {
                    if ('switch' === c) {
                      if (((j = i.toggle(a)), h(), y?.({ phase: 'toggle', type: c, key: a, state: j, button: o }), p)) {
  ...
  const m = (() => {
              ...
              j &&
                ...
                p(g)
                  .then(() => {
                    ...
                    (n.searchParams.set('page', g), history.replaceState(null, '', n.toString()), (h = !1), (D = 0), w());
                  })
                  .finally(() => {
                    v = !1;
                  }));
    ...
    x = { PREFS: o, RUNTIME: i, REDIS: a, DOM: s, MATCH: l, SITE: d, OBSERVER: c, INFORM: M, RANDOM: u, DEBUG: p, BUTTON: N, CONFIG: v, RESOLVER: g, VERIFY: m, SCHEDULER: y, HOOK: n, ADD_CLASS: L, QUICK_READ: j, REMOVE_LIMITS: h, AUTO_LOAD: I, AUTO_EXECUTE: D };
  ((window.OVN = x),
    (function () {
        ...
        if (a.children && a.children.length > 0) {
          ...
          ((j.className = 'ovnGroupBody'),
            ...
            L.addEventListener('change', () => {
              const t = L.checked;
              (n.set(u, t), r(L, a, t), e(m, d, t), c(j, d && t));
            }),
            m.append(y, L),
            g.append(p, m),
            t(p, j, N, `fold_${u}`, a.fold ?? !1),
            a.children.forEach((n) => l(n, j, d && v)),
            i.append(g, j),
            s.appendChild(i));
        } else
          s.appendChild(
    ...
    (function () {
      function n() {
        ...
        const y = g.getTree(),
          L = Object.keys(y),
          j = [...L.filter((n) => d[n]), ...Object.keys(d).filter((n) => !L.includes(n))];
        for (const n of j) {
          const r = d[n];
          if (!r) continue;
          const e = document.createElement('div');
    ...
    y.run('Gallop', () => {
      !(function () {
        ...
        function j() {
          (function () {
            if (a && a.parentNode) return !0;
            a && ((a = null), (i = null), (c = null));
            const n = document.getElementById('ovnDOM') || document.body;
            return !!n && ((a = document.createElement('div')), (a.id = 'ovnGallop'), (a.style.cssText = 'display:none;position:fixed;top:0;left:0;width:100%;height:100%;z-index: var(--ovnPriority09,92926192);pointer-events:none;'), (i = document.createElement('canvas')), (i.style.cssText = 'position:absolute;top:0;left:0;width:100%;height:100%;pointer-events:none;'), (c = i.getContext('2d')), a.appendChild(i), n.appendChild(a), !0);
          })() && ((i.width = window.innerWidth), (i.height = window.innerHeight), (a.style.display = 'block'));
        }
        function h() {
          c &&
            !N &&
            (g ||
              (g = requestAnimationFrame(() => {
                (!(function () {
                  if (!c || d.length < 2 || N) return;
                  if ((c.clearRect(0, 0, i.width, i.height), c.beginPath(), c.moveTo(d[0].x, d[0].y), 2 === d.length)) c.lineTo(d[1].x, d[1].y);
                  else {
                    for (let n = 1; n < d.length - 1; n++) {
                      const r = (d[n].x + d[n + 1].x) / 2,
                        e = (d[n].y + d[n + 1].y) / 2;
                      c.quadraticCurveTo(d[n].x, d[n].y, r, e);
                    }
                    c.lineTo(d[d.length - 1].x, d[d.length - 1].y);
                  }
        ...
        function I(n) {
          const r = () => {
            ((s = !1), (l = !1), (d = []), a && ((a.style.display = 'none'), g && (cancelAnimationFrame(g), (g = null)), (N = !1)), p && clearTimeout(p));
          };
          n ? r() : (p && clearTimeout(p), (p = setTimeout(r, 150)));
        }
        function D(n) {
          2 !== n.button || m || (p && (clearTimeout(p), (p = null)), I(!0), (s = !0), (l = !1), (N = !1), (u = n.clientX), (v = n.clientY), (d = [{ x: n.clientX, y: n.clientY }]));
        }
        function x(n) {
        ...
        function T(n) {
          if (!s) return;
          if (m) return void I(!0);
          const e = { x: n.clientX, y: n.clientY },
            a = e.x - u,
            g = e.y - v;
          if (!l) {
            if (!(a * a + g * g > r * r)) return;
            ((l = !0), j());
          }
