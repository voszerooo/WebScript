...
// @contributionURL           https://buymeacoffee.com/voszerooo
...
(() => {
  ...
  (e.inject(), (window.OVN_CSS_INJECTOR = e));
  const t = (() => {
      function n(n) {
        const r = new Map();
        function e(r) {
      ...
      return {
        ...
        reset: function () {
          ...
          for (const r of n) (r.startsWith('prefs:') || r.startsWith('hover:') || r.startsWith('fold:') || r.startsWith('visited:')) && GM_deleteValue(r);
          (r.clear(), e.clear(), t.clear(), o.clear());
        },
      };
    })(),
    o = (() => {
    ...
    a = (() => {
      function n(n, r = !0) {
        const e = t.prefs.get(n, void 0);
        return void 0 === e ? r : !!e;
      }
      function r(r, e) {
        const o = !!e;
        return (n(r) === o || t.prefs.set(r, o), o);
      }
      return {
        get: n,
        set: r,
    ...
    M = (() => {
      ...
      function r(r) {
        ...
        function d(n) {
          (n.firstChild !== o && n.insertBefore(o, n.firstChild), c && n.lastChild !== c && n.appendChild(c), a && (c ? a.nextSibling !== c && n.insertBefore(a, c) : n.lastChild !== a && n.appendChild(a)));
        }
        function u(n) {
          (document.body.firstChild !== n && document.body.insertBefore(n, document.body.firstChild),
            (o = g(n, 'ovnStyle')),
            (a = g(n, 'ovnScript')),
            (c = g(n, 'ovnLog')),
            (function (n) {
              ...
              (Array.from(n.children).forEach((n) => {
                n !== o && n !== a && n !== c && (n.hasAttribute('data-ovn-frozen') || (s(n, 'style') ? l(n, o) : s(n, 'script') && l(n, a)));
              }),
                d(n));
            })(n),
            (function (n) {
                  ...
                  (r) => {
                    ...
                    (r.forEach((n) => {
                      n.addedNodes.forEach((n) => {
                        1 === n.nodeType && n !== o && n !== a && n !== c && (n.hasAttribute('data-ovn-frozen') || (s(n, 'style') ? l(n, o) && (e = !0) : s(n, 'script') ? l(n, a) && (e = !0) : (e = !0)));
                      });
                    }),
                      e && d(n));
                  },
        ...
        function v() {
          return (
            ...
            ((t = new Promise((o) => {
              function a() {
                const a = (function () {
                  if ((e && !document.contains(e) && ((e = null), (t = null), i.disconnectKey(M)), e)) return e;
                  const o = document.querySelector(`#${r}`);
                  if (o) return ((e = o), r === n && u(e), e);
                  const a = document.createElement('div');
                  return ((a.id = r), document.body.insertBefore(a, document.body.firstChild), (e = a), r === n && u(e), e);
                })();
                o(a);
              }
              'loading' === document.readyState ? document.addEventListener('DOMContentLoaded', a, { once: !0 }) : a();
            })),
            t)
          );
        }
  ...
  const s = (() => {
      ...
      function r(r = {}) {
        const e = r.include || [],
          t = r.exclude || [],
          a = e.join('|') + '::' + t.join('|');
        return o.compute('compiledMatch', a, () => {
          const r = e.map(n),
            o = t.map(n),
      ...
      function n(n, r = {}) {
        ...
        return {
          ...
          hover: function (n, r, e, a, i = 926) {
            ...
            const M = 'hover::' + r,
              s = t.hover.get(M) || 0;
            if ('number' == typeof e && s >= e) return;
            const l = o.get(c);
            l && (c.removeEventListener('mouseenter', l.onEnter), c.removeEventListener('mouseleave', l.onLeave), l.timerId && clearTimeout(l.timerId), l.hoverElement && l.hoverElement.remove(), o.delete(c));
            let d = null,
              u = null;
            const g = (n) => {
                ((d = setTimeout(() => {
                  ((u = document.createElement('div')), (u.className = 'ovnTips hover'), (u.textContent = r), document.body.appendChild(u));
                  const { clientX: i, clientY: l } = n,
                    { offsetWidth: d, offsetHeight: N } = u,
                    p = l - 40,
                    m = Math.max(10, Math.min(i - d / 2, window.innerWidth - d - 10));
                  if (
                    ((u.style.left = `${m}px`),
                    (u.style.top = `${Math.max(10, p)}px`),
                    requestAnimationFrame(() => {
                  ...
                  ('function' == typeof a && a(), 1 === e && (c.removeEventListener('mouseenter', g), c.removeEventListener('mouseleave', v), o.delete(c)));
                }, i)),
                  o.set(c, { timerId: d, hoverElement: u, onEnter: g, onLeave: v }));
              },
              v = () => {
            ...
            (c.addEventListener('mouseenter', g), c.addEventListener('mouseleave', v), o.set(c, { timerId: d, hoverElement: u, onEnter: g, onLeave: v }));
          },
        };
      }
      return { create: n, OVN: n(M.bindOVN, { informTime: 3e3 }) };
    })();
  c.apply('inform', d);
  const u = (() => {
      function n(n = {}) {
    ...
    g = { debug: !1, Global: { fold: !1, block: [], ScrollBar: { name: '客制化滚动条', feature: '滚动条样式 个性化', match: { include: ['*'], exclude: [] } }, LoaderBar: { name: '顶部加载条', feature: '全局顶部植入 加载进度条 => 进度条', match: { include: ['*'], exclude: [] } }, Gallop: { feature: '浮光掠影‌  走马观花', match: { include: ['*'], exclude: [] } }, Preview: { match: { include: ['*'], exclude: [] } }, CustomICON: { feature: '站点 ICO 替换 | 书签栏 > DeepSeek > HUA! 黑鲸', match: { include: ['*'], exclude: [] }, phase: 'end' }, Selection: { feature: '原生鼠标选取样式 个性化', match: { include: ['*'], exclude: ['*yuque.com/*'] } }, FontStyle: { feature: '字体样式 | 可去 FontStyle 重定义所需站点/变更应用已安装的某款字体', match: { include: ['file:///*', '*iconfont.cn/*', '*emojiall.com/*', '*greasyfork.org/*', '*juejin.cn/*', '*wikipedia.org/*', '*prompts.chat/*', ...l.Chat, ...l.ProgDev, ...l.Manage, ...l.Search, ...l.Media], exclude: ['*youtube.com/*', ...l.Font] } } }, Matrix: { fold: !1, block: [], Search: { fold: !0, Baidu: { match: { include: ['*baidu.com/*'], exclude: [] } }, Google: { match: { include: ['*Google.com/*', '*Google.com.*/*'], exclude: [] } }, Bing: { match: { include: ['*bing.com/*'], exclude: [] } } }, Chat: { fold: !0, DeepSeek: { match: { include: ['*deepseek.com/*'], exclude: [] } }, ChatGPT: { match: { include: ['*chatgpt.com/*'], exclude: [] } }, DOUBAO: { match: { include: ['*doubao.com/*'], exclude: [] } } }, ComfyUI: { fold: !0, feature: 'YOYOYO', match: { include: [...l.AIGC], exclude: [] }, manager: {}, crystools: {}, rgthree: {} }, YUQUE: { fold: !0, name: ' ', feature: ' ', state: !0, default: !0, match: { include: ['*yuque.com/*'], exclude: [] }, ovnGrid: { feature: '背景网格' }, ovnTable: { feature: '表格样式' } }, TickTick: { match: { include: ['*dida365.com/*', '*ticktick.com/*'], exclude: [] } }, Youtube: { match: { include: ['*youtube.com/*'], exclude: [] } }, Bilibili: { match: { include: ['*Bilibili.com/*'], exclude: [] } } }, Micro: { fold: !1, block: [], Eagle: { match: { include: ['*'], exclude: [] } }, NetDisk_Check: { match: { include: ['*'], exclude: [] } }, Other: { feature: '炸七炸八', match: { include: ['*'], exclude: [] } } } };
  c.apply('config', g);
  const v = (() => {
      const n = {},
        r = {};
      function e(r, t, o) {
        ...
        return (
          ...
          a.match && (a.compiledMatch = s.compile(a.match)),
          a
        );
      }
      for (const n in g) 'debug' !== n && (r[n] = e(g[n], [n], null));
      return {
        get: (r) => n[r],
        getFlat: () => n,
        getTree: () => r,
    ...
    N = (() => {
      ...
      function p(n, { level: r, msg: e, time: t }) {
        o[n] || (o[n] = {});
        const a = o[n];
        (null != t && t >= 0 ? (a.timeCost = t) : a.timeCost || (a.timeCost = 0), (a.debugLevel = r), 'error' === r && ((a.error = !0), (a.errorMSG = e)), l(a.timeCost));
      }
      function m(n) {
        const r = n.split('_');
      ...
      return {
        log: function (r, t = 'DONE', o = 0, a) {
          const i = u({ icon: '🚀', key: r, time: o, msg: t }),
            c = a ? `${i} | ${a}` : i;
          return (e.push(c), n && console.log(c), N(r, c), p(r, { level: 'log', msg: t, time: o }), c);
        },
        warn: function (r, t = 'DEBUG', o = 0, a) {
          const i = u({ icon: '🛠️', key: r, time: o, msg: t }),
            c = a ? `${i} | ${a}` : i;
          return (e.push(c), n && console.warn(c), N(r, c), p(r, { level: 'warn', msg: t, time: o }), c);
        },
        error: function (r, t = 'ERROR', o = 0, a) {
          const i = u({ icon: '👾', key: r, time: o, msg: t }),
            c = a ? `${i} | ${a}` : i;
          return (e.push(c), n && console.error(c), N(r, c), p(r, { level: 'error', msg: t, time: o }), c);
        },
        getLogs: function (n) {
          return t[n] || [];
        },
        ...
        getSnapshot: function () {
          ...
          for (const n in a) {
            const o = a[n],
              c = e[n] || {},
              l = { block: null, match: null, state: null, chain: null, exec: null };
            let u = '',
              g = 'idle',
              v = 0;
            for (const n of o) {
              const r = (n) => 'done' === n || ('fail' !== n && null);
              ('block' === n.step && (l.block = r(n.state)), 'match' === n.step && (l.match = r(n.state)), 'state' === n.step && (l.state = r(n.state)), 'chain' === n.step && (l.chain = r(n.state)), 'run.exec' === n.step && ((l.exec = r(n.state)), (v = n.timeCost || 0)), 'fail' === n.state && ((g = 'fail'), (u = n.step)));
            }
            'fail' !== g && (g = 'done');
            const N = m(n),
              p = s(`[${N}]`, M + 2),
              y = d(v),
              I = `${r}[${'fail' === g ? '👾' : '🚀'}][${y}ms]${p} | ${'fail' === g ? `FAIL - ${u}` : 'DONE'}`;
            i[n] = { group: c.group || n.split('_')[0] || 'Unknown', shortName: N, timeCost: v, steps: l, state: g, reason: u, logs: t[n] || [], consoleLine: I };
          }
          for (const n in o) {
            if (i[n]) continue;
            const e = o[n],
              ...
              v = d(l),
              N = `${r}[${a}][${v}ms]${g} | ${c}`;
            i[n] = { group: n.split('_')[0] || 'Unknown', shortName: u, timeCost: l, steps: {}, state: e.error ? 'fail' : 'done', reason: e.errorMSG || '', logs: t[n] || [], consoleLine: N };
          }
          return i;
        },
        ...
        okTrace: function (n, r, e) {
          ...
          t && ((t.state = 'done'), (t.timeCost = performance.now() - t.time), (t.detail = e), l(t.timeCost));
        },
        failTrace: function (n, r, e) {
          const t = y(n).find((n) => n.step === r && 'pending' === n.state);
          t && ((t.state = 'fail'), (t.reason = e), (t.timeCost = performance.now() - t.time), l(t.timeCost));
        },
    ...
    p = (() => {
      ...
      function r(r, t) {
        return function (o = {}) {
          ...
          i.forEach((o) => {
            const { key: i, type: c = 'switch', name: M = ['ON', 'OFF'], color: s = ['var(--ovnAccentHEX)', 'var(--ovnBase04HEX)'], group: l = t, class: u = [], default: g = !0, order: v = 50, inform: N = !0, reload: p = !1, map: m, onClick: y, onMounted: I } = o;
            (i || 'jump' === c) &&
              r((r) => {
                ...
                if ('jump' === c && m)
                  return void Object.entries(m).forEach(([o, a]) => {
                    ...
                    ((i.className = [...n(u)].join(' ')),
                      ...
                      (i.dataset.order = v),
                      (i.onclick = () => {
                        (y?.({ phase: 'action', type: 'jump', label: o, url: a, button: i }), N && d.top(`Jump TO ${o}`, 'correct'), y || (location.href = a), p && location.reload());
                      }),
                      e(t, i, v),
                      I?.(i));
                  });
                ...
                ((o.className = [...n(u), i].join(' ')), (o.dataset.order = v));
                let j = 'switch' === c ? a.get(i, g) : null;
                function h() {
                  if ('switch' !== c) return void (o.textContent = n(M)[0] || 'RUN');
                  const r = n(M),
                    e = n(s);
                  ((o.textContent = j ? r[0] : r[1]), (o.style.background = j ? e[0] : e[1]));
                }
                (h(),
                  'switch' === c && y?.({ phase: 'init', type: c, key: i, state: j, button: o }),
                  o.addEventListener('click', () => {
                    if ('switch' === c) {
                      if (((j = a.toggle(i)), h(), y?.({ phase: 'toggle', type: c, key: i, state: j, button: o }), N)) {
                        const r = j ? n(M)[0] || 'ON' : n(M)[1] || 'OFF';
                        d.top(`${i}: ${r}`, 'correct');
                      }
                    } else (y?.({ phase: 'action', type: c, key: i, button: o }), N && d.top(`${n(M)[0] || i} 已执行`, 'correct'));
                    p && location.reload();
                  }),
                  e(t, o, v),
                  I?.(o));
      ...
      return { create: r, bindOVN: r(M.bindOVN, ['ovnButtonBase', 'ovnButtonUnder']) };
    })();
  c.apply('button', p);
  const m = (() => {
      function n(n) {
      ...
      function r(r, e) {
        ...
        return t.some((n) => s.check(n, e.url)) ? n('BLOCK') : { ready: !0 };
      }
      function e(r, e) {
      ...
      return {
        check: function (n, a) {
          ...
          for (const [r, e] of i) {
            N?.startTrace?.(n.key, r);
            const t = e(n, a);
            if (!t.ready) return (N?.failTrace?.(n.key, r, t.reason), t);
            N?.okTrace?.(n.key, r);
          }
          return { ready: !0 };
        },
    ...
    y = (() => {
      ...
      function o() {
        ...
        n.length = 0;
        const a = (n, r) => {
          for (const e of n) (N?.startTrace?.(e.mod.key, `phase.${r}`), N?.startTrace?.(e.mod.key, 'run.exec'), t(e.mod, e.callback), N?.okTrace?.(e.mod.key, 'run.exec'), N?.okTrace?.(e.mod.key, `phase.${r}`));
        };
      ...
      return {
        run: function (e, i, c = {}) {
          ...
          const M = v.resolve(e);
          if (!M) return (N?.failTrace?.(e, 'resolve', 'NOT_FOUND'), !1);
          const s = v.get(M);
          if (!s) return (N?.skipTrace?.(M, 'run', 'NO_MODULE'), !1);
          N?.startTrace?.(M, 'run');
          const l = (function (n, r = {}) {
              return { url: r.url || location.href, runtime: a, group: v.get(n.group), chain: v.getChain(n.key) };
            })(s, c),
            d = m.check(s, l);
          if (!d.ready) return (N?.failTrace?.(M, 'final', d.reason), !1);
          if ('function' != typeof i) return (N?.failTrace?.(M, 'run', 'NO_FUNC'), !1);
          if (
            !(function (n) {
              return (n.depend && n.depend.length > 0) || (n.phase && 'none' !== n.phase) || n.priority > 0;
            })(s)
          ) {
            N?.startTrace?.(M, 'run.exec');
            performance.now();
            return (t(s, i), N?.okTrace?.(M, 'run.exec'), !0);
          }
          return (n.push({ mod: s, callback: i }), r || ((r = !0), Promise.resolve().then(o)), !0);
        },
      };
    })(),
    I = (() => {
      const n = 'visited',
        r = 'data-ovn-trace';
      return {
        apply: function ({ delay: e = 260, target: o, subjoin: a, trace: c = !1, traceQuery: M = 'a[href]', traceJudge: s }) {
          const l = Array.isArray(o) ? o : [o],
            d = Array.isArray(a) ? a : [a],
            u = new Set(JSON.parse(t.visited.get(n, '[]'))),
            g = `subjoin_${l.join('_')}_${d.join('_')}`;
          function v(n) {
            (d.forEach((r) => {
            ...
            l.forEach((n) => {
              document.querySelectorAll(n).forEach((n) => {
                n.hasAttribute(r) ||
                  (c
                    ? (function (n) {
                        return [...n.querySelectorAll(M)].some((n) => {
                          const r = n.getAttribute('href');
                          return !!r && ('function' == typeof s ? s(r) : !Array.isArray(s) || s.every((n) => r.includes(n))) && u.has(r);
                        });
                      })(n) && v(n)
                    : v(n));
              });
          ...
          function p() {
            (N(),
              document.body.addEventListener('click', (r) => {
                const e = r.target.closest(M);
                if (!e) return;
                const o = e.getAttribute('href');
                o &&
                  ('function' == typeof s ? s(o) : !Array.isArray(s) || s.every((n) => o.includes(n))) &&
                  (u.add(o),
                  t.visited.set(n, JSON.stringify([...u])),
                  l.forEach((n) => {
                    const r = e.closest(n);
                    r && v(r);
                  }));
              }),
              i.observeWithKey(g, document.body, { childList: !0, subtree: !0 }, N, { preventDuplicate: !0, autoDisconnect: !1 }));
          }
    ...
    L = (() => {
      ...
      return {
        apply: function ({ mode: r = 'smart', loadPage: e = 9, itemTarget: t = '#container .c-container', itemWrapper: o = '#container', buttonPrev: a = '.page-prev', buttonNext: i = '.page-next', fragment: c = !1, jitter: M } = {}) {
          const s = M || { delay: 30, interval: 30, random: 70 },
            l = (function () {
              const n = location.href.match(/page=(\d+)/);
              return n ? parseInt(n[1]) : 1;
            })(),
            d = 'string' == typeof o ? document.querySelector(o) : o;
          if (!d) return;
          let g = !1,
            v = l;
          function N(r) {
            return new Promise((e) => {
              const o = u.get({ jitter: s, order: r });
              setTimeout(() => {
                $.get(n(r), (n) => {
                  const r = document.createElement('div');
                  r.innerHTML = n;
                  const o = r.querySelectorAll(t),
                    a = c ? document.createDocumentFragment() : d;
                  (o.forEach((n) => {
                    (n.classList.add('ovnFadeInLoad'), a.appendChild(n));
                  }),
                    c && d.appendChild(a),
                    requestAnimationFrame(() => {
                      d.querySelectorAll('.ovnFadeInLoad:not(.ovnLoaded)').forEach((n) => {
          ...
          if ('multipage' === r) {
            ...
            p && ((p.href = n(l + e + 1)), (p.textContent = `Next ${e + 1}`));
            const m = [];
            for (let y = 1; y <= e; y++) {
              const I = l + y;
              m.push(N(I));
              ...
              j &&
                ...
                N(v)
                  .then(() => {
                    ...
                    (n.searchParams.set('page', v), history.replaceState(null, '', n.toString()), (h = !1), (D = 0), w());
                  })
                  .finally(() => {
                    g = !1;
                  }));
            ...
            const A = new IntersectionObserver(
              (n) => {
                ...
                r.isIntersecting &&
                  ...
                  ((g = !0),
                  (v += 1),
                  A.unobserve(r.target),
                  N(v)
                    .then(() => {
                      const n = new URL(location.href);
                      (n.searchParams.set('page', v), history.replaceState(null, '', n.toString()), z());
                    })
                    .finally(() => {
                      g = !1;
                    }));
    ...
    D = (() => {
      ...
      return {
        apply: function (e = {}) {
          const { jitter: t, delay: o, interval: a, random: i, backstage: c = !1, strict: M = !1, debug: s = !1 } = e,
            l = t || { delay: o || 200, interval: a || 20, random: i || 0 },
            d = [];
          for (let n = 1; n <= 10; n++) {
            const r = `step${n}`;
            e[r] && d.push(e[r]);
                      ...
                      u.run(
                        () => {
                          ...
                          try {
                            ...
                            t ? (r(t, i), N.log(n, `Step${e + 1} ✅ ${i} - ${a}`)) : (N.warn(n, `Step${e + 1} ❓ None - ${a}`), M && ((v = !0), N.error(n, `Step${e + 1} ❌ Break`)));
                          } catch (r) {
                            (N.error(n, `Step${e + 1} ❌ Error - ${r.message}`, 0, r.stack), M && (v = !0));
                          }
                          o();
                        },
                        { jitter: l, order: e },
          ...
          ('loading' === document.readyState ? document.addEventListener('DOMContentLoaded', p) : p(), document.addEventListener('visibilitychange', p));
        },
      };
    })(),
    x = { PREFS: t, RUNTIME: a, REDIS: o, DOM: M, MATCH: s, SITE: l, OBSERVER: i, INFORM: d, RANDOM: u, DEBUG: N, BUTTON: p, CONFIG: g, RESOLVER: v, VERIFY: m, SCHEDULER: y, HOOK: c, ADD_CLASS: I, QUICK_READ: j, REMOVE_LIMITS: h, AUTO_LOAD: L, AUTO_EXECUTE: D };
  ((window.OVN = x),
    (function () {
        ...
        c = () => {
          const o = document.documentElement,
            i =
              ...
              'light';
          i !== e && (o.classList.remove('ovnThemeLight', 'ovnThemeDark'), o.classList.add('light' === i ? 'ovnThemeLight' : 'ovnThemeDark'), (e = i));
        },
        M = () => {
          ...
          n.forEach((n, e) => {
            i.observeWithKey(`ovnTheme_${e}`, n, { attributes: !0 }, r, { preventDuplicate: !0, autoDisconnect: !1 });
          });
        };
      (() => {
        const n = () => {
          (c(), M(), window.matchMedia('(prefers-color-scheme: dark)').addEventListener('change', c), window.matchMedia('(prefers-color-scheme: light)').addEventListener('change', c));
        };
    ...
    (function () {
      ...
      function i(n, r, e, o, a) {
        let i = t.fold.get(o, a);
        (i ? (r.classList.add('ovnClose'), (r.style.height = '0px'), e.classList.remove('ovnRotated')) : ((r.style.height = 'auto'), e.classList.add('ovnRotated')),
          n.addEventListener('click', (n) => {
            if ((n.stopPropagation(), (i = !i), t.fold.set(o, i), r.classList.add('ovnOpen'), i)) {
      ...
      function c(n, t) {
        n.querySelectorAll('input[type=checkbox]').forEach((n) => {
          ...
          if (!c) return;
          n.disabled = !t;
          const M = a.get(o, i?.default ?? !0);
          ((n.checked = !!t && M), r(n, i || {}, n.checked), e(c, t, n.checked));
        });
      }
      function s(o, M, l) {
        const u = o.key,
          g = a.get(u, o.default ?? !0);
        if (o.children && o.children.length > 0) {
          const a = document.createElement('div');
          a.className = 'ovnGroupBase Sub';
          const v = document.createElement('div');
          v.className = 'ovnGroupHead';
          const N = document.createElement('div');
          ((N.className = 'ovnFoldBox'), (N.style.cursor = 'pointer'), t.hover.get(u, !0) && d.OVN.hover(N, 'HEIHEI 彩蛋 | ClickClick', 2));
          const p = document.createElement('div');
          ((p.className = 'ovnArrow'), (p.textContent = '›'), N.appendChild(p));
          const m = document.createElement('label');
          m.className = 'ovnHeaderRow';
          const y = document.createElement('span');
          ((y.textContent = u.split('_').pop()), (y.style.marginRight = 'auto'));
          const I = document.createElement('input');
          ((I.type = 'checkbox'), (I.checked = g), (I.disabled = !l), I.classList.add('ovnStatusDot', 'ovnState', 'ovnBack'), r(I, o, g), e(m, l, g));
          const j = document.createElement('div');
          ((j.className = 'ovnGroupBody'),
            requestAnimationFrame(() => {
              c(j, l && I.checked);
            }),
            I.addEventListener('change', () => {
              const t = I.checked;
              (n.set(u, t), r(I, o, t), e(m, l, t), c(j, l && t));
            }),
            m.append(y, I),
            v.append(N, m),
            i(N, j, p, `fold_${u}`, o.fold ?? !1),
            o.children.forEach((n) => s(n, j, l && g)),
            a.append(v, j),
            M.appendChild(a));
        } else
          M.appendChild(
            (function (o, i) {
              const c = o.key,
                M = a.get(c, o.default ?? !0),
                s = document.createElement('label');
              s.className = 'ovnBodyRow';
              const l = document.createElement('span');
              l.textContent = c.split('_').pop();
              ...
              ((u.type = 'checkbox'),
                ...
                u.addEventListener('change', () => {
                  (n.set(c, u.checked), r(u, o, u.checked), e(s, i, u.checked));
                }),
                s.append(l, u));
              const g = o.error ? o.errorMSG : o.feature;
              return (g && t.hover.get(c, !0) && d.OVN.hover(s, g), s);
            })(o, l),
          );
      }
      function l() {
        ...
        ((l.id = 'ovnOptionsPanel'), (l.className = 'ovnPanelBase ovnOptionBase ovnFixed'));
        const u = document.createElement('h2');
        ((u.textContent = 'Options'), l.appendChild(u));
        const g = document.createElement('div');
        g.className = 'ovnPanelBody';
        const N = v.getTree();
        Object.values(N).forEach((e) => {
          const t = a.get(e.key, !0),
            o = document.createElement('div');
          o.className = 'ovnGroupBase';
          const M = document.createElement('div');
          M.className = 'ovnGroupHead';
          const l = document.createElement('div');
          l.className = 'ovnFoldBox';
          const d = document.createElement('div');
          ((d.className = 'ovnArrow'), (d.textContent = '›'), l.appendChild(d));
          const u = document.createElement('label');
          u.className = 'ovnHeaderRow';
          const v = document.createElement('span');
          ((v.textContent = e.key), (v.style.marginRight = 'auto'));
          const N = document.createElement('input');
          ((N.type = 'checkbox'), (N.checked = t), N.classList.add('ovnStatusDot', 'ovnState', 'ovnBack'), r(N, e, t));
          const p = document.createElement('div');
          ((p.className = 'ovnGroupBody'),
            N.addEventListener('change', () => {
              const t = N.checked;
              (n.set(e.key, t), r(N, e, t), c(p, t));
            }),
            u.append(v, N),
            M.append(l, u),
            i(l, p, d, `fold_${e.key}`, e.fold ?? !1),
            e.children.forEach((n) => s(n, p, t)),
            o.append(M, p),
            g.appendChild(o));
        });
        const p = document.createElement('button');
        ((p.textContent = 'Apply'),
          (p.className = 'ovnButtonBase ovnButtonAdapt ovnApply'),
          (p.onclick = () => {
            (n.forEach((n, r) => a.set(r, n)), d.OVN.top('已应用 即将刷新', 'correct'), setTimeout(() => location.reload(), 1260));
          }));
        const m = document.createElement('button');
        ((m.textContent = 'Reset'),
          (m.className = 'ovnButtonBase ovnButtonAdapt ovnReset'),
          (m.onclick = () => {
            (t.reset(), o.clear(), d.OVN.top('已重置 即将刷新', 'correct'), setTimeout(() => location.reload(), 1260));
          }));
        const y = document.createElement('div');
        ((y.className = 'ovnButton'),
          y.append(p, m),
          l.append(g, y),
          M.bindOVN((n) => n.appendChild(l)),
          setTimeout(() => l.classList.add('ovnShow'), 20),
          setTimeout(() => {
            const n = (r) => {
              l.contains(r.target) ||
                (l.classList.add('ovnHide'),
                setTimeout(() => {
                  (l.remove(), document.removeEventListener('click', n));
                }, 526));
            };
            document.addEventListener('click', n);
          }, 100));
      }
      (GM_registerMenuCommand('👽 Options Panel', l),
        document.addEventListener('keydown', (n) => {
          n.ctrlKey && n.altKey && 'x' === n.key.toLowerCase() && (n.preventDefault(), l());
        }));
    })(),
    (function () {
      function n() {
        ...
        const o = n.getSnapshot(),
          ...
          c = Object.keys(a),
          s = {};
        for (const n of c) o[n] && (s[n] = o[n]);
        const l = Object.create(null);
        for (const [n, r] of Object.entries(s)) {
          const e = n.split('_')[0];
          (l[e] || (l[e] = []), l[e].push({ key: n, val: r }));
        }
        let u = 0,
          g = 0;
        for (const n of Object.values(s)) 'done' === n.state ? u++ : g++;
        const p = `[==👽OVN==][🛸] DONE - ${u}/${u + g} | FAIL - ${g}`,
          m = document.createElement('div');
        m.className = 'ovnDebugGrid';
        const y = v.getTree(),
          I = Object.keys(y),
          j = [...I.filter((n) => l[n]), ...Object.keys(l).filter((n) => !I.includes(n))];
        for (const n of j) {
          const r = l[n];
          if (!r) continue;
          const e = document.createElement('div');
          ...
          for (const { key: n, val: t } of r) {
            ...
            ((i.className = 'ovnDebugLine'),
              ['block', 'match', 'state', 'chain'].forEach((n) => {
                ...
                const e = t.steps[n];
                (!0 === e ? r.setAttribute('data-ovn-state', 'success') : !1 === e && r.setAttribute('data-ovn-state', 'error'), d.OVN.hover(r, n.toUpperCase(), void 0, void 0, 20), i.appendChild(r));
              }),
              n.append(r, o, i),
              e.appendChild(n));
          }
        ...
        h.className = 'ovnDebugBottom';
        const L = document.createElement('pre');
        L.className = 'ovnObserver';
        ...
        const T = document.documentElement.getAttribute('data-ovn-mode') || 'Unknown';
        ((x.textContent = `DevMode | ${T}`), 'SSE' === T ? x.setAttribute('data-ovn-type', 'imp') : 'ETag' === T && x.setAttribute('data-ovn-type', 'sec'));
        const b = document.createElement('pre');
        b.className = 'ovnDebugConsole';
        const w = [];
        w.push(p);
        for (const [n, r] of Object.entries(s))
          try {
        ...
        const A = document.getElementById('ovnLog');
        if (A) {
          const n = Array.from(A.querySelectorAll('pre')).map((n) => n.textContent);
          n.length > 0 && (w.push(' '), w.push('----------'), w.push(' '), w.push(...n), w.push(' '));
        }
        ((b.textContent = w.join('\n')),
          h.appendChild(L),
          h.appendChild(x),
          h.appendChild(b),
          t.appendChild(m),
      ...
      (N || void 0 !== N || console.warn('[==👽OVN==] OVN_Debug | OVN_GLOBAL_DEBUG not available yet, will retry on demand'),
    ...
    y.run('Gallop', () => {
      !(function () {
        const n = !0,
          ...
          u = 300,
          g = [
            { condition: (n) => n < 400, ratio: 1 },
            { condition: (n) => n > 400 && n <= 999, ratio: 4 },
            { condition: (n) => n > 999, ratio: 14 },
          ];
        let v = !1,
          N = !1,
          p = !1,
        ...
        function S(r, t = 0) {
          switch (r) {
            ...
            case 'right':
              ...
              break;
            case 'up-down':
              window.scrollTo({ top: document.documentElement.scrollHeight, behavior: e ? 'smooth' : 'auto' });
              break;
            case 'down-up':
            ...
            case 'down': {
              ...
              n &&
                t >= i &&
                (o = (function (n) {
                  for (const r of g) if (r.condition(n)) return r.ratio;
                  return l;
                })(t));
              !(function (n) {
                window.scrollBy({ top: n, behavior: e ? 'smooth' : 'auto' });
              })(('up' === r ? -1 : 1) * window.innerHeight * o);
              break;
            }
          }
        }
        function f() {
          T = !1;
          const n = (D || (D = A()), h || ((h = document.createElement('canvas')), (h.style.cssText = '\n                    position: fixed;\n                    top: 0;\n                    left: 0;\n                    width: 100%;\n                    height: 100%;\n                    pointer-events: none;\n                    z-index: 999999999;\n                    opacity: 0;\n                    transition: opacity .2s ease;\n                '), D.appendChild(h), (L = h.getContext('2d'))), (h.width = window.innerWidth), (h.height = window.innerHeight), h);
          ((n.style.transition = 'none'), (n.style.opacity = '1'), n.offsetHeight, (n.style.transition = 'opacity .2s ease'), C());
        }
        function C() {
          L && L.clearRect(0, 0, h.width, h.height);
        }
        function O() {
          T ||
            x ||
            (x = requestAnimationFrame(() => {
              (!(function () {
                if (!L || y.length < 2 || T) return;
                (C(), L.beginPath(), L.moveTo(y[0].x, y[0].y));
                for (let n = 1; n < y.length; n++) L.lineTo(y[n].x, y[n].y);
                ((L.strokeStyle = r), (L.lineWidth = 2), (L.lineCap = 'round'), (L.lineJoin = 'round'), L.stroke());
              })(),
                (x = null));
            }));
        }
        function E(n = !1) {
          const r = () => {
            ((v = !1), (N = !1), (p = !1), (y = []), h && (h.style.opacity = '0'), document.documentElement.classList.remove('gesture-active'), window.removeEventListener('mousemove', _, !0), window.removeEventListener('mouseup', Y, !0), m && clearTimeout(m), x && (cancelAnimationFrame(x), (x = null)));
          };
          n ? r() : (m && clearTimeout(m), (m = setTimeout(r, 150)));
        }
        let k = !1;
        function U(n) {
          2 !== n.button ||
            ...
            (function (n) {
              if (!n) return !1;
              const r = n.tagName;
              if ('INPUT' === r || 'TEXTAREA' === r || 'SELECT' === r || 'BUTTON' === r || 'A' === r) return !0;
              if (n.isContentEditable) return !0;
              const e = n.getAttribute('role');
              return 'textbox' === e || 'searchbox' === e || 'combobox' === e || 'button' === e || 'link' === e || null !== n.closest?.('[contenteditable="true"], [contenteditable=""]');
            })(n.target) ||
            (m && (clearTimeout(m), (m = null)), E(!0), (v = !0), (N = !1), (p = !1), (I = n.clientX), (j = n.clientY), (y = [{ x: n.clientX, y: n.clientY }]), document.documentElement.classList.add('gesture-active'), window.addEventListener('mousemove', _, !0), window.addEventListener('mouseup', Y, !0));
        }
        function _(n) {
          if (!v) return;
          if (k) return void E(!0);
          ((N = !0), n.preventDefault(), n.stopPropagation());
          const r = { x: n.clientX, y: n.clientY },
            e = r.x - I,
            t = r.y - j;
          if (!p) {
            if (!(e * e + t * t > o * o)) return;
            ((p = !0), f());
          }
          (y.push(r),
            y.length > u && y.shift(),
            y.length > d &&
              ...
              (function () {
                if (!h || T) return;
                ((T = !0), (h.style.opacity = '0'));
                const n = () => {
                  (h.removeEventListener('transitionend', n), h && (h.remove(), (h = null), (L = null)));
                };
                (h.addEventListener('transitionend', n, { once: !0 }),
                  setTimeout(() => {
                    h && h.parentNode && '0' === h.style.opacity && (h.remove(), (h = null), (L = null));
                  }, 200));
              })(),
            O());
        }
              ...
              if (o >= i) {
                ...
                const r = (function (n) {
                  ...
                  let e = null,
                    t = null,
                    o = -1;
                  for (let a = r; a < n.length; a += r) {
                    const i = n[a].y - n[a - r].y;
                  ...
                  if (!t) return null;
                  const a = Math.min(o, n.length - 1),
                    i = Math.abs(n[a].y - n[0].y),
                    M = Math.abs(n[n.length - 1].y - n[a].y);
                  return i < c || M < c ? null : 'up' === e && 'down' === t ? 'up-down' : 'down' === e && 'up' === t ? 'down-up' : null;
                })(y);
                if (r) S(r);
                else {
                  const n = z(e, t);
                  ['left', 'right', 'up', 'down'].includes(n) && S(n, o);
                }
              }
            }
            E(!1);
        ...
        function B(n) {
          if (((D = n), b)) return;
          const r = 'ovn-gesture-style';
          if (!document.getElementById(r)) {
            const n = document.createElement('style');
            ((n.id = r), (n.textContent = '.gesture-active { user-select: none !important; -webkit-user-select: none !important; }'));
            const e = document.getElementById('ovnDOM');
            e ? e.appendChild(n) : document.head.appendChild(n);
          }
          w = new AbortController();
          const e = w.signal;
          (document.addEventListener('mousedown', U, { capture: !0, passive: !1, signal: e }),
            window.addEventListener('blur', () => E(!0), { signal: e }),
            window.addEventListener(
              'resize',
              () => {
                h && ((h.width = window.innerWidth), (h.height = window.innerHeight), v && C());
              },
              { signal: e },
            ),
            (b = !0));
        ...
        (window.addEventListener('compositionstart', () => {
          ...
          window.addEventListener(
            'contextmenu',
            (n) => {
              v && N && (n.preventDefault(), n.stopPropagation(), n.stopImmediatePropagation());
            },
            { capture: !0, passive: !1 },
          ),
          void 0 !== M && M.bindOVN
      ...
      !(function () {
        ...
        function M() {
          if (
            ...
            r.some((n) => window.location.host.endsWith(n)))
          ) {
        ...
        o &&
          (o.startsWith('--') &&
            (o = getComputedStyle(document.documentElement)
              ...
              .replace(/^url\(["']?(.*?)["']?\)$/i, '$1')
              .replace(/["']/g, '')),
          o && (document.head ? a(o) : document.addEventListener('DOMContentLoaded', () => a(o)), 'loading' === document.readyState ? document.addEventListener('DOMContentLoaded', () => setTimeout(M, 126)) : setTimeout(M, 126)));
      })();
    }),
    y.run('Selection', () => {
  ...
  (y.run('YUQUE', () => {
    ...
    y.run('ovnTable', () => {
      I.apply({ target: ['#main table:not(.data-table-card table)'], subjoin: ['ovnTable'] });
    }),
    y.run('ovnGrid', () => {
      I.apply({ target: ['.ne-editor-wrap-content', '.ne-viewer-layout-mode-fixed .ne-viewer-body'], subjoin: ['ovnGrid', 'ovnSolid'] });
    }));
  y.run('TickTick', () => {
  ...
  function T() {
    try {
      const n = document.documentElement;
      (n.classList.add('ovn'), c.apply('class', { html: n }), n.classList.contains('ovnThemeLight') && (n.classList.remove('ovnThemeLight'), n.classList.add('ovnThemeLight')), x.SCHEDULER.run(), x.DEBUG.infoTotal());
    } catch (n) {
      console.error('[Global.Custom] 启动出错:', n.stack);
    }
  }
  (y.run('Bilibili', () => {
