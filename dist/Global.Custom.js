...
(() => {
  ...
  const g = (() => {
    ...
    p = (() => {
      ...
      function N(n, { level: r, msg: e, time: o }) {
        t[n] || (t[n] = {});
        const a = t[n];
      ...
      return {
        log: function (r, o = 'DONE', t = 0, a) {
          const i = u({ icon: '🚀', key: r, time: t, msg: o }),
            c = a ? `${i} | ${a}` : i;
          return (e.push(c), n && console.log(c), p(r, c), N(r, { level: 'log', msg: o, time: t }), c);
        },
        warn: function (r, o = 'DEBUG', t = 0, a) {
          const i = u({ icon: '🛠️', key: r, time: t, msg: o }),
            c = a ? `${i} | ${a}` : i;
          return (e.push(c), n && console.warn(c), p(r, c), N(r, { level: 'warn', msg: o, time: t }), c);
        },
        error: function (r, o = 'ERROR', t = 0, a) {
          const i = u({ icon: '👾', key: r, time: t, msg: o }),
            c = a ? `${i} | ${a}` : i;
          return (e.push(c), n && console.error(c), p(r, c), N(r, { level: 'error', msg: o, time: t }), c);
        },
        getLogs: function (n) {
          return o[n] || [];
        },
    ...
    N = (() => {
      ...
      function r(r, o) {
        return function (t = {}) {
          ...
          a.forEach((t) => {
            const { key: a, type: c = 'switch', name: s = ['ON', 'OFF'], color: l = ['var(--ovnAccentHEX)', 'var(--ovnBase04HEX)'], group: d = o, class: u = [], default: v = !0, order: g = 50, inform: p = !0, reload: N = !1, map: m, onClick: y, onMounted: L } = t;
            (a || 'jump' === c) &&
              r((r) => {
                ...
                if ('jump' === c && m)
                  return void Object.entries(m).forEach(([t, a]) => {
                    ...
                    ((i.className = [...n(u)].join(' ')),
                      ...
                      (i.dataset.order = g),
                      (i.onclick = () => {
                        (y?.({ phase: 'action', type: 'jump', label: t, url: a, button: i }), p && M.top(`Jump TO ${t}`, 'correct'), y || (location.href = a), N && location.reload());
                      }),
                      e(o, i, g),
                      L?.(i));
                  });
                ...
                let I = 'switch' === c ? i.get(a, v) : null;
                function h() {
                  if ('switch' !== c) return void (t.textContent = n(s)[0] || 'RUN');
                  const r = n(s),
                    e = n(l);
                  ((t.textContent = I ? r[0] : r[1]), (t.style.background = I ? e[0] : e[1]));
                }
                ('switch' === c && (y?.({ phase: 'init', type: c, key: a, state: I, button: t }), (I = i.get(a, v))),
                  h(),
                  t.addEventListener('click', () => {
                    if ('switch' === c) {
                      if (((I = i.toggle(a)), h(), y?.({ phase: 'toggle', type: c, key: a, state: I, button: t }), p)) {
  ...
  const m = (() => {
              ...
              I &&
                ...
                p(g)
                  .then(() => {
                    ...
                    (n.searchParams.set('page', g), history.replaceState(null, '', n.toString()), (h = !1), (D = 0), T());
                  })
                  .finally(() => {
                    v = !1;
                  }));
    ...
    b = { PREFS: t, RUNTIME: i, REDIS: a, DOM: s, MATCH: l, SITE: d, OBSERVER: c, INFORM: M, RANDOM: u, DEBUG: p, BUTTON: N, CONFIG: v, RESOLVER: g, VERIFY: m, SCHEDULER: y, HOOK: n, ADD_CLASS: L, QUICK_READ: I, REMOVE_LIMITS: h, AUTO_LOAD: j, AUTO_EXECUTE: D, BATCH_LOAD: x };
  ((window.OVN = b),
    (function () {
        ...
        if (a.children && a.children.length > 0) {
          ...
          ((I.className = 'ovnGroupBody'),
            ...
            L.addEventListener('change', () => {
              const o = L.checked;
              (n.set(u, o), r(L, a, o), e(m, d, o), c(I, d && o));
            }),
            m.append(y, L),
            g.append(p, m),
            o(p, I, N, `fold_${u}`, a.fold ?? !1),
            a.children.forEach((n) => l(n, I, d && v)),
            i.append(g, I),
            s.appendChild(i));
        } else
          s.appendChild(
        ...
        Object.values(p).forEach((e) => {
          ...
          ((N.className = 'ovnGroupBody'),
            p.addEventListener('change', () => {
              const o = p.checked;
              (n.set(e.key, o), r(p, e, o), c(N, o));
            }),
            u.append(g, p),
            s.append(d, u),
            o(d, N, M, `fold_${e.key}`, e.fold ?? !1),
            e.children.forEach((n) => l(n, N, t)),
            a.append(s, N),
            v.appendChild(a));
        });
    ...
    (function () {
      function n() {
        ...
        const y = g.getTree(),
          L = Object.keys(y),
          I = [...L.filter((n) => d[n]), ...Object.keys(d).filter((n) => !L.includes(n))];
        for (const n of I) {
          const r = d[n];
          if (!r) continue;
          const e = document.createElement('div');
    ...
    y.run('Gallop', () => {
      !(function () {
        ...
        let N = !1,
          ...
          h = null;
        function j() {
          (h && (clearTimeout(h), (h = null)), window.removeEventListener('mousemove', x, !0), window.removeEventListener('mouseup', b, !0), (N = !1), (m = !1), (y = []), i && ((i.style.pointerEvents = 'none'), (i.style.display = 'none')), v && (cancelAnimationFrame(v), (v = null)), (g = !1));
        }
        function D() {
          (h && clearTimeout(h), window.removeEventListener('mousemove', x, !0), window.removeEventListener('mouseup', b, !0), (h = setTimeout(j, 200)));
        }
        function x(r) {
          if (!N) return;
          if (A) return void j();
        ...
        function b(r) {
          ...
          if ((r.preventDefault(), r.stopPropagation(), !m)) return void j();
        ...
        function z(n) {
          2 !== n.button ||
            ...
            (j(), window.addEventListener('mousemove', x, !0), window.addEventListener('mouseup', b, !0), (N = !0), (m = !1), (g = !1), (L = n.clientX), (I = n.clientY), (y = [{ x: n.clientX, y: n.clientY }]));
        }
    ...
    y.run('QuickRead', () => {
      !(function () {
        ...
        let N = document.getElementById('ovnDOM');
        if (N) {
          let r = N.getAttribute('data-ovn-fn') || '';
          N.setAttribute('data-ovn-fn', r ? r + ' ' + n : n);
        }
      })();
    }),
    y.run('CustomICON', () => {
