...
(() => {
        ...
        getSnapshot: function () {
          ...
          for (const n in a) {
            ...
            const N = m(n),
              p = M(`[${N}]`, s + 2),
              L = d(v),
              y = `${r}[${'fail' === g ? '👾' : '🚀'}][${L}ms]${p} | ${'fail' === g ? `FAIL - ${u}` : 'DONE'}`;
            i[n] = { group: c.group || n.split('_')[0] || 'Unknown', shortName: N, timeCost: v, steps: l, state: g, reason: u, logs: t[n] || [], consoleLine: y };
          }
          for (const n in o) {
            if (i[n]) continue;
            const e = o[n],
    ...
    p = (() => {
      ...
      function r(r, t) {
        return function (o = {}) {
          ...
          i.forEach((o) => {
            const { key: i, type: c = 'switch', name: s = ['ON', 'OFF'], color: M = ['var(--ovnAccentHEX)', 'var(--ovnBase04HEX)'], group: l = t, class: u = [], default: g = !0, order: v = 50, inform: N = !0, reload: p = !1, map: m, onClick: L, onMounted: y } = o;
            (i || 'jump' === c) &&
              r((r) => {
                ...
                let I = 'switch' === c ? a.get(i, g) : null;
                function j() {
                  if ('switch' !== c) return void (o.textContent = n(s)[0] || 'RUN');
                  const r = n(s),
                    e = n(M);
                  ((o.textContent = I ? r[0] : r[1]), (o.style.background = I ? e[0] : e[1]));
                }
                (j(),
                  'switch' === c && L?.({ phase: 'init', type: c, key: i, state: I, button: o }),
                  o.addEventListener('click', () => {
                    if ('switch' === c) {
                      if (((I = a.toggle(i)), j(), L?.({ phase: 'toggle', type: c, key: i, state: I, button: o }), N)) {
                        const r = I ? n(s)[0] || 'ON' : n(s)[1] || 'OFF';
                        d.top(`${i}: ${r}`, 'correct');
                      }
  ...
  const m = (() => {
    ...
    x = { PREFS: t, RUNTIME: a, REDIS: o, DOM: s, MATCH: M, SITE: l, OBSERVER: i, INFORM: d, RANDOM: u, DEBUG: N, BUTTON: p, CONFIG: g, RESOLVER: v, VERIFY: m, SCHEDULER: L, HOOK: c, ADD_CLASS: y, QUICK_READ: I, REMOVE_LIMITS: j, AUTO_LOAD: h, AUTO_EXECUTE: D };
  ((window.OVN = x),
    (function () {
    ...
    (function () {
      ...
      function M(o, s, l) {
        ...
        if (o.children && o.children.length > 0) {
          ...
          ((y.type = 'checkbox'), (y.checked = g), (y.disabled = !l), y.classList.add('ovnStatusDot', 'ovnState', 'ovnBack'), r(y, o, g), e(m, l, g));
          const I = document.createElement('div');
          ((I.className = 'ovnGroupBody'),
            requestAnimationFrame(() => {
              c(I, l && y.checked);
            }),
            y.addEventListener('change', () => {
              const t = y.checked;
              (n.set(u, t), r(y, o, t), e(m, l, t), c(I, l && t));
            }),
            m.append(L, y),
            v.append(N, m),
            i(N, I, p, `fold_${u}`, o.fold ?? !1),
            o.children.forEach((n) => M(n, I, l && g)),
            a.append(v, I),
            s.appendChild(a));
        } else
          s.appendChild(
    ...
    (function () {
      function n() {
        ...
        const L = v.getTree(),
          y = Object.keys(L),
          I = [...y.filter((n) => l[n]), ...Object.keys(l).filter((n) => !y.includes(n))];
        for (const n of I) {
          const r = l[n];
          if (!r) continue;
          const e = document.createElement('div');
      ...
      !(function () {
        ...
        function B(n) {
          2 !== n.button ||
            ...
            (m && (clearTimeout(m), (m = null)), O(!0), (v = !0), (N = !1), (p = !1), (y = n.clientX), (I = n.clientY), (L = [{ x: n.clientX, y: n.clientY }]), document.documentElement.classList.add('gesture-active'), window.addEventListener('mousemove', U, !0), window.addEventListener('mouseup', _, !0));
        }
        function U(n) {
          if (!v) return;
