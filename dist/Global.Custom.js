...
(() => {
    ...
    if (e) {
      ...
      const o = new MutationObserver(() => {
        if (r.classList.contains('ovn')) {
          ...
          (r && r.remove(), o.disconnect());
        }
      });
      return void o.observe(r, { attributes: !0, attributeFilter: ['class'] });
    }
    if (r.classList.contains('ovn')) return;
    const o = document.createElement('style');
    ((o.id = n), (o.textContent = 'html:not(.ovn){opacity:0!important;pointer-events:none!important}'));
    const t = () => {
      (o.remove(), a && a.disconnect());
    };
    let a = new MutationObserver(() => {
      r.classList.contains('ovn') && t();
    });
    (a.observe(r, { attributes: !0, attributeFilter: ['class'] }),
      setTimeout(() => {
        !r.classList.contains('ovn') && document.getElementById(n) && t();
      }, 526));
    const i = () => {
      if (document.getElementById(n)) return;
      const r = document.head;
      return !!r && (r.insertBefore(o, r.firstChild), !0);
    };
    if (!i()) {
      const n = () => {
  ...
  const e = new (class {
    ...
    inject(n) {
      const e = n || r,
        o = () => {
          try {
            if (!document.body) return void requestAnimationFrame(() => o());
            ...
            const t = this.styleContainer.querySelectorAll('style[data-ovn-style-global]');
  ...
  (o.classList.add('ovn'), n.apply('class', { html: o }), (window.OVN_CSS_INJECTOR = e));
  const t = (() => {
      function n(n) {
        const r = new Map();
        function e(r) {
        ...
        return {
          ...
          get(n, o) {
            ...
            const t = GM_getValue(e(n), o);
            return (void 0 !== t && r.set(n, t), t);
          },
          set(n, o) {
            (r.set(n, o), GM_setValue(e(n), o));
          },
          delete(n) {
    ...
    c = (() => {
      const n = new Map(),
        r = new Map(),
        e = new WeakMap();
      function o(n, o = { childList: !0, subtree: !0 }, t, a = {}) {
        ...
        const i = (function (n, e) {
          ...
          return ((c._callbacks = a), (c._debounce = 0), c.observe(n, e), o.set(t, c), c);
        })(n, o);
        if (
          (i._callbacks.add(t),
          ...
          const n = (r, e) => {
            ((a.autoDisconnect || ('function' == typeof a.onceWhen && a.onceWhen(r))) && i._callbacks.delete(n), t(r, e));
          };
          (i._callbacks.delete(t), i._callbacks.add(n));
        }
        return i;
      }
      function t(r) {
      ...
      return {
        ...
        disconnect: function (n) {
          const o = e.get(n);
          o && (o.forEach((n) => n.disconnect()), e.delete(n), r.delete(n));
        },
        disconnectKey: t,
    ...
    s = (() => {
      ...
      function r(r) {
        ...
        function l(n, r) {
          const e = 'style' === r ? 'STYLE' : 'SCRIPT',
            o = 'style' === r ? 'data-ovn-style' : 'data-ovn-script';
          return (
            n.tagName === e ||
            (function (n, r) {
        ...
        function M(n) {
          (n.firstChild !== t && n.insertBefore(t, n.firstChild), i && n.lastChild !== i && n.appendChild(i), a && (i ? a.nextSibling !== i && n.insertBefore(a, i) : n.lastChild !== a && n.appendChild(a)));
        }
        function u() {
          if ((e && !document.contains(e) && ((e = null), (o = null), c.disconnectKey(s)), e)) return e;
          const t = document.querySelector(`#${r}`);
          if (t) return ((e = t), r === n && v(e), e);
          ...
          (document.body.firstChild !== v && document.body.insertBefore(v, document.body.firstChild),
            ...
            (function (n) {
              ...
              (Array.from(n.children).forEach((n) => {
                n !== t && n !== a && n !== i && (n.hasAttribute('data-ovn-frozen') || n.hasAttribute('data-ovn-fn') || (l(n, 'style') ? d(n, t) : l(n, 'script') && d(n, a)));
              }),
                M(n));
            })(v),
            (function (n) {
                  ...
                  (r) => {
                    ...
                    (r.forEach((n) => {
                      n.addedNodes.forEach((n) => {
                        1 === n.nodeType && n !== t && n !== a && n !== i && (n.hasAttribute('data-ovn-frozen') || n.hasAttribute('data-ovn-fn') || (l(n, 'style') ? d(n, t) && (e = !0) : l(n, 'script') ? d(n, a) && (e = !0) : (e = !0)));
                      });
                    }),
                      e && M(n));
                  },
            ...
            r === n &&
              (function () {
                ...
                ((g = new MutationObserver(() => {
                  p ||
                    (p = setTimeout(() => {
                      ((p = null), (e && document.contains(e)) || ((e = null), (o = null), c.disconnectKey(s), u()));
                    }, 126));
                })),
      ...
      const e = r(n);
      return { create: r, OVN: (n) => e.bind(n) };
    })();
  n.apply('dom', s);
  const l = (() => {
      function n(n) {
      ...
      function r(r = {}) {
        const e = r.include || [],
          o = r.exclude || [],
          t = e.join('|') + '::' + o.join('|');
        return a.compute('compiledMatch', t, () => {
          const r = e.map(n),
            t = o.map(n),
    ...
    M = (() => {
      function n(n, r = {}) {
        const e = r.informTime || 3e3,
          o = new WeakMap();
        function a({ message: r, type: o = '', method: t = 'left', timeout: a = e }) {
        ...
        return {
          top: (n, r = '', o = e) => {
            a({ message: n, type: r, method: 'top', timeout: o });
          },
          left: (n, r = '', o = e) => {
            a({ message: n, type: r, method: 'left', timeout: o });
          },
          hover: function (n, r, e, a, i = 926) {
            ...
            const d = o.get(c);
            d && (c.removeEventListener('mouseenter', d.onEnter), c.removeEventListener('mouseleave', d.onLeave), d.timerId && clearTimeout(d.timerId), d.hoverElement && d.hoverElement.remove(), o.delete(c));
            let M = null,
              u = null;
            const v = (n) => {
                ((M = setTimeout(() => {
                  ...
                  const { clientX: i, clientY: d } = n,
                    ...
                    m = d - 40,
                    N = Math.max(10, Math.min(i - M / 2, window.innerWidth - M - 10));
                  if (
                    ((u.style.left = `${N}px`),
                    (u.style.top = `${Math.max(10, m)}px`),
                    requestAnimationFrame(() => {
                  ...
                  ('function' == typeof a && a(), 1 === e && (c.removeEventListener('mouseenter', v), c.removeEventListener('mouseleave', g), o.delete(c)));
                }, i)),
                  o.set(c, { timerId: M, hoverElement: u, onEnter: v, onLeave: g }));
              },
              g = () => {
            ...
            (c.addEventListener('mouseenter', v), c.addEventListener('mouseleave', g), o.set(c, { timerId: M, hoverElement: u, onEnter: v, onLeave: g }));
          },
        };
      }
      return { create: n, OVN: n(s.OVN, { informTime: 3e3 }) };
    })();
  n.apply('inform', M);
  const u = (() => {
      function n(n = {}) {
        const r = n.jitter || n,
          ...
          o = r.interval ?? 0,
          t = r.random ?? 0;
        return e + o * (n.order || 0) + (t ? Math.random() * t : 0);
      }
      return {
        get: n,
        run: function (r, e = {}) {
  ...
  const g = (() => {
      ...
      function e(r, o, t) {
        const a = (function ({ raw: n, path: r, parent: e }) {
          ...
          return { key: e ? `${e.key}_${o}` : o, id: r.join('_'), parent: e, children: [], name: n.name || '', feature: n.feature || '', fold: n.fold || !1, state: void 0 !== n.state ? n.state : !e || void 0, default: n.default ?? !0, block: n.block || [], match: ((t = n.match), t ? ('string' == typeof t ? { include: [t], exclude: [] } : Array.isArray(t) ? { include: t, exclude: [] } : { include: t.include || [], exclude: t.exclude || [] }) : null), phase: n.phase || null, priority: n.priority || 0, depend: n.depend || [], group: null };
          var t;
        })({ raw: r, path: o, parent: t });
        n[a.key] = a;
        for (const n in r) {
          const t = r[n];
          'object' == typeof t && (['name', 'feature', 'match', 'state', 'default', 'fold', 'block', 'priority', 'depend', 'phase'].includes(n) || a.children.push(e(t, [...o, n], a)));
        }
        return (
      ...
      return {
        ...
        getChain: function (r) {
          const e = [];
          let o = n[r];
          for (; o; ) (e.unshift(o.key), (o = o.parent));
          return e;
        },
        resolve: function (r) {
          if (n[r]) return r;
          const e = [];
          for (const o in n) o.endsWith(`_${r}`) && e.push(o);
    ...
    p = (() => {
      ...
      function M(n) {
        ...
        const [e, o] = n.toFixed(2).split('.');
        return e.padStart(r, '-') + '.' + o;
      }
      function u({ icon: n, key: e, time: o, msg: t }) {
        d(o);
        const a = M(o),
          c = N(e);
        !(function (n) {
      ...
      function p(n, r) {
        (o[n] || (o[n] = []), o[n].push({ msg: r, time: Date.now() }));
      }
      function m(n, { level: r, msg: e, time: o }) {
        t[n] || (t[n] = {});
        const a = t[n];
        (null != o && o >= 0 ? (a.timeCost = o) : a.timeCost || (a.timeCost = 0), (a.debugLevel = r), 'error' === r && ((a.error = !0), (a.errorMSG = e)), d(a.timeCost));
      }
      function N(n) {
        const r = n.split('_');
      ...
      return {
        log: function (r, o = 'DONE', t = 0, a) {
          const i = u({ icon: '🚀', key: r, time: t, msg: o }),
            c = a ? `${i} | ${a}` : i;
          return (e.push(c), n && console.log(c), p(r, c), m(r, { level: 'log', msg: o, time: t }), c);
        },
        warn: function (r, o = 'DEBUG', t = 0, a) {
          const i = u({ icon: '🛠️', key: r, time: t, msg: o }),
            c = a ? `${i} | ${a}` : i;
          return (e.push(c), n && console.warn(c), p(r, c), m(r, { level: 'warn', msg: o, time: t }), c);
        },
        error: function (r, o = 'ERROR', t = 0, a) {
          const i = u({ icon: '👾', key: r, time: t, msg: o }),
            c = a ? `${i} | ${a}` : i;
          return (e.push(c), n && console.error(c), p(r, c), m(r, { level: 'error', msg: o, time: t }), c);
        },
        getLogs: function (n) {
          return o[n] || [];
        },
          ...
          if (n) {
            for (const [n, r] of Object.entries(t)) {
              const e = r.error ? '👾' : 'warn' === r.debugLevel ? '🛠️' : '🚀',
                o = r.errorMSG || (r.error ? 'ERROR' : 'DONE');
              console.log(u({ icon: e, key: n, time: r.timeCost || 0, msg: o }));
            }
            if (void 0 !== c) {
        ...
        getSnapshot: function () {
          ...
          for (const n in a) {
            ...
            const p = N(n),
              m = l(`[${p}]`, s + 2),
              y = M(g),
              L = `${r}[${'fail' === v ? '👾' : '🚀'}][${y}ms]${m} | ${'fail' === v ? `FAIL - ${u}` : 'DONE'}`;
            i[n] = { group: c.group || n.split('_')[0] || 'Unknown', shortName: p, timeCost: g, steps: d, state: v, reason: u, logs: o[n] || [], consoleLine: L };
          }
          for (const n in t) {
            if (i[n]) continue;
            const e = t[n],
              ...
              g = M(d),
              p = `${r}[${a}][${g}ms]${v} | ${c}`;
            i[n] = { group: n.split('_')[0] || 'Unknown', shortName: u, timeCost: d, steps: {}, state: e.error ? 'fail' : 'done', reason: e.errorMSG || '', logs: o[n] || [], consoleLine: p };
          }
          return i;
        },
        ...
        okTrace: function (n, r, e) {
          const o = y(n).find((n) => n.step === r && 'pending' === n.state);
          o && ((o.state = 'done'), (o.timeCost = performance.now() - o.time), (o.detail = e), d(o.timeCost));
        },
        failTrace: function (n, r, e) {
          const o = y(n).find((n) => n.step === r && 'pending' === n.state);
          o && ((o.state = 'fail'), (o.reason = e), (o.timeCost = performance.now() - o.time), d(o.timeCost));
        },
        skipTrace: function (n, r, e) {
          y(n).push({ step: r, state: 'skip', reason: e });
        },
        format: function ({ icon: n, key: r, time: e, msg: o }) {
          return u({ icon: n, key: r, time: e, msg: o });
        },
      };
    })(),
    m = (() => {
      ...
      function r(r, o) {
        return function (t = {}) {
          ...
          a.forEach((t) => {
            const { key: a, type: c = 'switch', name: s = ['ON', 'OFF'], color: l = ['var(--ovnAccentHEX)', 'var(--ovnBase04HEX)'], group: d = o, class: u = [], default: v = !0, order: g = 50, inform: p = !0, reload: m = !1, map: N, onClick: y, onMounted: L } = t;
            (a || 'jump' === c) &&
              r((r) => {
                const o = (function (n, r) {
                  ...
                  const e = 'string' == typeof r ? [r] : r,
                    o = e.map((n) => `.${n}`).join('');
                  let t = n.querySelector(o);
                  t || ((t = document.createElement('div')), (t.className = e.join(' ')), n.appendChild(t));
                  return t;
                })(r, d);
                if ('jump' === c && N)
                  return void Object.entries(N).forEach(([t, a]) => {
                    if (r.querySelector(`[data-jump="${t}"]`)) return;
                    ...
                    ((i.className = [...n(u)].join(' ')),
                      ...
                      (i.dataset.order = g),
                      (i.onclick = () => {
                        (y?.({ phase: 'action', type: 'jump', label: t, url: a, button: i }), p && M.top(`Jump TO ${t}`, 'correct'), y || (location.href = a), m && location.reload());
                      }),
                      e(o, i, g),
                      L?.(i));
                  });
                ...
                ((t.className = [...n(u), a].join(' ')), (t.dataset.order = g));
                let h = 'switch' === c ? i.get(a, v) : null;
                function I() {
                  if ('switch' !== c) return void (t.textContent = n(s)[0] || 'RUN');
                  const r = n(s),
                    e = n(l);
                  ((t.textContent = h ? r[0] : r[1]), (t.style.background = h ? e[0] : e[1]));
                }
                ('switch' === c && (y?.({ phase: 'init', type: c, key: a, state: h, button: t }), (h = i.get(a, v))),
                  I(),
                  t.addEventListener('click', () => {
                    if ('switch' === c) {
                      if (((h = i.toggle(a)), I(), y?.({ phase: 'toggle', type: c, key: a, state: h, button: t }), p)) {
                        const r = h ? n(s)[0] || 'ON' : n(s)[1] || 'OFF';
                        M.top(`${a}: ${r}`, 'correct');
                      }
                    } else (y?.({ phase: 'action', type: c, key: a, button: t }), p && M.top(`${n(s)[0] || a} 已执行`, 'correct'));
                    m && location.reload();
                  }),
                  e(o, t, g),
                  L?.(t));
      ...
      function e(n, r, e) {
        const o = n.querySelectorAll('[data-order]');
        let t = null;
        for (const n of o) {
        ...
        t ? n.insertBefore(r, t) : n.appendChild(r);
      }
      return { create: r, OVN: r(s.OVN, ['ovnButtonBase', 'ovnButtonUnder']) };
    })();
  n.apply('button', m);
  const N = (() => {
      function n(n) {
      ...
      function r(r, e) {
        const o = e.group?.block;
        if (!o?.length) return { ready: !0 };
        return o.some((n) => l.check(n, e.url)) ? n('BLOCK') : { ready: !0 };
      }
      function e(r, e) {
      ...
      return {
        check: function (n, a) {
          ...
          for (const [r, e] of i) {
            ...
            const o = e(n, a);
            if (!o.ready) return (p?.failTrace?.(n.key, r, o.reason), o);
            p?.okTrace?.(n.key, r);
          }
          return { ready: !0 };
        },
    ...
    y = (() => {
      ...
      function t() {
        ...
        n.length = 0;
        const a = (n, r) => {
          for (const e of n) (p?.startTrace?.(e.mod.key, `phase.${r}`), p?.startTrace?.(e.mod.key, 'run.exec'), o(e.mod, e.callback), p?.okTrace?.(e.mod.key, 'run.exec'), p?.okTrace?.(e.mod.key, `phase.${r}`));
        };
        if ((a(t.start, 'start'), a(t.init, 'init'), t.ready.length || t.end.length)) {
          const n = () => {
            (a(t.ready, 'ready'), a(t.end, 'end'));
          };
      ...
      return {
        run: function (e, a, c = {}) {
          ...
          if (
            ...
            performance.now();
            return (o(l, a), p?.okTrace?.(s, 'run.exec'), !0);
          }
          return (n.push({ mod: l, callback: a }), r || ((r = !0), Promise.resolve().then(t)), !0);
        },
      };
    })(),
    L = (() => {
      const n = 'visited',
        r = 'data-ovn-trace';
      return {
        apply: function ({ delay: e = 260, target: o, subjoin: a, trace: i = !1, traceQuery: s = 'a[href]', traceJudge: l }) {
          ...
          e > 0 ? setTimeout(m, e) : m();
        },
      };
    })(),
    h = {
      apply: function ({ scroll: n = !0, smooth: r = !0, ratio: e = 0.8, letterKey: o = !0, buttonPrev: t = '#page-prev', buttonNext: a = '#page-next' } = {}) {
        const i = (n) => window.scrollBy({ top: n, left: 0, behavior: r ? 'smooth' : 'auto' }),
          c = { ArrowLeft: () => document.querySelector(t)?.click(), ArrowRight: () => document.querySelector(a)?.click(), ArrowUp: () => n && i(-window.innerHeight * e), ArrowDown: () => n && i(window.innerHeight * e) };
        (o && Object.assign(c, { a: c.ArrowLeft, d: c.ArrowRight, w: c.ArrowUp, s: c.ArrowDown }),
          ...
          const o = ((n) => {
            ...
            return (
              document.addEventListener(
                'keydown',
                (n) => {
                  e.includes(n.key.toLowerCase()) && (o = !0);
                },
                !0,
              ),
              document.addEventListener(
                'keyup',
                (n) => {
                  e.includes(n.key.toLowerCase()) && (o = !1);
                },
                !0,
              ),
              () => o
    ...
    j = (() => {
      ...
      return {
        apply: function ({ mode: r = 'smart', loadPage: e = 9, itemTarget: o = '#container .c-container', itemWrapper: t = '#container', buttonPrev: a = '.page-prev', buttonNext: i = '.page-next', fragment: c = !1, jitter: s } = {}) {
          const l = s || { delay: 30, interval: 30, random: 70 },
            d = (function () {
              const n = location.href.match(/page=(\d+)/);
              return n ? parseInt(n[1]) : 1;
            })(),
            M = 'string' == typeof t ? document.querySelector(t) : t;
          if (!M) return;
          let v = !1,
            g = d;
          function p(r) {
            return new Promise((e) => {
              const t = u.get({ jitter: l, order: r });
              setTimeout(() => {
                $.get(n(r), (n) => {
                  const r = document.createElement('div');
                  r.innerHTML = n;
                  const t = r.querySelectorAll(o),
          ...
          if ('multipage' === r) {
            ...
            m && ((m.href = n(d + e + 1)), (m.textContent = `Next ${e + 1}`));
            const N = [];
            for (let y = 1; y <= e; y++) {
              const L = d + y;
              N.push(p(L));
              ...
              h &&
                ...
                p(g)
                  .then(() => {
                    ...
                    (n.searchParams.set('page', g), history.replaceState(null, '', n.toString()), (I = !1), (D = 0), T());
                  })
                  .finally(() => {
                    v = !1;
                  }));
    ...
    D = (() => {
      ...
      return {
        apply: function (e = {}) {
          const { jitter: o, delay: t, interval: a, random: i, backstage: c = !1, strict: s = !1, debug: l = !1 } = e,
            d = o || { delay: t || 200, interval: a || 20, random: i || 0 },
            M = [];
          for (let n = 1; n <= 10; n++) {
            const r = `step${n}`;
            e[r] && M.push(e[r]);
                  ...
                  for (let e = 0; e < M.length && !g; e++) {
                    ...
                    await new Promise((t) => {
                      u.run(
                        () => {
                          if (g) return void t();
                          const { target: a, action: i = 'click' } = o;
                          try {
                            const o = document.querySelector(a);
                            o ? (r(o, i), p.log(n, `Step${e + 1} ✅ ${i} - ${a}`)) : (p.warn(n, `Step${e + 1} ❓ None - ${a}`), s && ((g = !0), p.error(n, `Step${e + 1} ❌ Break`)));
                          } catch (r) {
          ...
          ('loading' === document.readyState ? document.addEventListener('DOMContentLoaded', m) : m(), document.addEventListener('visibilitychange', m));
        },
      };
    })(),
    x = {
      apply: function ({ delay: n = 120, interval: r = 200, random: e = 120, item: o = 10, target: t = '#container', url: a = 'a[href]' } = {}) {
        const i = 'string' == typeof t ? document.querySelector(t) : t;
        if (!i) return;
        const c = i.querySelectorAll(a),
          s = Math.min(o, c.length);
        if (0 !== s)
          for (let o = s - 1, t = 0; o >= 0; o--, t++) {
            const a = c[o];
            if (!a) continue;
            ...
            const d = u.get({ delay: n, interval: r, random: e, order: t });
            setTimeout(() => {
              if ('undefined' != typeof GM_openInTab)
                try {
                  GM_openInTab(l, { active: !1, insert: !0 });
                } catch (n) {
    ...
    b = { PREFS: t, RUNTIME: i, REDIS: a, DOM: s, MATCH: l, SITE: d, OBSERVER: c, INFORM: M, RANDOM: u, DEBUG: p, BUTTON: m, CONFIG: v, RESOLVER: g, VERIFY: N, SCHEDULER: y, HOOK: n, ADD_CLASS: L, QUICK_READ: h, REMOVE_LIMITS: I, AUTO_LOAD: j, AUTO_EXECUTE: D, BATCH_LOAD: x };
  ((window.OVN = b),
    (function () {
      ...
      const o = (n, r) => {
        ...
        t = (n) => {
          ...
          const [e, o, t] = r.map(Number);
          return (299 * e + 587 * o + 114 * t) / 1e3;
        },
        a = () => {
            ...
            (n, [r, e]) =>
              ...
              ((n, r) => {
                ...
                for (; e && e !== document.documentElement; ) {
                  ...
                  if (n && 'transparent' !== n && !n.includes('rgba(0, 0, 0, 0)')) return t(n);
                  e = e.parentElement;
                }
                return 255;
              })(r, e),
            ...
            i =
              (() => {
                const { documentElement: e, body: t } = document,
                  a = (n, r) => o(n, r.dark) - o(n, r.light);
                let i = a(e, r) + a(t, r);
                return i ? (i > 0 ? 'dark' : 'light') : ((i = a(e, n) + a(t, n)), i ? (i > 0 ? 'dark' : 'light') : null);
              })() ||
              a() ||
              (window.matchMedia('(prefers-color-scheme: dark)').matches ? 'dark' : window.matchMedia('(prefers-color-scheme: light)').matches ? 'light' : null) ||
              'light';
          i !== e && (t.setAttribute('data-ovn-theme', i), (e = i));
        },
        s = () => {
    ...
    (function () {
      ...
      function c(n, o) {
        n.querySelectorAll('input[type=checkbox]').forEach((n) => {
          ...
          if (!c) return;
          n.disabled = !o;
          const s = i.get(t, a?.default ?? !0);
          ((n.checked = !!o && s), r(n, a || {}, n.checked), e(c, o, n.checked));
        });
      }
      function l(a, s, d) {
        const u = a.key,
        ...
        if (a.children && a.children.length > 0) {
          ...
          ((p.className = 'ovnFoldBox'), (p.style.cursor = 'pointer'), t.hover.get(u, !0) && M.OVN.hover(p, 'HEIHEI 彩蛋 | ClickClick', 2));
          const m = document.createElement('div');
          ((m.className = 'ovnArrow'), (m.textContent = '›'), p.appendChild(m));
          const N = document.createElement('label');
          N.className = 'ovnHeaderRow';
          const y = document.createElement('span');
          ((y.textContent = u.split('_').pop()), (y.style.marginRight = 'auto'));
          const L = document.createElement('input');
          ((L.type = 'checkbox'), (L.checked = v), (L.disabled = !d), L.classList.add('ovnStatusDot', 'ovnState', 'ovnBack'), r(L, a, v), e(N, d, v));
          ...
          ((h.className = 'ovnGroupBody'),
            ...
            L.addEventListener('change', () => {
              const o = L.checked;
              (n.set(u, o), r(L, a, o), e(N, d, o), c(h, d && o));
            }),
            N.append(y, L),
            g.append(p, N),
            o(p, h, m, `fold_${u}`, a.fold ?? !1),
            ...
            (function (o, a) {
              ...
              ((u.type = 'checkbox'),
                ...
                u.addEventListener('change', () => {
                  (n.set(c, u.checked), r(u, o, u.checked), e(l, a, u.checked));
                }),
                l.append(d, u));
              const v = o.error ? o.errorMSG : o.feature;
              return (v && t.hover.get(c, !0) && M.OVN.hover(l, v), l);
            })(a, d),
          );
      }
      function d() {
        ...
        Object.values(p).forEach((e) => {
          ...
          ((p.type = 'checkbox'), (p.checked = t), p.classList.add('ovnStatusDot', 'ovnState', 'ovnBack'), r(p, e, t));
          const m = document.createElement('div');
          ((m.className = 'ovnGroupBody'),
            p.addEventListener('change', () => {
              const o = p.checked;
              (n.set(e.key, o), r(p, e, o), c(m, o));
            }),
            u.append(g, p),
            s.append(d, u),
            o(d, m, M, `fold_${e.key}`, e.fold ?? !1),
            e.children.forEach((n) => l(n, m, t)),
            a.append(s, m),
            v.appendChild(a));
        });
        const m = document.createElement('button');
        ((m.textContent = 'Apply'),
          (m.className = 'ovnButtonBase ovnButtonAdapt ovnApply'),
          (m.onclick = () => {
            (n.forEach((n, r) => i.set(r, n)), M.OVN.top('已应用 即将刷新', 'correct'), setTimeout(() => location.reload(), 1260));
          }));
        const N = document.createElement('button');
        ((N.textContent = 'Reset'),
          (N.className = 'ovnButtonBase ovnButtonAdapt ovnReset'),
          (N.onclick = () => {
            (t.reset(), a.clear(), M.OVN.top('已重置 即将刷新', 'correct'), setTimeout(() => location.reload(), 1260));
          }));
        const y = document.createElement('div');
        ((y.className = 'ovnButton'),
          y.append(m, N),
          d.append(v, y),
          s.OVN((n) => n.appendChild(d)),
    ...
    (function () {
      function n() {
        ...
        ((o.id = 'ovnDebugPanel'), (o.className = 'ovnPanelBase'));
        ...
        const m = `[==👽OVN==][🛸] DONE - ${u}/${u + v} | FAIL - ${v}`,
          N = document.createElement('div');
        N.className = 'ovnDebugGrid';
        const y = g.getTree(),
          L = Object.keys(y),
        ...
        for (const n of h) {
          ...
          const o = document.createElement('div');
          ((o.className = 'ovnDebugGroupTitle'), (o.textContent = n), e.appendChild(o));
          for (const { key: n, val: o } of r) {
            const n = document.createElement('div');
            n.className = 'ovnDebugItem';
            const r = document.createElement('div');
            ((r.className = 'ovnDebugModkey'), (r.textContent = o.shortName));
            const t = document.createElement('div'),
              a = 'done' === o.state ? 'success' : 'error';
            ((t.className = 'ovnDebugStatus ovnState ovnFore'), t.setAttribute('data-ovn-state', a), (t.textContent = o.state.toUpperCase()));
            const i = document.createElement('div');
        ...
        const I = document.createElement('div');
        I.className = 'ovnDebugBottom';
        const j = document.createElement('pre');
        j.className = 'ovnObserver';
        ...
        w.className = 'ovnDebugConsole';
        const T = [];
        T.push(m);
        for (const [n, r] of Object.entries(l))
          try {
            r && r.consoleLine && 'string' == typeof r.consoleLine && T.push(r.consoleLine);
          } catch (r) {
            T.push(`[==👽OVN==][👾][-.--ms][${n}] | ERROR - ${r?.message || 'Unknown'}`);
          }
        const S = document.getElementById('ovnLog');
        if (S) {
          const n = Array.from(S.querySelectorAll('pre')).map((n) => n.textContent);
          n.length > 0 && (T.push(' '), T.push('----------'), T.push(' '), T.push(...n), T.push(' '));
        }
        ((w.textContent = T.join('\n')),
          I.appendChild(j),
          I.appendChild(x),
          I.appendChild(w),
          o.appendChild(N),
    ...
    y.run('LoaderBar', () => {
      !(function () {
        ...
        function n(n, r) {
          let e = n.getAttribute('data-ovn-fn') || '',
            o = e ? e.split(' ') : [];
          ((o = o.filter((n) => 'LoaderBar' !== n && 'ScrollBar' !== n)), o.push(r), n.setAttribute('data-ovn-fn', o.join(' ')));
        }
        let r = document.getElementById('ovnDOM');
        function e() {
          ...
          let e,
            o = !0;
          function t() {
            let n = parseFloat(r.style.width) || 0,
              e = 'interactive' === document.readyState ? 80 : 'complete' === document.readyState ? 100 : 0;
            (e > 0 && o && ((o = !1), (r.style.animation = 'none')), (r.style.width = Math.max(n, e) + '%'), 100 === e && (document.removeEventListener('readystatechange', t), setTimeout(a, 260)));
          }
          function a() {
            let e = document.getElementById('ovnDOM');
            (e && n(e, 'ScrollBar'), (r.style.animation = 'none'), window.addEventListener('resize', c), c());
          }
          function i() {
            e ||
              (e = requestAnimationFrame(() => {
                if (((e = null), !r.isConnected)) return (window.removeEventListener('scroll', i), void window.removeEventListener('resize', c));
                ...
                r.style.width = (n / o) * 100 + '%';
              }));
          }
          function c() {
            if (!r.isConnected) return (window.removeEventListener('scroll', i), void window.removeEventListener('resize', c));
            document.documentElement.scrollHeight > window.innerHeight ? (window.removeEventListener('scroll', i), window.addEventListener('scroll', i), (r.style.display = 'block'), i()) : (window.removeEventListener('scroll', i), (r.style.display = 'none'));
          }
          (s.OVN((n) => n.appendChild(r)), document.addEventListener('readystatechange', t), t());
        }
        (r && n(r, 'LoaderBar'),
          document.body
            ? e()
      ...
      !(function () {
        ...
        function a(e, o = 0) {
          switch (e) {
            ...
            case 'down': {
              let t = r;
              o >= n && (t = o < 426 ? 1 : o <= 926 ? 4 : 12);
              !(function (n) {
                window.scrollBy({ top: n, behavior: 'smooth' });
              })(('up' === e ? -1 : 1) * window.innerHeight * t);
              break;
            }
          }
        }
        ...
        function l() {
          ...
          return !!n && ((i = document.createElement('div')), (i.id = 'ovnGallop'), (i.style.cssText = 'display:none;position:fixed;top:0;left:0;width:100%;height:100%;z-index: var(--ovnPriority09,9292692);pointer-events:none;user-select:none;-webkit-user-select:none;cursor:default;'), (c = document.createElement('canvas')), (c.style.cssText = 'position:absolute;top:0;left:0;width:100%;height:100%;pointer-events:none;'), (s = c.getContext('2d')), i.appendChild(c), n.appendChild(i), !0);
        }
        let d = '';
        function u() {
        ...
        let m = !1,
          ...
          I = null;
        function j() {
          (I && (clearTimeout(I), (I = null)), window.removeEventListener('mousemove', x, !0), window.removeEventListener('mouseup', b, !0), (m = !1), (N = !1), (y = []), i && ((i.style.pointerEvents = 'none'), (i.style.display = 'none')), v && (cancelAnimationFrame(v), (v = null)), (g = !1));
        }
        function D() {
          (I && clearTimeout(I), window.removeEventListener('mousemove', x, !0), window.removeEventListener('mouseup', b, !0), (I = setTimeout(j, 200)));
        }
        function x(r) {
          if (!m) return;
          if (A) return void j();
          ...
          I * I + D * D < 4 ||
            ...
            y.length >= e &&
              ...
              (function () {
                ...
                const n = t.gallop.get('destroy_tip', 0);
                n < 2 && (M.OVN.top('YO 👾 调皮'), t.gallop.set('destroy_tip', n + 1));
              })(),
            y.length > e && y.shift(),
            p());
        }
        function b(r) {
          ...
          if ((r.preventDefault(), r.stopPropagation(), !N)) return void j();
          ...
          if (c >= n) {
            ...
            const e = (function (n) {
              ...
              let r = null,
                e = null,
                o = -1;
              for (let t = 3; t < n.length; t += 3) {
                const a = n[t].y - n[t - 3].y;
              ...
              if (!e) return null;
              const t = Math.min(o, n.length - 1),
                a = Math.abs(n[t].y - n[0].y),
                i = Math.abs(n[n.length - 1].y - n[t].y);
        ...
        function z(n) {
          2 !== n.button ||
            ...
            (j(), window.addEventListener('mousemove', x, !0), window.addEventListener('mouseup', b, !0), (m = !0), (N = !1), (g = !1), (L = n.clientX), (h = n.clientY), (y = [{ x: n.clientX, y: n.clientY }]));
        }
        (window.addEventListener('compositionstart', () => {
          ...
          setTimeout(function n() {
            l()
              ? (window.addEventListener('contextmenu', w, { capture: !0, passive: !1 }),
                window.addEventListener('auxclick', T, { capture: !0, passive: !1 }),
                ...
                window.addEventListener('resize', () => {
                  m && c && s && ((c.width = window.innerWidth * (window.devicePixelRatio || 1)), (c.height = window.innerHeight * (window.devicePixelRatio || 1)), s.setTransform(window.devicePixelRatio || 1, 0, 0, window.devicePixelRatio || 1, 0, 0));
                }))
              : setTimeout(n, 524);
          }, 524));
        let f = document.getElementById('ovnDOM');
        if (f) {
          let n = f.getAttribute('data-ovn-fn') || '';
          f.setAttribute('data-ovn-fn', n ? n + ' Gallop' : 'Gallop');
        }
      })();
    }),
    y.run('QuickRead', () => {
      !(function () {
        const n = 'QuickRead',
          ...
          t = !0,
          a = !0,
          i = (n) => window.scrollBy({ top: n, left: 0, behavior: t ? 'smooth' : 'auto' }),
          c = { ArrowUp: () => o && i(-window.innerHeight * r), ArrowDown: () => o && i(window.innerHeight * r) };
        a && Object.assign(c, { w: c.ArrowUp, s: c.ArrowDown });
        const s = { ArrowUp: -1, ArrowDown: 1 };
        a && Object.assign(s, { w: -1, s: 1 });
        let l = null,
          d = 0,
          M = null,
          u = 0,
          ...
          g = 0;
        function p(n) {
          (n && n !== l) || (M && (cancelAnimationFrame(M), (M = null)), (l = null), (d = 0));
        }
        (document.addEventListener(
          'keydown',
          (n) => {
            ...
            if ('input' === o || 'textarea' === o || 'select' === o || r.isContentEditable) return;
            if (n.defaultPrevented) return;
            const t = n.key,
              a = c[t] || c[t.toLowerCase()];
            if (!a) return;
            if ((n.preventDefault(), n.repeat)) {
              const n = s[t];
              return void (
                n &&
                !M &&
                (function (n) {
                  M ||
                    ...
                    (v = []),
                    (g = 0),
                    (M = requestAnimationFrame(function n(r) {
                      if (null !== M) {
                        if (g) {
                          const n = r - g;
                          n < 100 && (v.push(n), v.length > 60 && v.shift(), (u = 1e3 / (v.reduce((n, r) => n + r, 0) / v.length)));
                        }
                        if (((g = r), u)) {
                          const n = (window.innerHeight * e) / u;
                          window.scrollBy({ top: d * n, left: 0, behavior: 'auto' });
                        }
  ...
  y.run('ChatGPT', () => {
    GM_addStyle('\r\n\r\nhtml {\r\n    \r\n    &:root body {\r\n        \r\n        --ovnChatCA: var(--ovnAccentHEX);\r\n        --ovnChatCS: var(--ovnSecondaryHEX);\r\n        --ovnChatCP: var(--ovnPrimaryHEX);\r\n        --ovnChatBG: var(--ovnBase09HEX);\r\n        \r\n        --ovnChatRB: var(--ovnRB);\r\n        --ovnChatRU: var(--ovnRU);\r\n        --ovnChatRP: var(--ovnRP);\r\n        --ovnChatRS: var(--ovnRS);\r\n        --ovnChatRL: var(--ovnRL);\r\n        --ovnChatRX: var(--ovnRX);\r\n        \r\n        --ovnChatX: var(--ovnSpaceWidth02);\r\n        \r\n        @media (width >= 1080px) { --ovnChatV: calc(var(--ovnChatX) + 20vw) }\r\n        @media (width >= 1600px) { --ovnChatV: calc(var(--ovnChatX) + 15vw) }\r\n        @media (width >= 1920px) { --ovnChatV: calc(var(--ovnChatX) + 02vw) }\r\n        \r\n    }\r\n    \r\n    &.ovn body {\r\n        .\\@w-lg\\/main\\:\\[--thread-content-max-width\\:48rem\\] {\r\n            --thread-content-max-width: var(--ovnChatV);\r\n        }\r\n    }\r\n    \r\n    \r\n    \r\n        \r\n        .sm\\:rounded-\\[100px\\] {\r\n            border-radius: var(--ovnChatRP);\r\n        }\r\n        \r\n        \r\n        .max-w-lg[id^="radix-_r_"] { max-width: calc(9vw + 26vw); }\r\n        #instructions { min-height: 12vh; height: 26vh; }\r\n        \r\n        .shadow-xs, .shadow-xxs, .shadow-short-composer {\r\n            --tw-shadow:\r\n                0px 0px 00px 1px var(--tw-shadow-color, var(--shadow-color-2, #0000000F)),\r\n                0px 5px 10px 0px var(--tw-shadow-color, var(--shadow-color-1, #00000009));\r\n            border: none;\r\n        }\r\n        \r\n        \r\n        \r\n            form[data-type="unified-composer"] {\r\n                \r\n                .shadow-short {\r\n                    --tw-shadow:\r\n                        0px 0px 00px 1px var(--tw-shadow-color, var(--shadow-color-2, #0000000D)),\r\n                        0px 5px 10px 0px var(--tw-shadow-color, var(--shadow-color-1, #00000012));\r\n                }\r\n                \r\n                .min-h-14 { min-height: calc(var(--spacing) * 14 + 40px); }\r\n                \r\n                p.placeholder { opacity: .4; }\r\n                \r\n                [class*="[grid-area:leading]"] { display: flex; align-items: center; }\r\n                \r\n            }\r\n            \r\n        \r\n        \r\n        \r\n            \r\n    \r\n    \r\n    \r\n}\r\n\r\n\r\n\r\n');
  });
  y.run('Gemini', () => {
    GM_addStyle('\r\n\r\nhtml {\r\n    \r\n    &:root body {\r\n        \r\n        --ovnGeminiCA: var(--ovnAccentHEX);\r\n        --ovnGeminiCS: var(--ovnSecondaryHEX);\r\n        --ovnGeminiCP: var(--ovnPrimaryHEX);\r\n        --ovnGeminiBG: var(--ovnBase09HEX);\r\n        \r\n        --ovnGeminiRB: var(--ovnRB);\r\n        --ovnGeminiRU: var(--ovnRU);\r\n        --ovnGeminiRP: var(--ovnRP);\r\n        --ovnGeminiRS: var(--ovnRS);\r\n        --ovnGeminiRL: var(--ovnRL);\r\n        --ovnGeminiRX: var(--ovnRX);\r\n        \r\n        --ovnGeminiX: var(--ovnSpaceWidth02);\r\n        --ovnGeminiInput: 50px;\r\n        \r\n        @media (width <= 1260px) { --ovnGeminiV: calc(var(--ovnGeminiX) + 40vw) }\r\n        @media (width >= 1260px) { --ovnGeminiV: calc(var(--ovnGeminiX) + 20vw) }\r\n        @media (width >= 1920px) { --ovnGeminiV: calc(var(--ovnGeminiX) + 02vw) }\r\n        \r\n    }\r\n    \r\n    &.ovn body {\r\n        \r\n        --ovnGeminiSYS: var(--lumi-sys-color--surface);\r\n        \r\n        &:where(.theme-host) {\r\n            --lumi-sys-color--code-background: #1f2026;                         \r\n            --gem-sys-shape--corner-full: var(--ovnGeminiRP);                   \r\n            --mat-list-active-indicator-shape: var(--ovnGeminiRP);              \r\n            --mat-icon-button-container-shape: var(--ovnGeminiRP);              \r\n            --mat-button-text-container-shape: var(--ovnGeminiRP);              \r\n            --mat-button-filled-container-shape: var(--ovnGeminiRP);            \r\n        }\r\n        &:where(.theme-host):where(.enable-lm-spacing-tokens) {\r\n            --gem-sys-shape--corner-extra-large-max: var(--ovnGeminiRP);        \r\n            --gem-sys-shape--corner-extra-large-increased: var(--ovnGeminiRL);  \r\n        }\r\n        .enable-luminous-content-width-update {\r\n            --bard-chat-window-content-width-default: var(--ovnGeminiV);        \r\n        }\r\n        .chat-history-scroll-container.lm.lm {\r\n            --gradient-fade-height: 0;                                          \r\n        }\r\n    }\r\n    \r\n    \r\n    \r\n        \r\n        \r\n            .lm-input-redesign, .lm-input-redesign-ssr {\r\n                .initial-input-area-container.initial-input-area-container,       \r\n                .input-area-container.input-area-container.input-area-container { \r\n                    max-width: var(--ovnGeminiV);\r\n                    border-radius: var(--ovnGeminiRL);\r\n                }\r\n                .input-area.input-area.input-area.input-area.input-area:is(&, :has(.text-input-field.simplified-input-area)) {\r\n                    --input-area-content-size: var(--ovnGeminiInput);\r\n                }\r\n                .initial-input-area-container textarea {\r\n                    --input-area-height: var(--ovnGeminiInput);\r\n                }\r\n            }\r\n            \r\n            \r\n    \r\n    \r\n        .content-wrapper.content-wrapper {\r\n            \r\n            \r\n            .conversation-container model-response {\r\n                padding-bottom: calc( 50px + var(--ovnGeminiInput));\r\n            }\r\n            \r\n            \r\n            \r\n                \r\n                .enable-luminous-code-block .code-block-decoration.header-formatted { margin-right: -20px; }\r\n                \r\n                \r\n                input-container .enable-luminous-disclaimer-updates .capabilities-disclaimer.capabilities-disclaimer p {\r\n                    margin-block: 5px;\r\n                }\r\n                \r\n                .enable-luminous-prompt-bubble .user-query-bubble-with-background,     \r\n                .enable-luminous-code-block .formatted-code-block-internal-container { \r\n                    padding: 1em 1.5em;\r\n                }\r\n                \r\n                \r\n                .query-text-line.ng-star-inserted > .ng-star-inserted {\r\n                    display: none;\r\n                }\r\n                \r\n                \r\n                .enable-luminous-prompt-bubble .luminous-toggle-container {\r\n                    bottom: 10px;\r\n                    inset-inline-end: 10px;\r\n                }\r\n                .enable-luminous-prompt-bubble .luminous-expand-fade { opacity: 0; }\r\n                \r\n        }\r\n        \r\n        :where(.content-wrapper) {\r\n            \r\n            .input-gradient.input-gradient {\r\n                position: fixed;\r\n                background: linear-gradient( to top, var(--ovnGeminiSYS), transparent);\r\n                &:before { background: none; }\r\n            }\r\n            \r\n            \r\n            .ng-star-inserted .markdown ul > li:before {\r\n                left: 15px;\r\n            }\r\n            \r\n        }\r\n        \r\n}\r\n\r\n\r\n\r\n');
  });
  y.run('DOUBAO', () => {
      ...
      m.OVN([
        {
          ...
          order: 20,
          onClick: () => {
            x.apply({ item: 7, target: '.video-list.row', url: ".bili-video-card .bili-video-card__wrap > a[href*='//www.bilibili.com/video']" });
          },
        },
      ]);
    }),
