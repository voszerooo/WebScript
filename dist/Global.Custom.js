...
(() => {
  ...
  const m = (() => {
    ...
    b = { PREFS: t, RUNTIME: i, REDIS: a, DOM: s, MATCH: l, SITE: d, OBSERVER: c, INFORM: M, RANDOM: u, DEBUG: p, BUTTON: N, CONFIG: v, RESOLVER: g, VERIFY: m, SCHEDULER: y, HOOK: n, ADD_CLASS: L, QUICK_READ: h, REMOVE_LIMITS: I, AUTO_LOAD: j, AUTO_EXECUTE: D, BATCH_LOAD: x };
  ((window.OVN = b),
    (function () {
        ...
        if (a.children && a.children.length > 0) {
          ...
          ((h.className = 'ovnGroupBody'),
            ...
            L.addEventListener('change', () => {
              const o = L.checked;
              (n.set(u, o), r(L, a, o), e(m, d, o), c(h, d && o));
            }),
            m.append(y, L),
            g.append(p, m),
            o(p, h, N, `fold_${u}`, a.fold ?? !1),
    ...
    y.run('Gallop', () => {
      !(function () {
        ...
        let N = !1,
          ...
          I = null;
        function j() {
          (I && (clearTimeout(I), (I = null)), window.removeEventListener('mousemove', x, !0), window.removeEventListener('mouseup', b, !0), (N = !1), (m = !1), (y = []), i && ((i.style.pointerEvents = 'none'), (i.style.display = 'none')), v && (cancelAnimationFrame(v), (v = null)), (g = !1));
        }
        function D() {
        ...
        function z(n) {
          2 !== n.button ||
            ...
            (j(), window.addEventListener('mousemove', x, !0), window.addEventListener('mouseup', b, !0), (N = !0), (m = !1), (g = !1), (L = n.clientX), (h = n.clientY), (y = [{ x: n.clientX, y: n.clientY }]));
        }
