...
(() => {
          ...
          (document.body.firstChild !== n && document.body.insertBefore(n, document.body.firstChild),
            ...
            (function (n) {
              ...
              (Array.from(n.children).forEach((n) => {
                n !== o && n !== a && n !== c && (n.hasAttribute('data-ovn-frozen') || (M(n, 'style') ? l(n, o) : M(n, 'script') && l(n, a)));
              }),
                d(n));
            })(n),
            (function (n) {
                  ...
                  (r) => {
                    ...
                    (r.forEach((n) => {
                      n.addedNodes.forEach((n) => {
                        1 === n.nodeType && n !== o && n !== a && n !== c && (n.hasAttribute('data-ovn-frozen') || (M(n, 'style') ? l(n, o) && (e = !0) : M(n, 'script') ? l(n, a) && (e = !0) : (e = !0)));
                      });
                    }),
                      e && d(n));
                  },
        ...
        function g() {
          return (
            ...
            ((t = new Promise((o) => {
              function a() {
                const a = (function () {
                  if ((e && !document.contains(e) && ((e = null), (t = null), i.disconnectKey(s)), e)) return e;
          ...
          hover: function (n, r, e, a, i = 926) {
            ...
            const v = (n) => {
                ((d = setTimeout(() => {
                  ...
                  o.set(c, { timerId: d, hoverElement: u, onEnter: v, onLeave: g }));
              },
              g = () => {
            ...
            (c.addEventListener('mouseenter', v), c.addEventListener('mouseleave', g), o.set(c, { timerId: d, hoverElement: u, onEnter: v, onLeave: g }));
          },
        };
      }
  ...
  const g = (() => {
      ...
      function e(r, t, o) {
        ...
        return (
          ...
          a.match && (a.compiledMatch = M.compile(a.match)),
          a
        );
      }
    ...
    N = (() => {
      ...
      return {
        ...
        getSnapshot: function () {
          ...
          for (const n in a) {
            ...
            for (const n of o) {
              ...
              ('block' === n.step && (l.block = r(n.state)), 'match' === n.step && (l.match = r(n.state)), 'state' === n.step && (l.state = r(n.state)), 'chain' === n.step && (l.chain = r(n.state)), 'run.exec' === n.step && ((l.exec = r(n.state)), (g = n.timeCost || 0)), 'fail' === n.state && ((v = 'fail'), (u = n.step)));
            }
            'fail' !== v && (v = 'done');
            const N = m(n),
              p = M(`[${N}]`, s + 2),
              L = d(g),
              I = `${r}[${'fail' === v ? '👾' : '🚀'}][${L}ms]${p} | ${'fail' === v ? `FAIL - ${u}` : 'DONE'}`;
            i[n] = { group: c.group || n.split('_')[0] || 'Unknown', shortName: N, timeCost: g, steps: l, state: v, reason: u, logs: t[n] || [], consoleLine: I };
          }
          for (const n in o) {
            if (i[n]) continue;
            const e = o[n],
        ...
        startTrace: function (n, r) {
          L(n).push({ step: r, state: 'pending', time: performance.now() });
        },
        okTrace: function (n, r, e) {
          const t = L(n).find((n) => n.step === r && 'pending' === n.state);
        ...
        skipTrace: function (n, r, e) {
          L(n).push({ step: r, state: 'skip', reason: e });
        },
    ...
    p = (() => {
      ...
      function r(r, t) {
        return function (o = {}) {
          ...
          i.forEach((o) => {
            const { key: i, type: c = 'switch', name: s = ['ON', 'OFF'], color: M = ['var(--ovnAccentHEX)', 'var(--ovnBase04HEX)'], group: l = t, class: u = [], default: v = !0, order: g = 50, inform: N = !0, reload: p = !1, map: m, onClick: L, onMounted: I } = o;
            (i || 'jump' === c) &&
              r((r) => {
                ...
                if ('jump' === c && m)
                  return void Object.entries(m).forEach(([o, a]) => {
                    ...
                    ((i.className = [...n(u)].join(' ')),
                      ...
                      (i.dataset.order = g),
                      (i.onclick = () => {
                        (L?.({ phase: 'action', type: 'jump', label: o, url: a, button: i }), N && d.top(`Jump TO ${o}`, 'correct'), L || (location.href = a), p && location.reload());
                      }),
                      e(t, i, g),
                      I?.(i));
                  });
                ...
                ((o.className = [...n(u), i].join(' ')), (o.dataset.order = g));
                let y = 'switch' === c ? a.get(i, v) : null;
                function j() {
                  if ('switch' !== c) return void (o.textContent = n(s)[0] || 'RUN');
                  const r = n(s),
                    e = n(M);
                  ((o.textContent = y ? r[0] : r[1]), (o.style.background = y ? e[0] : e[1]));
                }
                (j(),
                  'switch' === c && L?.({ phase: 'init', type: c, key: i, state: y, button: o }),
                  o.addEventListener('click', () => {
                    if ('switch' === c) {
                      if (((y = a.toggle(i)), j(), L?.({ phase: 'toggle', type: c, key: i, state: y, button: o }), N)) {
                        const r = y ? n(s)[0] || 'ON' : n(s)[1] || 'OFF';
                        d.top(`${i}: ${r}`, 'correct');
                      }
                    } else (L?.({ phase: 'action', type: c, key: i, button: o }), N && d.top(`${n(s)[0] || i} 已执行`, 'correct'));
                    p && location.reload();
                  }),
                  e(t, o, g),
                  I?.(o));
  ...
  const m = (() => {
      ...
      function r(r, e) {
        ...
        return t.some((n) => M.check(n, e.url)) ? n('BLOCK') : { ready: !0 };
      }
      function e(r, e) {
    ...
    L = (() => {
      ...
      return {
        run: function (e, i, c = {}) {
          ...
          const s = g.resolve(e);
          if (!s) return (N?.failTrace?.(e, 'resolve', 'NOT_FOUND'), !1);
          const M = g.get(s);
          if (!M) return (N?.skipTrace?.(s, 'run', 'NO_MODULE'), !1);
          N?.startTrace?.(s, 'run');
          const l = (function (n, r = {}) {
              return { url: r.url || location.href, runtime: a, group: g.get(n.group), chain: g.getChain(n.key) };
            })(M, c),
            d = m.check(M, l);
          if (!d.ready) return (N?.failTrace?.(s, 'final', d.reason), !1);
          if ('function' != typeof i) return (N?.failTrace?.(s, 'run', 'NO_FUNC'), !1);
          if (
            !(function (n) {
              return (n.depend && n.depend.length > 0) || (n.phase && 'none' !== n.phase) || n.priority > 0;
            })(M)
          ) {
            N?.startTrace?.(s, 'run.exec');
            performance.now();
            return (t(M, i), N?.okTrace?.(s, 'run.exec'), !0);
          }
          return (n.push({ mod: M, callback: i }), r || ((r = !0), Promise.resolve().then(o)), !0);
        },
      };
    })(),
    I = (() => {
      const n = 'visited',
        r = 'data-ovn-trace';
      return {
        apply: function ({ delay: e = 260, target: o, subjoin: a, trace: c = !1, traceQuery: s = 'a[href]', traceJudge: M }) {
          const l = Array.isArray(o) ? o : [o],
            d = Array.isArray(a) ? a : [a],
            u = new Set(JSON.parse(t.visited.get(n, '[]'))),
            v = `subjoin_${l.join('_')}_${d.join('_')}`;
          function g(n) {
            (d.forEach((r) => {
                  ...
                  (c
                    ? (function (n) {
                        return [...n.querySelectorAll(s)].some((n) => {
                          ...
                          return !!r && ('function' == typeof M ? M(r) : !Array.isArray(M) || M.every((n) => r.includes(n))) && u.has(r);
                        });
                      })(n) && g(n)
                    : g(n));
              });
          ...
          function p() {
            (N(),
              document.body.addEventListener('click', (r) => {
                ...
                o &&
                  ('function' == typeof M ? M(o) : !Array.isArray(M) || M.every((n) => o.includes(n))) &&
                  (u.add(o),
              ...
              i.observeWithKey(v, document.body, { childList: !0, subtree: !0 }, N, { preventDuplicate: !0, autoDisconnect: !1 }));
          }
    ...
    D = (() => {
      ...
      return {
        apply: function ({ mode: r = 'smart', loadPage: e = 9, itemTarget: t = '#container .c-container', itemWrapper: o = '#container', buttonPrev: a = '.page-prev', buttonNext: i = '.page-next', fragment: c = !1, jitter: s } = {}) {
          const M = s || { delay: 30, interval: 30, random: 70 },
            l = (function () {
          ...
          function N(r) {
            return new Promise((e) => {
              const o = u.get({ jitter: M, order: r });
              setTimeout(() => {
                $.get(n(r), (n) => {
              ...
              y &&
                ...
                N(g)
                  .then(() => {
                    ...
                    (n.searchParams.set('page', g), history.replaceState(null, '', n.toString()), (j = !1), (h = 0), w());
                  })
                  .finally(() => {
                    v = !1;
                  }));
    ...
    h = (() => {
      ...
      return {
        apply: function (e = {}) {
          const { jitter: t, delay: o, interval: a, random: i, backstage: c = !1, strict: s = !1, debug: M = !1 } = e,
                      ...
                      u.run(
                        () => {
                          ...
                          try {
                            ...
                            t ? (r(t, i), N.log(n, `Step${e + 1} ✅ ${i} - ${a}`)) : (N.warn(n, `Step${e + 1} ❓ None - ${a}`), s && ((g = !0), N.error(n, `Step${e + 1} ❌ Break`)));
                          } catch (r) {
                            (N.error(n, `Step${e + 1} ❌ Error - ${r.message}`, 0, r.stack), s && (g = !0));
                          }
                          o();
                        },
                        { jitter: l, order: e },
    ...
    x = { PREFS: t, RUNTIME: a, REDIS: o, DOM: s, MATCH: M, SITE: l, OBSERVER: i, INFORM: d, RANDOM: u, DEBUG: N, BUTTON: p, CONFIG: v, RESOLVER: g, VERIFY: m, SCHEDULER: L, HOOK: c, ADD_CLASS: I, QUICK_READ: y, REMOVE_LIMITS: j, AUTO_LOAD: D, AUTO_EXECUTE: h };
  ((window.OVN = x),
    (function () {
    ...
    (function () {
      ...
      function c(n, t) {
        n.querySelectorAll('input[type=checkbox]').forEach((n) => {
          ...
          if (!c) return;
          n.disabled = !t;
          const s = a.get(o, i?.default ?? !0);
          ((n.checked = !!t && s), r(n, i || {}, n.checked), e(c, t, n.checked));
        });
      }
      function M(o, s, l) {
        const u = o.key,
          v = a.get(u, o.default ?? !0);
        if (o.children && o.children.length > 0) {
          ...
          ((L.textContent = u.split('_').pop()), (L.style.marginRight = 'auto'));
          const I = document.createElement('input');
          ((I.type = 'checkbox'), (I.checked = v), (I.disabled = !l), I.classList.add('ovnStatusDot', 'ovnState', 'ovnBack'), r(I, o, v), e(m, l, v));
          const y = document.createElement('div');
          ((y.className = 'ovnGroupBody'),
            requestAnimationFrame(() => {
              c(y, l && I.checked);
            }),
            I.addEventListener('change', () => {
              const t = I.checked;
              (n.set(u, t), r(I, o, t), e(m, l, t), c(y, l && t));
            }),
            m.append(L, I),
            g.append(N, m),
            i(N, y, p, `fold_${u}`, o.fold ?? !1),
            o.children.forEach((n) => M(n, y, l && v)),
            a.append(g, y),
            s.appendChild(a));
        } else
          s.appendChild(
            (function (o, i) {
              const c = o.key,
                s = a.get(c, o.default ?? !0),
                M = document.createElement('label');
              M.className = 'ovnBodyRow';
              const l = document.createElement('span');
              ...
              ((u.type = 'checkbox'),
                ...
                u.addEventListener('change', () => {
                  (n.set(c, u.checked), r(u, o, u.checked), e(M, i, u.checked));
                }),
                M.append(l, u));
              const v = o.error ? o.errorMSG : o.feature;
              return (v && t.hover.get(c, !0) && d.OVN.hover(M, v), M);
            })(o, l),
          );
      }
      function l() {
        ...
        const L = document.createElement('div');
        ((L.className = 'ovnButton'),
          L.append(p, m),
          l.append(v, L),
          s.bindOVN((n) => n.appendChild(l)),
    ...
    (function () {
      function n() {
        ...
        let u = 0,
          v = 0;
        for (const n of Object.values(M)) 'done' === n.state ? u++ : v++;
        const p = `[==👽OVN==][🛸] DONE - ${u}/${u + v} | FAIL - ${v}`,
          m = document.createElement('div');
        m.className = 'ovnDebugGrid';
        const L = g.getTree(),
          I = Object.keys(L),
          y = [...I.filter((n) => l[n]), ...Object.keys(l).filter((n) => !I.includes(n))];
        for (const n of y) {
          const r = l[n];
          if (!r) continue;
          const e = document.createElement('div');
        ...
        D.className = 'ovnObserver';
        let h = '[♾️][observer] Statistics\n';
        if (((h += '----------\n'), void 0 !== i)) {
          const n = i.getActiveCount();
          ((h += `Anonymous : ${n.anonymous}\n`), (h += `Keyed     : ${n.keyed}\n`), (h += `Total     : ${n.byTarget}\n`));
        } else h += 'Observer center not available.\n';
        D.textContent = h;
    ...
    L.run('Gallop', () => {
      !(function () {
          ...
          switch (r) {
            ...
            case 'down': {
              ...
              n &&
                t >= i &&
                (o = (function (n) {
                  for (const r of v) if (r.condition(n)) return r.ratio;
                  return l;
                })(t));
              !(function (n) {
        ...
        function C() {
          T = !1;
          const n = (h || (h = S()), j || ((j = document.createElement('canvas')), (j.style.cssText = '\n                    position: fixed;\n                    top: 0;\n                    left: 0;\n                    width: 100%;\n                    height: 100%;\n                    pointer-events: none;\n                    z-index: 999999999;\n                    opacity: 0;\n                    transition: opacity .2s ease;\n                '), h.appendChild(j), (D = j.getContext('2d'))), (j.width = window.innerWidth), (j.height = window.innerHeight), j);
          ((n.style.transition = 'none'), (n.style.opacity = '1'), n.offsetHeight, (n.style.transition = 'opacity .2s ease'), E());
        }
        function E() {
          D && D.clearRect(0, 0, j.width, j.height);
        }
        function f() {
          T ||
            x ||
            (x = requestAnimationFrame(() => {
              (!(function () {
                if (!D || L.length < 2 || T) return;
                (E(), D.beginPath(), D.moveTo(L[0].x, L[0].y));
                for (let n = 1; n < L.length; n++) D.lineTo(L[n].x, L[n].y);
                ((D.strokeStyle = r), (D.lineWidth = 2), (D.lineCap = 'round'), (D.lineJoin = 'round'), D.stroke());
              })(),
                (x = null));
            }));
        }
        function O(n = !1) {
          const r = () => {
            ((g = !1), (N = !1), (p = !1), (L = []), j && (j.style.opacity = '0'), document.documentElement.classList.remove('gesture-active'), window.removeEventListener('mousemove', U, !0), window.removeEventListener('mouseup', _, !0), m && clearTimeout(m), x && (cancelAnimationFrame(x), (x = null)));
          };
        ...
        function B(n) {
          2 !== n.button ||
            ...
            (m && (clearTimeout(m), (m = null)), O(!0), (g = !0), (N = !1), (p = !1), (I = n.clientX), (y = n.clientY), (L = [{ x: n.clientX, y: n.clientY }]), document.documentElement.classList.add('gesture-active'), window.addEventListener('mousemove', U, !0), window.addEventListener('mouseup', _, !0));
        }
        function U(n) {
          if (!g) return;
          if (k) return void O(!0);
          ...
          (L.push(r),
            ...
            L.length > d &&
              ...
              (function () {
                if (!j || T) return;
                ((T = !0), (j.style.opacity = '0'));
                const n = () => {
                  (j.removeEventListener('transitionend', n), j && (j.remove(), (j = null), (D = null)));
                };
                (j.addEventListener('transitionend', n, { once: !0 }),
                  setTimeout(() => {
                    j && j.parentNode && '0' === j.style.opacity && (j.remove(), (j = null), (D = null));
                  }, 200));
              })(),
            f());
        }
              ...
              if (o >= i) {
                ...
                const r = (function (n) {
                  ...
                  const a = Math.min(o, n.length - 1),
                    ...
                    s = Math.abs(n[n.length - 1].y - n[a].y);
                  return i < c || s < c ? null : 'up' === e && 'down' === t ? 'up-down' : 'down' === e && 'up' === t ? 'down-up' : null;
                })(L);
                if (r) z(r);
                else {
                  const n = A(e, t);
                  ['left', 'right', 'up', 'down'].includes(n) && z(n, o);
                }
              }
            }
            O(!1);
        ...
        function Y(n) {
          ...
          const e = w.signal;
          (document.addEventListener('mousedown', B, { capture: !0, passive: !1, signal: e }),
            window.addEventListener('blur', () => O(!0), { signal: e }),
            window.addEventListener(
              'resize',
              () => {
                j && ((j.width = window.innerWidth), (j.height = window.innerHeight), g && E());
              },
              { signal: e },
            ),
            (b = !0));
        ...
        (window.addEventListener('compositionstart', () => {
          ...
          window.addEventListener(
            'contextmenu',
            (n) => {
              g && N && (n.preventDefault(), n.stopPropagation(), n.stopImmediatePropagation());
            },
            { capture: !0, passive: !1 },
          ),
          void 0 !== s && s.bindOVN
        ...
        o &&
          (o.startsWith('--') &&
            (o = getComputedStyle(document.documentElement)
              ...
              .replace(/^url\(["']?(.*?)["']?\)$/i, '$1')
              .replace(/["']/g, '')),
          o && (document.head ? a(o) : document.addEventListener('DOMContentLoaded', () => a(o)), 'loading' === document.readyState ? document.addEventListener('DOMContentLoaded', () => setTimeout(s, 126)) : setTimeout(s, 126)));
      })();
    }),
    L.run('Selection', () => {
  ...
  function T() {
    try {
      const n = document.documentElement;
      (n.classList.add('ovn'), c.apply('class', { html: n }), x.SCHEDULER.run(), x.DEBUG.infoTotal());
    } catch (n) {
