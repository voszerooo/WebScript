...
(() => {
          ...
          (document.body.firstChild !== n && document.body.insertBefore(n, document.body.firstChild),
            ...
            (function (n) {
              ...
              (Array.from(n.children).forEach((n) => {
                n !== o && n !== i && n !== c && (n.hasAttribute('data-ovn-frozen') || (l(n, 'style') ? d(n, o) : l(n, 'script') && d(n, i)));
              }),
                M(n));
            })(n),
            (function (n) {
                  ...
                  (r) => {
                    ...
                    (r.forEach((n) => {
                      n.addedNodes.forEach((n) => {
                        1 === n.nodeType && n !== o && n !== i && n !== c && (n.hasAttribute('data-ovn-frozen') || (l(n, 'style') ? d(n, o) && (e = !0) : l(n, 'script') ? d(n, i) && (e = !0) : (e = !0)));
                      });
                    }),
                      e && M(n));
                  },
            ...
            const v = (n) => {
                ((M = setTimeout(() => {
                  ...
                  const { clientX: i, clientY: d } = n,
                    { offsetWidth: M, offsetHeight: N } = u,
                    p = d - 40,
                  ...
                  ('function' == typeof a && a(), 1 === t && (c.removeEventListener('mouseenter', v), c.removeEventListener('mouseleave', g), o.delete(c)));
                }, i)),
  ...
  const v = (() => {
    ...
    g = (() => {
      ...
      function g({ icon: n, key: e, time: t, msg: o }) {
        d(t);
        const a = M(t),
          i = m(e);
        !(function (n) {
      ...
      return {
        ...
        infoTotal: function () {
          if (n) {
            for (const [n, r] of Object.entries(o)) {
              ...
              console.log(g({ icon: e, key: n, time: r.timeCost || 0, msg: t }));
            }
            if (void 0 !== a) {
        ...
        getSnapshot: function () {
          ...
          for (const n in i) {
            ...
            const N = m(n),
              p = l(`[${N}]`, s + 2),
              L = M(g),
              y = `${r}[${'fail' === v ? '👾' : '🚀'}][${L}ms]${p} | ${'fail' === v ? `FAIL - ${u}` : 'DONE'}`;
            a[n] = { group: c.group || n.split('_')[0] || 'Unknown', shortName: N, timeCost: g, steps: d, state: v, reason: u, logs: t[n] || [], consoleLine: y };
          }
          for (const n in o) {
            if (a[n]) continue;
            const e = o[n],
              ...
              g = M(d),
              N = `${r}[${i}][${g}ms]${v} | ${c}`;
            a[n] = { group: n.split('_')[0] || 'Unknown', shortName: u, timeCost: d, steps: {}, state: e.error ? 'fail' : 'done', reason: e.errorMSG || '', logs: t[n] || [], consoleLine: N };
          }
          return a;
        },
        ...
        format: function ({ icon: n, key: r, time: e, msg: t }) {
          return g({ icon: n, key: r, time: e, msg: t });
        },
      };
    })(),
    N = (() => {
      ...
      function r(r, t) {
        return function (a = {}) {
          ...
          i.forEach((a) => {
            const { key: i, type: c = 'switch', name: s = ['ON', 'OFF'], color: l = ['var(--ovnAccentHEX)', 'var(--ovnBase04HEX)'], group: M = t, class: u = [], default: v = !0, order: g = 50, inform: N = !0, reload: p = !1, map: m, onClick: L, onMounted: y } = a;
            (i || 'jump' === c) &&
              r((r) => {
                ...
                ((a.className = [...n(u), i].join(' ')), (a.dataset.order = g));
                let h = 'switch' === c ? o.get(i, v) : null;
                function I() {
                  if ('switch' !== c) return void (a.textContent = n(s)[0] || 'RUN');
                  const r = n(s),
                    e = n(l);
                  ((a.textContent = h ? r[0] : r[1]), (a.style.background = h ? e[0] : e[1]));
                }
                (I(),
                  'switch' === c && L?.({ phase: 'init', type: c, key: i, state: h, button: a }),
                  a.addEventListener('click', () => {
                    if ('switch' === c) {
                      if (((h = o.toggle(i)), I(), L?.({ phase: 'toggle', type: c, key: i, state: h, button: a }), N)) {
                        const r = h ? n(s)[0] || 'ON' : n(s)[1] || 'OFF';
                        d.top(`${i}: ${r}`, 'correct');
                      }
                    } else (L?.({ phase: 'action', type: c, key: i, button: a }), N && d.top(`${n(s)[0] || i} 已执行`, 'correct'));
                    p && location.reload();
                  }),
                  e(t, a, g),
                  y?.(a));
  ...
  const p = (() => {
      ...
      return {
        check: function (n, a) {
          ...
          for (const [r, e] of i) {
            g?.startTrace?.(n.key, r);
            const t = e(n, a);
            if (!t.ready) return (g?.failTrace?.(n.key, r, t.reason), t);
            g?.okTrace?.(n.key, r);
          }
          return { ready: !0 };
        },
    ...
    m = (() => {
      ...
      function a() {
        ...
        n.length = 0;
        const a = (n, r) => {
          for (const e of n) (g?.startTrace?.(e.mod.key, `phase.${r}`), g?.startTrace?.(e.mod.key, 'run.exec'), t(e.mod, e.callback), g?.okTrace?.(e.mod.key, 'run.exec'), g?.okTrace?.(e.mod.key, `phase.${r}`));
        };
      ...
      return {
        run: function (e, i, c = {}) {
          ...
          const s = v.resolve(e);
          if (!s) return (g?.failTrace?.(e, 'resolve', 'NOT_FOUND'), !1);
          const l = v.get(s);
          if (!l) return (g?.skipTrace?.(s, 'run', 'NO_MODULE'), !1);
          g?.startTrace?.(s, 'run');
          const d = (function (n, r = {}) {
              return { url: r.url || location.href, runtime: o, group: v.get(n.group), chain: v.getChain(n.key) };
            })(l, c),
            M = p.check(l, d);
          if (!M.ready) return (g?.failTrace?.(s, 'final', M.reason), !1);
          if ('function' != typeof i) return (g?.failTrace?.(s, 'run', 'NO_FUNC'), !1);
          if (
            !(function (n) {
              return (n.depend && n.depend.length > 0) || (n.phase && 'none' !== n.phase) || n.priority > 0;
            })(l)
          ) {
            g?.startTrace?.(s, 'run.exec');
            performance.now();
            return (t(l, i), g?.okTrace?.(s, 'run.exec'), !0);
          }
        ...
        apply: function ({ delay: t = 260, target: o, subjoin: i, trace: c = !1, traceQuery: s = 'a[href]', traceJudge: l }) {
          ...
          function p() {
            (N(),
              ...
              a.observeWithKey(v, document.body, { childList: !0, subtree: !0 }, N, { preventDuplicate: !0, autoDisconnect: !1 }));
          }
        ...
        apply: function ({ mode: r = 'smart', loadPage: e = 9, itemTarget: t = '#container .c-container', itemWrapper: o = '#container', buttonPrev: a = '.page-prev', buttonNext: i = '.page-next', fragment: c = !1, jitter: s } = {}) {
          ...
          function N(r) {
            return new Promise((e) => {
              const o = M.get({ jitter: l, order: r });
              setTimeout(() => {
                $.get(n(r), (n) => {
          ...
          if ('multipage' === r) {
            ...
            p && ((p.href = n(d + e + 1)), (p.textContent = `Next ${e + 1}`));
            const m = [];
            for (let L = 1; L <= e; L++) {
              const y = d + L;
              m.push(N(y));
              ...
              h &&
                ...
                N(g)
                  .then(() => {
                    ...
                    (n.searchParams.set('page', g), history.replaceState(null, '', n.toString()), (I = !1), (D = 0), w());
                  })
                  .finally(() => {
                    v = !1;
                  }));
                      ...
                      M.run(
                        () => {
                          ...
                          try {
                            ...
                            t ? (r(t, i), g.log(n, `Step${e + 1} ✅ ${i} - ${a}`)) : (g.warn(n, `Step${e + 1} ❓ None - ${a}`), s && ((N = !0), g.error(n, `Step${e + 1} ❌ Break`)));
                          } catch (r) {
                            (g.error(n, `Step${e + 1} ❌ Error - ${r.message}`, 0, r.stack), s && (N = !0));
                          }
                          o();
                        },
                        { jitter: d, order: e },
    ...
    D = { PREFS: e, RUNTIME: o, REDIS: t, DOM: c, MATCH: s, SITE: l, OBSERVER: a, INFORM: d, RANDOM: M, DEBUG: g, BUTTON: N, CONFIG: u, RESOLVER: v, VERIFY: p, SCHEDULER: m, HOOK: i, ADD_CLASS: L, QUICK_READ: y, REMOVE_LIMITS: h, AUTO_LOAD: I, AUTO_EXECUTE: j };
  ((window.OVN = D),
    (function () {
        ...
        c = () => {
          const o = document.documentElement,
            a =
              ...
              'light';
          a !== e && (o.setAttribute('data-ovn-theme', a), (e = a));
        },
        s = () => {
    ...
    (function () {
      ...
      function l(t, c, M) {
        ...
        if (t.children && t.children.length > 0) {
          ...
          ((N.className = 'ovnFoldBox'), (N.style.cursor = 'pointer'), e.hover.get(u, !0) && d.OVN.hover(N, 'HEIHEI 彩蛋 | ClickClick', 2));
          ...
          ((y.type = 'checkbox'), (y.checked = v), (y.disabled = !M), y.classList.add('ovnStatusDot', 'ovnState', 'ovnBack'), r(y, t, v), a(m, M, v));
          ...
          ((h.className = 'ovnGroupBody'),
            ...
            y.addEventListener('change', () => {
              const e = y.checked;
              (n.set(u, e), r(y, t, e), a(m, M, e), s(h, M && e));
            }),
            m.append(L, y),
            g.append(N, m),
            i(N, h, p, `fold_${u}`, t.fold ?? !1),
            t.children.forEach((n) => l(n, h, M && v)),
            o.append(g, h),
            c.appendChild(o));
        } else
          c.appendChild(
            (function (t, i) {
              ...
              return (v && e.hover.get(c, !0) && d.OVN.hover(l, v), l);
            })(t, M),
          );
      }
      function M() {
        ...
        ((M.id = 'ovnOptionsPanel'), (M.className = 'ovnPanelBase ovnOptionBase ovnFixed'));
        const u = document.createElement('h2');
        ((u.textContent = 'Options'), M.appendChild(u));
        const g = document.createElement('div');
        ...
        ((p.textContent = 'Apply'),
          ...
          (p.onclick = () => {
            (n.forEach((n, r) => o.set(r, n)), d.OVN.top('已应用 即将刷新', 'correct'), setTimeout(() => location.reload(), 1260));
          }));
        const m = document.createElement('button');
        ((m.textContent = 'Reset'),
          (m.className = 'ovnButtonBase ovnButtonAdapt ovnReset'),
          (m.onclick = () => {
            (e.reset(), t.clear(), d.OVN.top('已重置 即将刷新', 'correct'), setTimeout(() => location.reload(), 1260));
          }));
        const L = document.createElement('div');
        ((L.className = 'ovnButton'),
          L.append(p, m),
          M.append(g, L),
          c.bindOVN((n) => n.appendChild(M)),
          setTimeout(() => M.classList.add('ovnShow'), 20),
          setTimeout(() => {
            const n = (r) => {
              M.contains(r.target) ||
                (M.classList.add('ovnHide'),
                setTimeout(() => {
                  (M.remove(), document.removeEventListener('click', n));
                }, 526));
            };
            document.addEventListener('click', n);
          }, 100));
      }
      (GM_registerMenuCommand('👽 Options Panel', M),
        document.addEventListener('keydown', (n) => {
          n.ctrlKey && n.altKey && 'x' === n.key.toLowerCase() && (n.preventDefault(), M());
        }));
    })(),
    (function () {
      function n() {
        ...
        const L = v.getTree(),
          y = Object.keys(L),
          h = [...y.filter((n) => M[n]), ...Object.keys(M).filter((n) => !y.includes(n))];
        for (const n of h) {
          const r = M[n];
          if (!r) continue;
          const e = document.createElement('div');
      ...
      (g || void 0 !== g || console.warn('[==👽OVN==] OVN_Debug | OVN_GLOBAL_DEBUG not available yet, will retry on demand'),
    ...
    m.run('Gallop', () => {
      !(function () {
        ...
        function C() {
          T = !1;
          const n = (D || (D = S()), I || ((I = document.createElement('canvas')), (I.style.cssText = '\n                    position: fixed;\n                    top: 0;\n                    left: 0;\n                    width: 100%;\n                    height: 100%;\n                    pointer-events: none;\n                    z-index: 999999999;\n                    opacity: 0;\n                    transition: opacity .2s ease;\n                '), D.appendChild(I), (j = I.getContext('2d'))), (I.width = window.innerWidth), (I.height = window.innerHeight), I);
          ((n.style.transition = 'none'), (n.style.opacity = '1'), n.offsetHeight, (n.style.transition = 'opacity .2s ease'), E());
        }
        function E() {
          j && j.clearRect(0, 0, I.width, I.height);
        }
        function f() {
          T ||
            x ||
            (x = requestAnimationFrame(() => {
              (!(function () {
                if (!j || L.length < 2 || T) return;
                (E(), j.beginPath(), j.moveTo(L[0].x, L[0].y));
                for (let n = 1; n < L.length; n++) j.lineTo(L[n].x, L[n].y);
                ((j.strokeStyle = r), (j.lineWidth = 2), (j.lineCap = 'round'), (j.lineJoin = 'round'), j.stroke());
              })(),
                (x = null));
            }));
        }
        function O(n = !1) {
          const r = () => {
            ((g = !1), (N = !1), (p = !1), (L = []), I && (I.style.opacity = '0'), document.documentElement.classList.remove('gesture-active'), window.removeEventListener('mousemove', _, !0), window.removeEventListener('mouseup', U, !0), m && clearTimeout(m), x && (cancelAnimationFrame(x), (x = null)));
          };
        ...
        function B(n) {
          2 !== n.button ||
            ...
            (m && (clearTimeout(m), (m = null)), O(!0), (g = !0), (N = !1), (p = !1), (y = n.clientX), (h = n.clientY), (L = [{ x: n.clientX, y: n.clientY }]), document.documentElement.classList.add('gesture-active'), window.addEventListener('mousemove', _, !0), window.addEventListener('mouseup', U, !0));
        }
        function _(n) {
          if (!g) return;
          ...
          (L.push(r),
            ...
            L.length > M &&
              ...
              (function () {
                if (!I || T) return;
                ((T = !0), (I.style.opacity = '0'));
                const n = () => {
                  (I.removeEventListener('transitionend', n), I && (I.remove(), (I = null), (j = null)));
                };
                (I.addEventListener('transitionend', n, { once: !0 }),
                  setTimeout(() => {
                    I && I.parentNode && '0' === I.style.opacity && (I.remove(), (I = null), (j = null));
                  }, 200));
              })(),
            f());
        }
        ...
        function Y(n) {
          ...
          (document.addEventListener('mousedown', B, { capture: !0, passive: !1, signal: e }),
            ...
            window.addEventListener(
              'resize',
              () => {
                I && ((I.width = window.innerWidth), (I.height = window.innerHeight), g && E());
              },
              { signal: e },
            ),
            (b = !0));
  ...
  (m.run('YUQUE', () => {
    ...
    m.run('ovnGrid', () => {
      L.apply({ target: ['.ne-editor-wrap-content', '.ne-viewer-layout-mode-fixed .ne-viewer-body'], subjoin: ['ovnGrid', 'ovnSolid'] });
    }));
  m.run('TickTick', () => {
  ...
  function x() {
    try {
      const n = document.documentElement;
      (n.classList.add('ovn'), i.apply('class', { html: n }), D.SCHEDULER.run(), D.DEBUG.infoTotal());
    } catch (n) {
