    ...
    return { apply };
        ...
        // #region Derive
            ...
            const VBN = {
                ...
                CONFIG_SITE: VBN_SITE_GROUP,
                CONFIG_CONFIG: VBN_GLOBAL_CONFIG,
                CONFIG_MODULE: VBN_GLOBAL_MODULES,
                
                VALUE_VALUE: VBN_VALUE_STORE,
                // VALUE_CACHE: VBN_VALUE_CACHE,
                // VALUE_RECORD: VBN_VALUE_RECORD,
                // VALUE_RUNTIME: VBN_VALUE_RUNTIME,
                
                BASICS_DOM: VBN_GLOBAL_DOM,
                BASICS_MATCH: VBN_MATCH_RULE,               // VBN_VALUE_STORE
                BASICS_OBSERVER: VBN_OBSERVER_CENTER,
                BASICS_RANDOM: VBN_RANDOM_JITTER,
                BASICS_INFORM: VBN_GLOBAL_INFORM,           // VBN_VALUE_STORE / VBN_GLOBAL_DOM
                BASICS_DEBUG: VBN_GLOBAL_DEBUG,             // VBN_VALUE_STORE / VBN_GLOBAL_CONFIG / VBN_OBSERVER_CENTER
                
                CORE_STORE: VBN_MODULE_STORE,               // VBN_VALUE_STORE
                CORE_ACTIVATION: VBN_ACTIVATION,            // VBN_VALUE_STORE / VBN_MATCH_RULE / VBN_MODULE_STORE
                CORE_DISPATCH: VBN_GLOBAL_DISPATCH,         // VBN_GLOBAL_CONFIG / VBN_ACTIVATION / VBN_MODULE_STORE / VBN_GLOBAL_DEBUG
                
                UTILS_CLASS: VBN_ADD_CLASS,                 // VBN_OBSERVER_CENTER
                UTILS_READ: VBN_QUICK_READ,
                UTILS_REMOVE: VBN_REMOVE_LIMITS,            // VBN_OBSERVER_CENTER
                UTILS_LOAD: VBN_AUTO_LOAD,
                UTILS_BATCH: VBN_BATCH_LOAD,
                UTILS_EXECUTE: VBN_AUTO_EXECUTE,            // VBN_GLOBAL_DEBUG
                
            };
            
            VBN.CORE_DISPATCH.preheat();
                ...
                GM_addStyle( /* css */ `
                    ...
                    /* ================================================== ↓ Global */
                        ...
                        html {
                            ...
                            &.vbn body {
                                ...
                                --vbn-Baidu-Width: var(--vbnSpaceWidth02);    /* XXXX */
                    ...
                    /* ================================================== ↓ Global */
                        ...
                        /* ========== ↓ 原生模块边框 */
                            ...
                            html .pc-fresh-smooth .cu-border:after,
        ...
        // #region Google
            ...
            VBN_GLOBAL_DISPATCH.activate("Search", {
                ...
                GM_addStyle( /* css */ `
                    ...
                    /* ========== ↓ 仅在 "分类 => 全部" 页激活才应用 */
                    html:has(body [role="listitem"]:nth-child(2) a[aria-disabled="true"]) {
                ...
                GM_addStyle( /* css */ `
                    ...
                    html {
                        ...
                        &.vbn body {
                            ...
                            --vbn-Bili-Base: var(--vbnPrimaryHEX);          /* 播放器 底色 */
                        ...
                        /* ========== ↓ 播放器 */
                            ...
                            .bpx-player-video-wrap video { background: var(--vbn-Bili-Base); }
